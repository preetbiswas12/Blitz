 ...
 * Merges UI translations from @opencode-ai/ui and Kilo overrides from @blitxcode/kilo-i18n.
 *
...
import { I18nProvider } from "@blitxcode/kilo-ui/context"
import type { UiI18nKey, UiI18nParams } from "@blitxcode/kilo-ui/context"
import { dict as uiEn } from "@blitxcode/kilo-ui/i18n/en"
import { dict as uiZh } from "@blitxcode/kilo-ui/i18n/zh"
import { dict as uiZht } from "@blitxcode/kilo-ui/i18n/zht"
import { dict as uiKo } from "@blitxcode/kilo-ui/i18n/ko"
import { dict as uiDe } from "@blitxcode/kilo-ui/i18n/de"
import { dict as uiEs } from "@blitxcode/kilo-ui/i18n/es"
import { dict as uiFr } from "@blitxcode/kilo-ui/i18n/fr"
import { dict as uiDa } from "@blitxcode/kilo-ui/i18n/da"
import { dict as uiJa } from "@blitxcode/kilo-ui/i18n/ja"
import { dict as uiPl } from "@blitxcode/kilo-ui/i18n/pl"
import { dict as uiRu } from "@blitxcode/kilo-ui/i18n/ru"
import { dict as uiAr } from "@blitxcode/kilo-ui/i18n/ar"
import { dict as uiNo } from "@blitxcode/kilo-ui/i18n/no"
import { dict as uiBr } from "@blitxcode/kilo-ui/i18n/br"
import { dict as uiTh } from "@blitxcode/kilo-ui/i18n/th"
import { dict as uiBs } from "@blitxcode/kilo-ui/i18n/bs"
import { dict as uiTr } from "@blitxcode/kilo-ui/i18n/tr"
import { dict as uiNl } from "@blitxcode/kilo-ui/i18n/nl"
import { dict as uiUk } from "@blitxcode/kilo-ui/i18n/uk"
import { dict as uiIt } from "@blitxcode/kilo-ui/i18n/it"
...
import { dict as kiloEn } from "@blitxcode/kilo-i18n/en"
import { dict as kiloZh } from "@blitxcode/kilo-i18n/zh"
import { dict as kiloZht } from "@blitxcode/kilo-i18n/zht"
import { dict as kiloKo } from "@blitxcode/kilo-i18n/ko"
import { dict as kiloDe } from "@blitxcode/kilo-i18n/de"
import { dict as kiloEs } from "@blitxcode/kilo-i18n/es"
import { dict as kiloFr } from "@blitxcode/kilo-i18n/fr"
import { dict as kiloDa } from "@blitxcode/kilo-i18n/da"
import { dict as kiloJa } from "@blitxcode/kilo-i18n/ja"
import { dict as kiloPl } from "@blitxcode/kilo-i18n/pl"
import { dict as kiloRu } from "@blitxcode/kilo-i18n/ru"
import { dict as kiloAr } from "@blitxcode/kilo-i18n/ar"
import { dict as kiloNo } from "@blitxcode/kilo-i18n/no"
import { dict as kiloBr } from "@blitxcode/kilo-i18n/br"
import { dict as kiloTh } from "@blitxcode/kilo-i18n/th"
import { dict as kiloBs } from "@blitxcode/kilo-i18n/bs"
import { dict as kiloTr } from "@blitxcode/kilo-i18n/tr"
import { dict as kiloNl } from "@blitxcode/kilo-i18n/nl"
import { dict as kiloUk } from "@blitxcode/kilo-i18n/uk"
import { dict as kiloIt } from "@blitxcode/kilo-i18n/it"
