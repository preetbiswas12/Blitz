...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "请在此设备上安装 Anaconda Desktop，然后返回此处。Blitx 不会为你运行安装程序。",
  ...
  "provider.anaconda.state.signedOut": "请打开 Anaconda Desktop 并登录，然后再连接 Blitx。",
  "provider.anaconda.state.unauthorized":
    "Blitx 无法访问 Anaconda Desktop。请打开 Desktop，重新登录，并在需要时重新启动它。",
  ...
  "provider.anaconda.state.ready": "Blitx 找到了一个健康的本地文本生成服务器，可以导入其当前的连接设置。",
  ...
  "provider.anaconda.toast.refreshed.description": "当前本地服务器和模型在 Blitx 中已是最新。",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx 无法检查可用技能。",
  "agentRequirements.error.mcpStatusFailed": "Blitx 无法检查 MCP 服务器状态。",
  "agentRequirements.error.scopeMismatch": "此代理要求检查已不再有效。",
  "agentRequirements.error.requestFailed": "Blitx 无法检查代理要求。",
  ...
  "dialog.model.unpaid.freeModels.title": "Blitx 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Blitx 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Blitx 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Blitx 中使用 {{provider}} 模型。",
  ...
  "prompt.action.sandbox.enabled": "沙盒已启用。代理 shell 命令被限制在项目和 Blitx 目录内。",
  "prompt.action.sandbox.disabled": "沙盒已禁用。点击以将代理 shell 命令的写入限制在项目和 Blitx 目录内。",
  ...
  "prompt.action.sandbox.description.enabled": "写入仅限项目和 Blitx 目录。",
  "prompt.action.sandbox.description.disabled": "点击以限制文件系统写入和网络访问。",
  "prompt.action.sandbox.description.disabledNetworkAllowed":
    "点击以限制文件系统写入。根据你的沙盒设置，网络访问仍然允许。",

  "speechToText.tooltip.start": "使用 Blitx Gateway 开始语音输入",
  ...
  "speechToText.error.loginRequired": "登录 Blitx 以使用语音输入。",
  ...
  "dialog.server.description": "切换此应用连接的 Blitx 服务器。",
  ...
  "toast.update.description": "Blitx 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Blitx 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Blitx 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Blitx 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Blitx 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Blitx 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Blitx 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Blitx 启动时自动检查更新",
  ...
  "settings.indexing.blitxModel.title": "Blitx 模型预设",
  "settings.indexing.blitxModel.description": "选择受支持的 Blitx 托管嵌入模型。",
  "settings.indexing.blitxSignIn.title": "需要登录 Blitx",
  "settings.indexing.blitxSignIn.description": "登录 Blitx 以使用托管嵌入。",
  ...
  "settings.providers.betaNotice":
    "目前只能在设置界面中配置 Blitx Gateway 提供商。在 Beta 测试期间即将支持配置其他提供商。在此期间，您可以使用 CLI 或配置文件来配置提供商。我们致力于保持 Blitx 开放，无锁定。",
  ...
  "settings.models.hidePromptTraining.description": "隐藏提供商可能会使用您的提示词进行训练的 Blitx Gateway 模型。",
  ...
  "settings.config.title": "打开 {{scope}} Blitx 配置文件",
  "settings.config.placeholder": "配置文件按顺序合并；标记为已加载的文件目前会影响设置。",
  "settings.config.noWorkspace": "打开工作区文件夹以编辑本地 Blitx 配置文件。",
  "settings.config.openFailed": "无法打开 {{scope}} Blitx 配置文件：{{message}}",
  ...
  "workStyle.onboarding.welcome": "欢迎使用 Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx 会在工作过程中暂停并向你展示其计划。",
  ...
  "session.cloud.import.placeholder": "会话 ID、URL 或 blitx import 命令",
  ...
  "settings.aboutBlitx.title": "关于 Blitx",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "Blitx 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutBlitx.status.connected": "已连接",
  "settings.aboutBlitx.status.connecting": "连接中...",
  "settings.aboutBlitx.status.disconnected": "已断开",
  "settings.aboutBlitx.status.error": "错误",
  "settings.aboutBlitx.cliServer": "CLI 服务器",
  "settings.aboutBlitx.status.label": "状态：",
  "settings.aboutBlitx.port.label": "端口：",
  "settings.aboutBlitx.versionInfo": "版本信息",
  "settings.aboutBlitx.version.label": "版本：",
  "settings.aboutBlitx.extensionName": "Blitx 扩展",
  "settings.aboutBlitx.community": "社区与支持",
  "settings.aboutBlitx.feedback.prefix": "如果您有任何问题或反馈，欢迎在以下平台提交 issue",
  "settings.aboutBlitx.feedback.or": "或",
  "settings.aboutBlitx.support.prefix": "如有账单或账户问题，请联系客户支持",
  "settings.aboutBlitx.resetSettings.title": "重置设置",
  "settings.aboutBlitx.resetSettings.description":
    "此操作仅将 VS Code 扩展专属设置重置为默认值。与 CLI 共享的设置（如模式和自动审批规则）存储在 CLI 配置中，不会被重置。",
  "settings.aboutBlitx.resetSettings.button": "重置所有设置",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "设置迁移",
  "settings.aboutBlitx.settingsTransfer.description": "导出或导入设置，以便在 VS Code 实例之间传输。",
  "settings.aboutBlitx.exportSettings": "导出",
  "settings.aboutBlitx.importSettings": "导入",
  "settings.aboutBlitx.importSettings.invalidJson": "无效的 JSON 文件。请选择有效的设置文件。",
  "settings.aboutBlitx.importSettings.invalidConfig": "文件不包含有效的 Blitx 设置。",
  "settings.aboutBlitx.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutBlitx.importSettings.newerVersion": "此文件由较新版本的 Blitx 导出。部分设置可能会被忽略。",
  "settings.aboutBlitx.importSettings.success": "设置已导入。请查看上方的更改，然后点击保存。",

  "settings.aboutBlitx.telemetry.title": "遥测",
  "settings.aboutBlitx.telemetry.description":
    '遥测由 VS Code 的内置遥测设置控制。若要将其禁用，请转到「设置」>「遥测」>「遥测级别」并将其设置为 "off"。重启 VS Code 以应用更改。',
  "settings.aboutBlitx.telemetry.openSettings": "打开遥测设置",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 Blitx 界面的语言。',
  ...
  "settings.experimental.speechToText.description": "通过 Blitx Gateway 使用您的 Blitx 帐户在提示词字段中启用语音输入。",
  "settings.models.speechToText.disabledDescription":
    "启用并登录 Blitx 提供商以使用 Speech to Text。Speech to Text 目前仅支持通过 Blitx Gateway 使用。",
  "settings.models.speechToTextModel.title": "语音转文本模型",
  "settings.models.speechToTextModel.description": "选择用于语音输入的 Blitx Gateway 转录模型。",
  ...
  "settings.experimental.remote.description": "通过 Blitx Cloud 启用会话的 Remote 控制。这也会影响此计算机上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "将 Claude Code 配置目录中的 CLAUDE.md 指令和技能加载到会话中。如果您希望 Blitx 使用您的 Claude Code 指令和技能，请启用此选项。需要重启。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未配置 MCP 服务器。在 blitx.jsonc 中添加 MCP 服务器，或让代理为您添加。",
  ...
  "settings.experimental.sandbox.description":
    "在操作系统级沙盒中运行代理 shell 命令，将写入限制在项目和 Blitx 状态目录内",
  ...
  "settings.display.fontSize.description": "独立于 VS Code 调整 Blitx webview UI 的字体大小。",
  ...
  "settings.aboutBlitx.legacyMigration.title": "旧版迁移",
  "settings.aboutBlitx.legacyMigration.description":
    "从旧版 Blitx 安装迁移设置，包括提供商 API 密钥和默认模型。",
  "settings.aboutBlitx.rooImport.description": "从 Roo Code 安装导入对话历史记录。",
  "settings.aboutBlitx.rooImport.button": "从 Roo Code 导入会话",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Blitx 产品共享一个小巧高效的核心。无论你选择哪种方式工作，都能获得熟悉的体验。",
  ...
  "diffViewer.source.session.tooltip": "Blitx 在当前会话中更改的文件，基于每轮快照。开始新会话时重置。",
