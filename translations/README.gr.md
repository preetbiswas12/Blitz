...
Επιλέξτε πού θέλετε να εκτελέσετε το Blitz.
...
Στη συνέχεια εκτελέστε `Blitz` σε οποιονδήποτε κατάλογο έργου για να ξεκινήσετε.
...
Το Blitz περιλαμβάνει εξειδικευμένους agents ανάμεσα στους οποίους αλλάζετε ανάλογα με την εργασία. Μπορείτε επίσης να δημιουργήσετε τους δικούς σας custom agents.
...
<details>
<summary>Από πού προήλθε το Blitz CLI;</summary>

Το Blitz CLI είναι fork του [OpenCode](https://github.com/anomalyco/opencode), βελτιωμένο για να λειτουργεί μέσα στην Blitz agentic engineering platform.
