export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Blitx オートコンプリート",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Blitx オートコンプリート (無効)",
  ...
  "kilocode:autocomplete.toggleMessage": "Blitx オートコンプリート {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Blitx: クイックタスク",
  "kilocode:autocomplete.input.placeholder": "例: 'この関数をより効率的にリファクタリングする'",
  "kilocode:autocomplete.commands.generateSuggestions": "Blitx: 提案された編集を生成",
  ...
  "kilocode:autocomplete.codeAction.title": "Blitx: 提案された編集",
  "kilocode:autocomplete.chatParticipant.fullName": "Blitx エージェント",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Blitx オートコンプリートは GitHub Copilot との競合によりブロックされています。修正するには、Copilot のインライン提案を無効にする必要があります。",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Blitx オートコンプリートは一時停止されました。考えられる原因: Kilo アカウントに残りクレジットがない、または設定済みの API キー (BYOK) がクォータ上限に達しています。オートコンプリートを再開するには、Kilo クレジットを追加するか API キー設定を確認してください。",
  "kilocode:autocomplete.creditsExhausted.addCredits": "クレジットを追加",
  "kilocode:autocomplete.authError.message":
    "Blitx オートコンプリートは認証の問題により一時停止されました。考えられる原因: Kilo にサインインしていない、または API キー (BYOK) が無効または不足しています。再度サインインするか、プロバイダーの API キー設定を確認してください。",
}
