...
- A [Kilo Code account](https://app.kilo.ai) <!-- TODO: Replace with Legion dashboard URL --> (free to create)
...
1. Log into the [Kilo platform](https://app.kilo.ai). <!-- TODO: Replace with Legion dashboard URL -->
2. Navigate to the [Bring Your Own Key (BYOK) page](https://app.kilo.ai/byok), <!-- TODO: Replace with Legion dashboard URL --> available in the sidebar under **Account**.
