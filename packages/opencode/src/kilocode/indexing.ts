...
import { type IndexingTelemetryEvent, type VectorStoreSearchResult } from "@blitxcode/kilo-indexing/engine"
import { toIndexingConfigInput, type IndexingConfig } from "@blitxcode/kilo-indexing/config"
import { hasIndexingPlugin } from "@blitxcode/kilo-indexing/detect"
import { IndexingStatus, disabledIndexingStatus } from "@blitxcode/kilo-indexing/status"
...
type EmbeddingModelCatalog = {
  models: Array<{ id: string; name: string; dimension: number; scoreThreshold: number; note?: string }>
