...
export const kiloScenarios: Scenario[] = [
    ...
    .seeded((ctx) =>
      Effect.gen(function* () {
        const location = yield* file(
          ctx,
          ".kilocodecodecode/skill/httpapi-remove/SKILL.md",
          "---\nname: httpapi-remove\ndescription: HTTP API removal fixture.\n---\n# HTTP API remove\n",
        )
        const sentinel = yield* file(ctx, ".kilocodecodecode/skill/httpapi-remove/KEEP.txt", "synthetic sentinel\n")
  ...
  http.protected
    ...
    .mutating()
    .seeded((ctx) => file(ctx, ".kilocodecodecode/agent/httpapi-remove.md", "---\ndescription: HTTP API remove\n---\nRemove me.\n"))
