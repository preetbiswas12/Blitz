...
import { BlitxEmbeddingModelsContext } from "../context/blitx-embedding-models"
  ...
  render: () => {
    ...
    return (
      <StoryProviders config={cfg}>
        <BlitxEmbeddingModelsContext.Provider value={{ catalog: () => catalog }}>
          <div style={{ "max-height": "700px", overflow: "auto" }}>
            <IndexingTab />
          </div>
        </BlitxEmbeddingModelsContext.Provider>
      </StoryProviders>
    )
  },
}
