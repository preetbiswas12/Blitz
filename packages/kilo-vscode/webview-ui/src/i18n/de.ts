...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installieren Sie Anaconda Desktop auf diesem Computer und kehren Sie dann hierher zurück. Blitx führt das Installationsprogramm nicht für Sie aus.",
  ...
  "provider.anaconda.state.signedOut": "Öffnen Sie Anaconda Desktop und melden Sie sich an, bevor Sie Blitx verbinden.",
  "provider.anaconda.state.unauthorized":
    "Blitx konnte nicht auf Anaconda Desktop zugreifen. Öffnen Sie Desktop, melden Sie sich erneut an und starten Sie es bei Bedarf neu.",
  ...
  "provider.anaconda.state.ready":
    "Blitx hat einen funktionsfähigen lokalen Textgenerierungsserver gefunden und kann dessen aktuelle Verbindungseinstellungen importieren.",
  ...
  "provider.anaconda.toast.refreshed.description":
    "Der aktive lokale Server und die Modelle sind in Blitx auf dem neuesten Stand.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx konnte die verfügbaren Skills nicht prüfen.",
  "agentRequirements.error.mcpStatusFailed": "Blitx konnte den MCP-Serverstatus nicht prüfen.",
  "agentRequirements.error.scopeMismatch": "Diese Prüfung der Agentenanforderungen ist nicht mehr aktiv.",
  "agentRequirements.error.requestFailed": "Blitx konnte die Agentenanforderungen nicht prüfen.",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Blitx",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Blitx zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Blitx zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Blitx zu nutzen.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox ist aktiviert. Shell-Befehle des Agenten sind auf die Projekt- und Blitx-Verzeichnisse beschränkt.",
  "prompt.action.sandbox.disabled":
    "Sandbox ist deaktiviert. Klicken, um Schreibvorgänge der Shell-Befehle des Agenten auf die Projekt- und Blitx-Verzeichnisse zu beschränken.",
  ...
  "prompt.action.sandbox.description.enabled":
    "Schreibvorgänge sind auf die Projekt- und Blitx-Verzeichnisse beschränkt.",
  ...
  "speechToText.tooltip.start": "Spracheingabe mit Blitx Gateway starten",
  ...
  "speechToText.error.loginRequired": "Melden Sie sich bei Blitx an, um die Spracheingabe zu verwenden.",
  ...
  "dialog.server.description": "Wechseln Sie den Blitx-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Blitx ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Blitx-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Blitx unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Blitx enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Blitx ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Blitx auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Blitx anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Blitx automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Blitx.",
  ...
  "settings.indexing.blitxModel.title": "Blitx-Modellvoreinstellung",
  "settings.indexing.blitxModel.description": "Wählen Sie ein unterstütztes von Blitx gehostetes Embedding-Modell.",
  "settings.indexing.blitxSignIn.title": "Blitx-Anmeldung erforderlich",
  "settings.indexing.blitxSignIn.description": "Melden Sie sich bei Blitx an, um gehostete Embeddings zu verwenden.",
  ...
  "settings.models.hidePromptTraining.description":
    "Blendet Blitx-Gateway-Modelle aus, deren Anbieter Ihre Prompts möglicherweise zum Training verwenden.",
  ...
  "settings.config.title": "{{scope}} Blitx-Konfigurationsdatei öffnen",
  ...
  "settings.config.noWorkspace":
    "Öffnen Sie einen Arbeitsbereichsordner, um die lokale Blitx-Konfigurationsdatei zu bearbeiten.",
  "settings.config.openFailed": "Fehler beim Öffnen der {{scope}} Blitx-Konfigurationsdatei: {{message}}",
  ...
  "workStyle.onboarding.welcome": "Willkommen bei Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx pausiert und zeigt dir während der Arbeit seinen Plan.",
  ...
  "session.cloud.import.placeholder": "Sitzungs-ID, URL oder blitx import-Befehl",
  ...
  "deviceAuth.title": "Bei Blitx anmelden",
  ...
  "profile.action.login": "Mit Blitx anmelden",
  ...
  "profile.pass.subscribe": "Hol dir Blitx Pass, um Guthaben hinzuzufügen und Boni zu verdienen",
  ...
  "settings.aboutBlitx.title": "Über Blitx",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "Blitx ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutBlitx.status.connected": "Verbunden",
  "settings.aboutBlitx.status.connecting": "Verbindung wird hergestellt...",
  "settings.aboutBlitx.status.disconnected": "Getrennt",
  "settings.aboutBlitx.status.error": "Fehler",
  "settings.aboutBlitx.cliServer": "CLI-Server",
  "settings.aboutBlitx.status.label": "Status:",
  "settings.aboutBlitx.port.label": "Port:",
  "settings.aboutBlitx.versionInfo": "Versionsinformationen",
  "settings.aboutBlitx.version.label": "Version:",
  "settings.aboutBlitx.extensionName": "Blitx Erweiterung",
  "settings.aboutBlitx.community": "Community & Support",
  "settings.aboutBlitx.feedback.prefix": "Bei Fragen oder Feedback können Sie ein Issue eröffnen auf",
  "settings.aboutBlitx.feedback.or": "oder",
  "settings.aboutBlitx.support.prefix":
    "Bei Abrechnungs- oder Kontofragen wenden Sie sich an den Kundensupport unter",
  "settings.aboutBlitx.resetSettings.title": "Einstellungen zurücksetzen",
  ...
  "settings.aboutBlitx.resetSettings.button": "Alle Einstellungen zurücksetzen",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Einstellungen übertragen",
  ...
  "settings.aboutBlitx.exportSettings": "Exportieren",
  "settings.aboutBlitx.importSettings": "Importieren",
  "settings.aboutBlitx.importSettings.invalidJson":
    "Ungültige JSON-Datei. Bitte wählen Sie eine gültige Einstellungsdatei aus.",
  "settings.aboutBlitx.importSettings.invalidConfig": "Die Datei enthält keine gültigen Blitx-Einstellungen.",
  ...
  "settings.aboutBlitx.importSettings.newerVersion":
    "Diese Datei wurde mit einer neueren Version von Blitx exportiert. Einige Einstellungen werden möglicherweise ignoriert.",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Telemetrie-Einstellungen öffnen",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die Blitx Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.experimental.speechToText.description":
    "Aktivieren Sie die Spracheingabe in Prompt-Feldern mit Ihrem Blitx-Konto über Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktivieren Sie den Blitx-Anbieter und melden Sie sich an, um Speech to Text zu verwenden. Speech to Text wird derzeit nur mit Blitx Gateway unterstützt.",
  "settings.models.speechToTextModel.title": "Sprache-zu-Text-Modell",
  "settings.models.speechToTextModel.description":
    "Wählen Sie das Blitx Gateway-Transkriptionsmodell für die Spracheingabe.",
  ...
  "settings.experimental.remote.description":
    "Aktivieren Sie die Remote-Steuerung von Sitzungen über Blitx Cloud. Dies betrifft auch CLIs auf diesem Computer.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Lädt CLAUDE.md-Anweisungen und Skills aus Ihrem Claude Code-Konfigurationsverzeichnis in Sitzungen. Aktivieren Sie dies, wenn Blitx Ihre Claude Code-Anweisungen und Skills verwenden soll. Neustart erforderlich.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Keine MCP-Server konfiguriert. Fügen Sie MCP-Server in blitx.jsonc hinzu oder bitten Sie den Agenten, sie hinzuzufügen.",
  ...
  "settings.experimental.sandbox.description":
    "Shell-Befehle des Agenten in einer Sandbox auf Betriebssystemebene ausführen, die Schreibvorgänge auf die Projekt- und Blitx-Statusverzeichnisse beschränkt",
  ...
  "settings.display.fontSize.description": "Passen Sie die Schriftgröße der Blitx webview UI unabhängig von VS Code an.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "Legacy-Migration",
  "settings.aboutBlitx.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von Blitx, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",
  "settings.aboutBlitx.rooImport.description":
    "Importieren Sie den Konversationsverlauf von einer Installation von Roo Code.",
  "settings.aboutBlitx.rooImport.button": "Sitzungen aus Roo Code importieren",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Ein kleiner, effizienter Kern über alle Blitx-Produkte hinweg. Ein vertrautes Erlebnis, egal wie Sie arbeiten.",
  ...
  "diffViewer.source.session.tooltip":
    "Von Blitx während der aktuellen Sitzung geänderte Dateien, basierend auf Snapshots pro Runde. Wird beim Start einer neuen Sitzung zurückgesetzt.",
