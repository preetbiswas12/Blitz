...
Встановіть [розширення Blitz](vscode:extension/Blitzcode.Blitz-code) напряму або завантажте його з [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=blitzcode.Blitz-Code). Створіть обліковий запис і отримайте доступ до понад 500 моделей, зокрема GPT-5.5, Claude Opus 4.7, Claude Sonnet 4.6 і Gemini 3.1 Pro Preview, усі за цінами постачальників.
...
Встановіть [плагін Blitz](https://plugins.jetbrains.com/plugin/28350-Blitz-code) з JetBrains Marketplace або знайдіть "Blitz" у `Settings → Plugins` у будь-якій JetBrains IDE.
...
Запускайте Blitz з вебу, без локальної машини, на [app.Blitz.ai/cloud](https://app.blitz.ai/cloud).
...
Налаштуйте автоматичні AI-рев'ю коду для ваших pull request на [app.Blitz.ai/code-reviews](https://app.blitz.ai/code-reviews).
...
Запустіть свого постійно активного AI-агента на [app.blitz.ai/claw](https://app.blitz.ai/claw).
...
Завантажте найновіший бінарний файл зі [сторінки Releases](https://github.com/Blitz-Org/Blitzcode/releases).
...
Дізнайтеся більше про [agents і власні agents](https://blitz.ai/docs/code-with-ai/agents/using-agents).
...
Для налаштування та всього іншого перегляньте [документацію](https://blitz.ai/docs).
...
**Долучайтеся до спільноти** [Discord](https://blitz.ai/discord) | [X](https://x.com/blitzcode) | [Reddit](https://www.reddit.com/r/blitzcode/)
