...
async function showRemovalSummary(targets: RemovalTargets, method: Installation.Method) {
  ...
  if (method !== "curl" && method !== "unknown") {
    const cmds: Record<string, string> = {
      npm: "npm uninstall -g @legioncli", // kilocode_change
      pnpm: "pnpm uninstall -g @legioncli", // kilocode_change
      bun: "bun remove -g @legioncli", // kilocode_change
      yarn: "yarn global remove @legioncli", // kilocode_change
