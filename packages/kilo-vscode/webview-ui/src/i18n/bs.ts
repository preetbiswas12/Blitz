export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instalirajte Anaconda Desktop na ovom računaru, zatim se vratite ovdje. Blitx ne pokreće instalacijski program umjesto vas.",
  ...
  "provider.anaconda.state.unauthorized":
    "Blitx nije mogao pristupiti Anaconda Desktopu. Otvorite Desktop, ponovo se prijavite i ponovo ga pokrenite ako je potrebno.",
  ...
  "provider.anaconda.state.ready":
    "Blitx je pronašao ispravan lokalni server za generisanje teksta i može uvesti njegove trenutne postavke veze.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx nije mogao provjeriti dostupne vještine.",
  "agentRequirements.error.mcpStatusFailed": "Blitx nije mogao provjeriti status MCP servera.",
  "agentRequirements.error.scopeMismatch": "Ova provjera zahtjeva agenta više nije aktivna.",
  "agentRequirements.error.requestFailed": "Blitx nije mogao provjeriti zahtjeve agenta.",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Blitx",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Blitx-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Blitx-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Blitx-u.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox je omogućen. Shell komande agenta su ograničene na direktorije projekta i Blitx.",
  "prompt.action.sandbox.disabled":
    "Sandbox je onemogućen. Kliknite da ograničite pisanje shell komandi agenta na direktorije projekta i Blitx.",
  ...
  "prompt.action.sandbox.description.enabled": "Pisanje je ograničeno na direktorije projekta i Blitx.",
  ...
  "speechToText.tooltip.start": "Započni glasovni unos sa Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "Prijavite se na Blitx da koristite glasovni unos.",
  ...
  "dialog.server.description": "Promijeni na koji se Blitx server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Blitx-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Blitx timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Blitx još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Blitx uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Blitx-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Blitx izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Blitx-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Blitx pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Blitx-a.",
  ...
  "settings.indexing.blitxModel.title": "Preset Blitx modela",
  "settings.indexing.blitxModel.description": "Odaberite podržani model embeddinga hostovan na Blitx.",
  "settings.indexing.blitxSignIn.title": "Potrebna je prijava na Blitx",
  "settings.indexing.blitxSignIn.description": "Prijavite se na Blitx za korištenje hostovanih embeddinga.",
  ...
  "settings.providers.betaNotice":
    "Trenutno se samo Blitx Gateway provajder može konfigurisati u interfejsu za postavke. Podrška za konfigurisanje drugih provajdera stiže uskoro tokom beta perioda. U međuvremenu, provajdere možete konfigurisati koristeći CLI ili konfiguracijsku datoteku. Posvećeni smo tome da Blitx ostane otvoren, bez vezivanja.",
  ...
  "settings.models.hidePromptTraining.description":
    "Sakrij Blitx Gateway modele čiji pružaoci mogu koristiti vaše promptove za treniranje.",
  ...
  "settings.config.title": "Otvori {{scope}} Blitx konfiguracijsku datoteku",
  "settings.config.placeholder":
    "Konfiguracijske datoteke se spajaju po redu; datoteke označene kao učitane trenutno utiču na postavke.",
  "settings.config.noWorkspace": "Otvorite fasciklu radnog prostora da uredite lokalnu Blitx konfiguracijsku datoteku.",
  "settings.config.openFailed": "Nije uspjelo otvaranje {{scope}} Blitx konfiguracijske datoteke: {{message}}",
  ...
  "workStyle.onboarding.welcome": "Dobro došli u Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx zastaje i prikazuje vam svoj plan tokom rada.",
  ...
  "session.cloud.import.placeholder": "ID sesije, URL ili blitx import naredba",
  ...
  "deviceAuth.title": "Prijavite se u Blitx",
  ...
  "profile.action.login": "Prijavite se putem Blitx",
  ...
  "profile.pass.subscribe": "Nabavite Blitx Pass da dodate kredite i zaradite bonuse",
  ...
  "settings.aboutBlitx.title": "O Blitx-u",

  "session.messages.empty": "Započnite razgovor unosom poruke ispod.",
  "session.messages.welcome":
    "Blitx je AI asistent za programiranje. Zatražite da gradi funkcionalnosti, ispravlja greške ili objasni vašu bazu koda.",
  ...
  "settings.aboutBlitx.status.connected": "Povezano",
  "settings.aboutBlitx.status.connecting": "Povezivanje...",
  "settings.aboutBlitx.status.disconnected": "Odspojeno",
  "settings.aboutBlitx.status.error": "Greška",
  "settings.aboutBlitx.cliServer": "CLI server",
  "settings.aboutBlitx.status.label": "Status:",
  "settings.aboutBlitx.port.label": "Port:",
  "settings.aboutBlitx.versionInfo": "Informacije o verziji",
  "settings.aboutBlitx.version.label": "Verzija:",
  "settings.aboutBlitx.extensionName": "Blitx ekstenzija",
  "settings.aboutBlitx.community": "Zajednica i podrška",
  "settings.aboutBlitx.feedback.prefix": "Ako imate pitanja ili povratne informacije, slobodno otvorite issue na",
  "settings.aboutBlitx.feedback.or": "ili",
  "settings.aboutBlitx.support.prefix": "Za pitanja o naplati ili računu, kontaktirajte korisničku podršku na",
  "settings.aboutBlitx.resetSettings.title": "Resetovanje postavki",
  ...
  "settings.aboutBlitx.resetSettings.button": "Resetuj sve postavke",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Prijenos postavki",
  "settings.aboutBlitx.settingsTransfer.description":
    "Izvezite ili uvezite postavke za prijenos između VS Code instanci.",
  "settings.aboutBlitx.exportSettings": "Izvezi",
  "settings.aboutBlitx.importSettings": "Uvezi",
  "settings.aboutBlitx.importSettings.invalidJson": "Nevažeći JSON fajl. Odaberite važeći fajl s postavkama.",
  "settings.aboutBlitx.importSettings.invalidConfig": "Fajl ne sadrži važeće Blitx postavke.",
  "settings.aboutBlitx.importSettings.tooLarge": "Fajl je prevelik. Fajlovi s postavkama moraju biti manji od 1 MB.",
  "settings.aboutBlitx.importSettings.newerVersion":
    "Ovaj fajl je izvezen iz novije verzije Blitx-a. Neke postavke mogu biti zanemarene.",
  "settings.aboutBlitx.importSettings.success":
    "Postavke su uvezene. Pregledajte promjene iznad, a zatim kliknite Sačuvaj.",

  "settings.aboutBlitx.telemetry.title": "Telemetrija",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Otvori postavke telemetrije",
  ...
  "settings.language.description": 'Odaberite jezik za Blitx sučelje. "Auto" koristi jezik prikaza VS Code-a.',
  ...
  "settings.experimental.speechToText.description":
    "Omogućite glasovni unos u poljima za promptove koristeći vaš Blitx račun preko Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Omogućite i prijavite se na Blitx provajder da biste koristili Speech to Text. Speech to Text je trenutno podržan samo uz Blitx Gateway.",
  "settings.models.speechToTextModel.title": "Model govora u tekst",
  "settings.models.speechToTextModel.description": "Odaberite Blitx Gateway model za transkripciju za glasovni unos.",
  ...
  "settings.experimental.remote.description":
    "Omogućite Remote kontrolu sesija putem Blitx Cloud. Ovo će također utjecati na CLI-jeve na ovoj mašini.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Učitajte CLAUDE.md instrukcije i vještine iz vašeg Claude Code konfiguracijskog direktorija u sesije. Omogućite ovo ako želite da Blitx koristi vaše Claude Code instrukcije i vještine. Zahtijeva ponovno pokretanje.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nema konfiguriranih MCP servera. Dodajte MCP servere u blitx.jsonc ili zamolite agenta da ih doda.",
  ...
  "settings.experimental.sandbox.description":
    "Pokrenite shell komande agenta unutar sandboxa na nivou operativnog sistema koji ograničava pisanje na direktorije stanja projekta i Blitx",
  ...
  "settings.display.fontSize.description": "Prilagodite veličinu fonta za Blitx webview UI nezavisno od VS Code-a.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "Migracija sa prethodne verzije",
  "settings.aboutBlitx.legacyMigration.description":
    "Migrirajte postavke iz prethodne instalacije Blitx, uključujući API ključeve provajdera i podrazumijevani model.",
  "settings.aboutBlitx.rooImport.description": "Uvezite historiju razgovora iz instalacije Roo Code.",
  "settings.aboutBlitx.rooImport.button": "Uvezi sesije iz Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Šta je novo u Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno malo, efikasno jezgro kroz sve Blitx proizvode. Poznato iskustvo bez obzira na to kako odaberete raditi.",
  ...
  "diffViewer.source.session.tooltip":
    "Datoteke koje je Blitx promijenio tokom trenutne sesije, na osnovu snapshota po koraku. Resetuje se kada pokrenete novu sesiju.",
