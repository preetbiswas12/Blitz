...
import type { NotebookRequest } from "@blitxcode/sdk/v2/client"
import * as vscode from "vscode"
import { BlitxConnectionService } from "../../src/services/cli-backend/connection-service"
...
describe("BlitxConnectionService notebook directories", () => {
  it("tracks the workspace root, current request directory, and provider directories", async () => {
    ...
    const service = new BlitxConnectionService({} as vscode.ExtensionContext)
