export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instale o Anaconda Desktop nesta máquina e depois volte aqui. O Blitx não executa o instalador para você.",
  ...
  "provider.anaconda.state.signedOut": "Abra o Anaconda Desktop e faça login antes de conectar o Blitx.",
  "provider.anaconda.state.unauthorized":
    "O Blitx não conseguiu acessar o Anaconda Desktop. Abra o Desktop, faça login novamente e reinicie-o se necessário.",
  ...
  "provider.anaconda.state.ready":
    "O Blitx encontrou um servidor local saudável de geração de texto e pode importar suas configurações de conexão atuais.",
  ...
  "provider.anaconda.toast.refreshed.description": "O servidor local ativo e os modelos estão atualizados no Blitx.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "O Blitx não conseguiu verificar as skills disponíveis.",
  "agentRequirements.error.mcpStatusFailed": "O Blitx não conseguiu verificar o status do servidor MCP.",
  "agentRequirements.error.scopeMismatch": "Esta verificação de requisitos do agente não está mais ativa.",
  "agentRequirements.error.requestFailed": "O Blitx não conseguiu verificar os requisitos do agente.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Blitx",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Blitx.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Blitx.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Blitx.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox ativado. Os comandos shell do agente estão limitados aos diretórios do projeto e do Blitx.",
  "prompt.action.sandbox.disabled":
    "Sandbox desativado. Clique para limitar as escritas dos comandos shell do agente aos diretórios do projeto e do Blitx.",
  ...
  "prompt.action.sandbox.description.enabled":
    "As operações de escrita são limitadas aos diretórios do projeto e do Blitx.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz com o Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "Faça login no Blitx para usar a entrada de voz.",
  ...
  "dialog.server.description": "Trocar para qual servidor Blitx este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Blitx ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Blitx",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Blitx ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Blitx inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Blitx",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Blitx aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Blitx é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Blitx iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Blitx.",
  ...
  "settings.providers.betaNotice":
    "Atualmente, apenas o provedor Blitx Gateway pode ser configurado na interface de configurações. O suporte para a configuração de outros provedores estará disponível em breve durante o período beta. Enquanto isso, você pode configurar provedores usando a CLI ou o arquivo de configuração. Estamos comprometidos em manter o Blitx aberto, sem lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Oculte os modelos do Blitx Gateway cujos provedores podem usar seus prompts para treinamento.",
  ...
  "settings.config.title": "Abrir arquivo de configuração {{scope}} do Blitx",
  ...
  "settings.config.noWorkspace":
    "Abra uma pasta de espaço de trabalho para editar o arquivo de configuração local do Blitx.",
  "settings.config.openFailed": "Falha ao abrir o arquivo de configuração {{scope}} do Blitx: {{message}}",
  ...
  "workStyle.onboarding.welcome": "Boas-vindas ao Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "O Blitx pausa e mostra o plano enquanto trabalha.",
  ...
  "session.cloud.import.placeholder": "ID da sessão, URL ou comando blitx import",
  ...
  "deviceAuth.title": "Entrar no Blitx",
  ...
  "profile.action.login": "Entrar com Blitx",
  ...
  "profile.pass.subscribe": "Obtenha o Blitx Pass para adicionar créditos e ganhar bônus",
  ...
  "settings.indexing.blitxModel.title": "Predefinição de modelo do Blitx",
  "settings.indexing.blitxModel.description": "Escolha um modelo de embedding hospedado pelo Blitx compatível.",
  "settings.indexing.blitxSignIn.title": "Login no Blitx necessário",
  "settings.indexing.blitxSignIn.description": "Entre no Blitx para usar embeddings hospedados.",
  ...
  "settings.aboutBlitx.title": "Sobre o Blitx",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "Blitx é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutBlitx.status.error": "Erro",
  "settings.aboutBlitx.cliServer": "Servidor CLI",
  "settings.aboutBlitx.status.label": "Status:",
  "settings.aboutBlitx.port.label": "Porta:",
  "settings.aboutBlitx.versionInfo": "Informações da Versão",
  "settings.aboutBlitx.version.label": "Versão:",
  "settings.aboutBlitx.extensionName": "Extensão Blitx",
  "settings.aboutBlitx.community": "Comunidade e Suporte",
  "settings.aboutBlitx.feedback.prefix": "Se você tiver perguntas ou feedback, abra uma issue no",
  ...
  "settings.aboutBlitx.resetSettings.title": "Redefinir Configurações",
  ...
  "settings.aboutBlitx.resetSettings.button": "Redefinir Todas as Configurações",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Transferência de configurações",
  ...
  "settings.aboutBlitx.importSettings.invalidConfig": "O arquivo não contém configurações válidas do Blitx.",
  ...
  "settings.aboutBlitx.importSettings.newerVersion":
    "Este arquivo foi exportado de uma versão mais recente do Blitx. Algumas configurações podem ser ignoradas.",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Abrir Configurações de Telemetria",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do Blitx. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Ative a entrada de voz nos campos de prompt usando sua conta do Blitx por meio do Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Ative e faça login no provedor Blitx para usar o Speech to Text. Atualmente, o Speech to Text é compatível apenas com o Blitx Gateway.",
  "settings.models.speechToTextModel.title": "Modelo de fala para texto",
  "settings.models.speechToTextModel.description":
    "Escolha o modelo de transcrição do Blitx Gateway para entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite o controle Remote de sessões via Blitx Cloud. Isso também afetará as CLIs nesta máquina.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carrega as instruções e skills do CLAUDE.md a partir do seu diretório de configuração do Claude Code para as sessões. Ative esta opção se deseja que o Blitx utilize suas instruções e skills do Claude Code. Requer reinicialização.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nenhum servidor MCP configurado. Adicione servidores MCP em blitx.jsonc ou peça ao agente para adicioná-los.",
  ...
  "settings.experimental.sandbox.description":
    "Executar os comandos shell do agente dentro de um sandbox a nível de sistema operacional que restringe escritas aos diretórios de estado do projeto e do Blitx",
  ...
  "settings.display.fontSize.description":
    "Ajuste o tamanho da fonte da webview UI do Blitx independentemente do VS Code.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "Migração Legada",
  "settings.aboutBlitx.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do Blitx, incluindo chaves de API de provedor e modelo padrão.",
  "settings.aboutBlitx.rooImport.description": "Importe o histórico de conversas de uma instalação do Roo Code.",
  "settings.aboutBlitx.rooImport.button": "Importar sessões do Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Um núcleo pequeno e eficiente em todos os produtos Blitx. Uma experiência familiar independentemente de como você escolha trabalhar.",
  ...
  "diffViewer.source.session.tooltip":
    "Arquivos modificados pelo Blitx durante a sessão atual, com base em snapshots por turno. Reinicia ao começar uma nova sessão.",
