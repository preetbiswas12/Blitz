export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Zainstaluj Anaconda Desktop na tym komputerze, a następnie wróć tutaj. Blitx nie uruchamia instalatora za Ciebie.",
  ...
  "provider.anaconda.state.signedOut": "Otwórz Anaconda Desktop i zaloguj się przed połączeniem Blitx.",
  "provider.anaconda.state.unauthorized":
    "Blitx nie mógł uzyskać dostępu do Anaconda Desktop. Otwórz Desktop, zaloguj się ponownie i w razie potrzeby uruchom ją ponownie.",
  ...
  "provider.anaconda.state.ready":
    "Blitx znalazł sprawny lokalny serwer generowania tekstu i może zaimportować jego bieżące ustawienia połączenia.",
  ...
  "provider.anaconda.toast.refreshed.description": "Aktywny serwer lokalny i modele są aktualne w Blitx.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx nie mógł sprawdzić dostępnych umiejętności.",
  "agentRequirements.error.mcpStatusFailed": "Blitx nie mógł sprawdzić stanu serwera MCP.",
  "agentRequirements.error.scopeMismatch": "To sprawdzenie wymagań agenta nie jest już aktywne.",
  "agentRequirements.error.requestFailed": "Blitx nie mógł sprawdzić wymagań agenta.",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Blitx",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Blitx.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Blitx.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Blitx.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox jest włączony. Polecenia shell agenta są ograniczone do katalogów projektu i Blitx.",
  "prompt.action.sandbox.disabled":
    "Sandbox jest wyłączony. Kliknij, aby ograniczyć zapisy poleceń shell agenta do katalogów projektu i Blitx.",
  ...
  "prompt.action.sandbox.description.enabled": "Zapisy są ograniczone do katalogów projektu i Blitx.",
  ...
  "speechToText.tooltip.start": "Rozpocznij wprowadzanie głosowe z Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "Zaloguj się do Blitx, aby korzystać z wprowadzania głosowego.",
  ...
  "dialog.server.description": "Przełącz serwer Blitx, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Blitx ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Blitx",
  ...
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, Blitx nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "Blitx zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Blitx",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Blitx na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Blitx.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Blitx",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Blitx.",
  ...
  "settings.providers.betaNotice":
    "Obecnie w interfejsie ustawień można skonfigurować tylko dostawcę Blitx Gateway. Obsługa konfiguracji innych dostawców pojawi się wkrótce w fazie beta. W międzyczasie możesz konfigurować dostawców za pomocą CLI lub pliku konfiguracyjnego. Zależy nam na zachowaniu otwartości Blitx, bez lock-inu.",
  ...
  "settings.models.hidePromptTraining.description":
    "Ukryj modele Blitx Gateway, których dostawcy mogą używać Twoich promptów do trenowania.",
  ...
  "settings.config.title": "Otwórz plik konfiguracyjny Blitx ({{scope}})",
  "settings.config.placeholder":
    "Pliki konfiguracyjne są scalane po kolei; pliki oznaczone jako wczytane mają obecnie wpływ na ustawienia.",
  "settings.config.noWorkspace": "Otwórz folder obszaru roboczego, aby edytować lokalny plik konfiguracyjny Blitx.",
  "settings.config.openFailed": "Nie udało się otworzyć pliku konfiguracyjnego Blitx ({{scope}}): {{message}}",
  ...
  "workStyle.onboarding.welcome": "Witamy w Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx wstrzymuje pracę i pokazuje swój plan w trakcie działania.",
  ...
  "session.cloud.import.placeholder": "ID sesji, URL lub polecenie blitx import",
  ...
  "deviceAuth.title": "Zaloguj się do Blitx",
  ...
  "profile.action.login": "Zaloguj się przez Blitx",
  ...
  "profile.pass.subscribe": "Zdobądź Blitx Pass, aby dodać środki i zdobywać bonusy",
  ...
  "settings.aboutBlitx.title": "O Blitx",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "Blitx to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutBlitx.status.connected": "Połączono",
  "settings.aboutBlitx.status.connecting": "Łączenie...",
  "settings.aboutBlitx.status.disconnected": "Rozłączono",
  "settings.aboutBlitx.status.error": "Błąd",
  "settings.aboutBlitx.cliServer": "Serwer CLI",
  "settings.aboutBlitx.status.label": "Status:",
  "settings.aboutBlitx.port.label": "Port:",
  "settings.aboutBlitx.versionInfo": "Informacje o wersji",
  "settings.aboutBlitx.version.label": "Wersja:",
  "settings.aboutBlitx.extensionName": "Rozszerzenie Blitx",
  "settings.aboutBlitx.community": "Społeczność i wsparcie",
  "settings.aboutBlitx.feedback.prefix": "Jeśli masz pytania lub uwagi, śmiało otwórz zgłoszenie na",
  "settings.aboutBlitx.feedback.or": "lub",
  "settings.aboutBlitx.support.prefix":
    "W sprawach rozliczeń lub konta skontaktuj się z obsługą klienta pod adresem",
  "settings.aboutBlitx.resetSettings.title": "Resetuj ustawienia",
  ...
  "settings.aboutBlitx.resetSettings.button": "Resetuj wszystkie ustawienia",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Przenoszenie ustawień",
  ...
  "settings.aboutBlitx.exportSettings": "Eksportuj",
  "settings.aboutBlitx.importSettings": "Importuj",
  "settings.aboutBlitx.importSettings.invalidJson": "Nieprawidłowy plik JSON. Wybierz prawidłowy plik ustawień.",
  "settings.aboutBlitx.importSettings.invalidConfig": "Plik nie zawiera prawidłowych ustawień Blitx.",
  "settings.aboutBlitx.importSettings.tooLarge": "Plik jest za duży. Pliki ustawień muszą mieć mniej niż 1 MB.",
  "settings.aboutBlitx.importSettings.newerVersion":
    "Ten plik został wyeksportowany z nowszej wersji Blitx. Niektóre ustawienia mogą zostać zignorowane.",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Otwórz ustawienia telemetrii",
  ...
  "settings.language.description": 'Wybierz język interfejsu Blitx. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Włącz wprowadzanie głosowe w polach promptów przy użyciu konta Blitx za pośrednictwem Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Włącz i zaloguj się do dostawcy Blitx, aby korzystać ze Speech to Text. Speech to Text jest obecnie obsługiwane tylko z Blitx Gateway.",
  "settings.models.speechToTextModel.title": "Model mowy na tekst",
  "settings.models.speechToTextModel.description":
    "Wybierz model transkrypcji Blitx Gateway dla wprowadzania głosowego.",
  ...
  "settings.experimental.remote.description":
    "Włącz sterowanie Remote sesjami za pośrednictwem Blitx Cloud. Wpłynie to również na CLI na tej maszynie.",
  ...
  "settings.indexing.blitxModel.title": "Preset modelu Blitx",
  "settings.indexing.blitxModel.description": "Wybierz obsługiwany model osadzania hostowany przez Blitx.",
  "settings.indexing.blitxSignIn.title": "Wymagane logowanie do Blitx",
  "settings.indexing.blitxSignIn.description": "Zaloguj się do Blitx, aby używać hostowanych osadzeń.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Wczytuje instrukcje CLAUDE.md oraz umiejętności z katalogu konfiguracyjnego Claude Code do sesji. Włącz tę opcję, jeśli chcesz, aby Blitx korzystał z Twoich instrukcji i umiejętności Claude Code. Wymaga ponownego uruchomienia.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Brak skonfigurowanych serwerów MCP. Dodaj serwery MCP w blitx.jsonc lub poproś agenta o ich dodanie.",
  ...
  "settings.experimental.sandbox.description":
    "Uruchamiaj polecenia shell agenta w sandboxie na poziomie systemu operacyjnego, który ogranicza zapisy do katalogów stanu projektu i Blitx",
  ...
  "settings.display.fontSize.description": "Dostosuj rozmiar czcionki webview UI Blitx niezależnie od VS Code.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "Migracja starszej wersji",
  "settings.aboutBlitx.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji Blitx, w tym klucze API dostawców i domyślny model.",
  "settings.aboutBlitx.rooImport.description": "Importuj historię rozmów z instalacji Roo Code.",
  "settings.aboutBlitx.rooImport.button": "Importuj sesje z Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno małe, wydajne jądro we wszystkich produktach Blitx. Znajome doświadczenie niezależnie od sposobu pracy.",
  ...
  "diffViewer.source.session.tooltip":
    "Pliki zmienione przez Blitx w trakcie bieżącej sesji, na podstawie snapshotów na turę. Resetowane przy rozpoczęciu nowej sesji.",
