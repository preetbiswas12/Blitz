...
const TIPS = [
  ...
  "Blitx can {highlight}configure itself{/highlight} if you ask it",
  "Ask Blitx to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Blitx to {highlight}create a review agent for this project{/highlight}",
  "Ask Blitx to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Blitx to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Blitx to {highlight}make my review agent read-only{/highlight}",
  "Ask Blitx to {highlight}require approval before git push{/highlight}",
  "Ask Blitx to {highlight}turn off auto-formatting{/highlight}",
  "Ask Blitx to {highlight}block access to .env files{/highlight}",
  "Ask Blitx to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Blitx to {highlight}match my terminal theme{/highlight}",
  "Ask Blitx to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Blitx to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Blitx to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Blitx to {highlight}save this workflow as a /command{/highlight}",
  "Blitx auto-handles OAuth for remote MCP servers requiring auth",
  "Blitx auto-formats files using prettier, gofmt, ruff, and more",
  "Blitx uses LSP servers for intelligent code analysis",
  "Use {highlight}blitx run{/highlight} for non-interactive scripting",
  "Use {highlight}blitx --continue{/highlight} to resume the last session",
  "Use {highlight}blitx run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}blitx serve{/highlight} for headless API access to Blitx",
  "Use {highlight}blitx run --attach{/highlight} to connect to a running server",
  "Run {highlight}blitx upgrade{/highlight} to update to the latest version",
  "Run {highlight}blitx auth list{/highlight} to see all configured providers",
