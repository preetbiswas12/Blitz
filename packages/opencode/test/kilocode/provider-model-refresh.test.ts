...
it.instance(
  ...
  Effect.gen(function* () {
    ...
    const flags = {
      source: Flag.kilocodecodecode_MODELS_URL,
      path: Flag.kilocodecodecode_MODELS_PATH,
      disabled: Flag.kilocodecodecode_DISABLE_MODELS_FETCH,
      key: process.env.ACME_API_KEY,
    }

    yield* Effect.acquireUseRelease(
      Effect.promise(async () => {
        Flag.kilocodecodecode_MODELS_URL = source
        Flag.kilocodecodecode_MODELS_PATH = undefined
        Flag.kilocodecodecode_DISABLE_MODELS_FETCH = true
      ...
      () =>
        Effect.promise(async () => {
          Flag.kilocodecodecode_MODELS_URL = flags.source
          Flag.kilocodecodecode_MODELS_PATH = flags.path
          Flag.kilocodecodecode_DISABLE_MODELS_FETCH = flags.disabled
