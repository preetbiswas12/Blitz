export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installer Anaconda Desktop på denne maskine, og vend derefter tilbage hertil. Blitx kører ikke installationsprogrammet for dig.",
  ...
  "provider.anaconda.state.signedOut": "Åbn Anaconda Desktop og log ind, før du forbinder Blitx.",
  "provider.anaconda.state.unauthorized":
    "Blitx kunne ikke få adgang til Anaconda Desktop. Åbn Desktop, log ind igen, og genstart den om nødvendigt.",
  ...
  "provider.anaconda.state.ready":
    "Blitx fandt en sund lokal tekstgenereringsserver og kan importere dens aktuelle forbindelsesindstillinger.",
  ...
  "provider.anaconda.toast.refreshed.description": "Den aktive lokale server og modeller er opdaterede i Blitx.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx kunne ikke kontrollere de tilgængelige skills.",
  "agentRequirements.error.mcpStatusFailed": "Blitx kunne ikke kontrollere MCP-serverstatus.",
  "agentRequirements.error.scopeMismatch": "Denne agentkravskontrol er ikke længere aktiv.",
  "agentRequirements.error.requestFailed": "Blitx kunne ikke kontrollere agentkravene.",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Blitx",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Blitx.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Blitx.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Blitx.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox er aktiveret. Shell-kommandoer for agenten er begrænset til projekt- og Blitx-mapperne.",
  "prompt.action.sandbox.disabled":
    "Sandbox er deaktiveret. Klik for at begrænse skrivning af shell-kommandoer for agenten til projekt- og Blitx-mapperne.",
  ...
  "prompt.action.sandbox.description.enabled": "Skrivning er begrænset til projekt- og Blitx-mapperne.",
  ...
  "speechToText.tooltip.start": "Start stemmeinput med Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "Log ind på Blitx for at bruge stemmeinput.",
  ...
  "dialog.server.description": "Skift hvilken Blitx-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Blitx ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Blitx-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Blitx understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Blitx inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Blitx",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Blitx ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Blitx er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Blitx starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Blitx.",
  ...
  "settings.indexing.blitxModel.title": "Blitx-modelpreset",
  "settings.indexing.blitxModel.description": "Vælg en understøttet Blitx-hostet embedding-model.",
  "settings.indexing.blitxSignIn.title": "Blitx-login kræves",
  "settings.indexing.blitxSignIn.description": "Log ind på Blitx for at bruge hostede embeddings.",
  ...
  "settings.providers.betaNotice":
    "I øjeblikket kan kun Blitx Gateway-udbyderen konfigureres i indstillingsgrænsefladen. Understøttelse af konfiguration af andre udbydere kommer snart i løbet af betaperioden. I mellemtiden kan du konfigurere udbydere via CLI eller konfigurationsfilen. Vi er dedikerede til at holde Blitx åben, ingen lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Skjul Blitx Gateway-modeller, hvis udbydere muligvis bruger dine prompts til træning.",
  ...
  "settings.config.title": "Åbn {{scope}} Blitx konfigurationsfil",
  "settings.config.placeholder":
    "Konfigurationsfiler flettes i rækkefølge; filer markeret som indlæst påvirker i øjeblikket indstillingerne.",
  "settings.config.noWorkspace": "Åbn en arbejdsområdemappe for at redigere den lokale Blitx konfigurationsfil.",
  "settings.config.openFailed": "Kunne ikke åbne {{scope}} Blitx konfigurationsfil: {{message}}",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx holder pause og viser dig sin plan undervejs.",
  ...
  "session.cloud.import.placeholder": "Sessions-ID, URL eller blitx import-kommando",
  ...
  "deviceAuth.title": "Log ind på Blitx",
  ...
  "profile.action.login": "Log ind med Blitx",
  ...
  "profile.pass.subscribe": "Få Blitx Pass for at tilføje kredit og optjene bonusser",
  ...
  "session.messages.welcome":
    "Blitx er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutBlitx.status.connected": "Forbundet",
  "settings.aboutBlitx.status.connecting": "Forbinder...",
  "settings.aboutBlitx.status.disconnected": "Afbrudt",
  "settings.aboutBlitx.status.error": "Fejl",
  "settings.aboutBlitx.cliServer": "CLI-server",
  "settings.aboutBlitx.status.label": "Status:",
  "settings.aboutBlitx.port.label": "Port:",
  "settings.aboutBlitx.versionInfo": "Versionsinformation",
  "settings.aboutBlitx.version.label": "Version:",
  "settings.aboutBlitx.extensionName": "Blitx-udvidelse",
  "settings.aboutBlitx.community": "Fællesskab og support",
  ...
  "settings.aboutBlitx.support.prefix": "For fakturerings- eller kontospørgsmål, kontakt kundesupport på",
  "settings.aboutBlitx.resetSettings.title": "Nulstil indstillinger",
  ...
  "settings.aboutBlitx.resetSettings.button": "Nulstil alle indstillinger",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Overførsel af indstillinger",
  ...
  "settings.aboutBlitx.exportSettings": "Eksportér",
  "settings.aboutBlitx.importSettings": "Importér",
  "settings.aboutBlitx.importSettings.invalidJson": "Ugyldig JSON-fil. Vælg venligst en gyldig indstillingsfil.",
  "settings.aboutBlitx.importSettings.invalidConfig": "Filen indeholder ikke gyldige Blitx-indstillinger.",
  "settings.aboutBlitx.importSettings.tooLarge": "Filen er for stor. Indstillingsfiler skal være under 1 MB.",
  "settings.aboutBlitx.importSettings.newerVersion":
    "Denne fil blev eksporteret fra en nyere version af Blitx. Nogle indstillinger kan blive ignoreret.",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Åbn telemetriindstillinger",
  ...
  "settings.language.description": 'Vælg sproget til Blitx-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.experimental.speechToText.description":
    "Aktivér stemmeinput i prompt-felter ved hjælp af din Blitx-konto gennem Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktivér og log ind på Blitx-udbyderen for at bruge Speech to Text. Speech to Text understøttes i øjeblikket kun med Blitx Gateway.",
  "settings.models.speechToTextModel.title": "Model til tale til tekst",
  "settings.models.speechToTextModel.description": "Vælg Blitx Gateway-transskriptionsmodellen til stemmeinput.",
  ...
  "settings.experimental.remote.description":
    "Aktivér Remote-styring af sessioner via Blitx Cloud. Dette vil også påvirke CLI'er på denne maskine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Indlæs CLAUDE.md-instruktioner og -færdigheder fra din Claude Code-konfigurationsmappe i sessioner. Aktivér dette, hvis du vil have Blitx til at bruge dine Claude Code-instruktioner og -færdigheder. Kræver genstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigureret. Tilføj MCP-servere i blitx.jsonc, eller bed agenten om at tilføje dem.",
  ...
  "settings.experimental.sandbox.description":
    "Kør shell-kommandoer for agenten i en sandbox på operativsystemniveau, der begrænser skrivning til projekt- og Blitx-tilstandsmapperne",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Blitx webview UI uafhængigt af VS Code.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "Legacy-migrering",
  "settings.aboutBlitx.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af Blitx, herunder udbyder API-nøgler og standardmodel.",
  "settings.aboutBlitx.rooImport.description": "Importer samtalehistorik fra en installation af Roo Code.",
  "settings.aboutBlitx.rooImport.button": "Importer sessioner fra Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én lille, effektiv kerne på tværs af alle Blitx-produkter. En velkendt oplevelse uanset hvordan du vælger at arbejde.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer ændret af Blitx i den aktuelle session, baseret på snapshots pr. tur. Nulstilles, når du starter en ny session.",
