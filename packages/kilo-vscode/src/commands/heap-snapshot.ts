...
export function registerHeapSnapshot(context: vscode.ExtensionContext, connectionService: BlitxConnectionService): void {
  context.subscriptions.push(
    vscode.commands.registerCommand("blitx-code.new.takeHeapSnapshot", async () => {
      try {
...
async function snapshot(connectionService: BlitxConnectionService) {
