...
// equivalents in @blitxcode/sdk. All API types (Session, Event, Agent,
// McpStatus, Config, etc.) should be imported from "@blitxcode/sdk/v2/client".

import type { IndexingStatus as SdkIndexingStatus } from "@blitxcode/sdk/v2/client"
