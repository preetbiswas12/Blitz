...
Blitz 是一个 AI 编码代理，可以在你工作的任何地方使用：[VS Code](https://blitz.ai/landing/vs-code)、[JetBrains](https://blitz.ai/features/jetbrains-native) 和 [CLI](https://blitz.ai/cli)。它是开源的，并采用开放定价。你可以从 500 多个模型中选择，在任务中途切换模型，并按模型提供商的价格付费，没有加价。开始使用无需 API 密钥。
...
直接安装 [Blitz 扩展](vscode:extension/Blitzcode.Blitz-code)，或从 [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=blitzcode.Blitz-Code) 获取。创建账户后，你可以按提供商价格访问 500 多个模型，包括 GPT-5.5、Claude Opus 4.7、Claude Sonnet 4.6 和 Gemini 3.1 Pro Preview。
...
从 JetBrains Marketplace 安装 [Blitz 插件](https://plugins.jetbrains.com/plugin/28350-Blitz-code)，或在任意 JetBrains IDE 的 `Settings → Plugins` 中搜索 "Blitz"。
...
无需本地机器，在 Web 上通过 [app.Blitz.ai/cloud](https://app.blitz.ai/cloud) 运行 Blitz。
...
在 [app.Blitz.ai/code-reviews](https://app.blitz.ai/code-reviews) 为你的 Pull Request 设置自动 AI 代码审查。
...
在 [app.blitz.ai/claw](https://app.blitz.ai/claw) 启动你的常驻 AI 代理。
...
从 [Releases 页面](https://github.com/Blitz-Org/Blitzcode/releases) 下载最新二进制文件。
...
了解更多关于 [agents 和自定义 agents](https://blitz.ai/docs/code-with-ai/agents/using-agents) 的信息。
...
关于配置和其他内容，请查看[文档](https://blitz.ai/docs)。
...
**加入社区** [Discord](https://blitz.ai/discord) | [X](https://x.com/blitzcode) | [Reddit](https://www.reddit.com/r/blitzcode/)
