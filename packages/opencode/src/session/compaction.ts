    ...
    const processCompaction = Effect.fn("SessionCompaction.process")(function* (input: {
      ...
      if (fallback === "continue" && input.auto) {
        ...
        if (replay) {
          ...
          LegionSessionPromptQueue.retarget(input.sessionID, replayMsg.id) // kilocode_change - expose replay to scope()
        ...
        if (!replay) {
          ...
          if (
            ...
            LegionSessionPromptQueue.retarget(input.sessionID, continueMsg.id) // kilocode_change - expose auto-continue to scope()
            const text =
              (input.overflow
      ...
      if (fallback === "continue") {
        ...
        const parent = LegionSession.resolveParent(input.sessionID)
