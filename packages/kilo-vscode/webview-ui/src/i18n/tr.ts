export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Anaconda Desktop'ı bu makineye kurun, ardından buraya dönün. Blitx kurulumu sizin için çalıştırmaz.",
  ...
  "provider.anaconda.state.signedOut": "Blitx'yu bağlamadan önce Anaconda Desktop'ı açın ve oturum açın.",
  "provider.anaconda.state.unauthorized":
    "Blitx Anaconda Desktop'a erişemedi. Desktop'ı açın, tekrar oturum açın ve gerekirse yeniden başlatın.",
  ...
  "provider.anaconda.state.ready":
    "Blitx sağlıklı bir yerel metin üretme sunucusu buldu ve mevcut bağlantı ayarlarını içe aktarabilir.",
  ...
  "provider.anaconda.toast.refreshed.description": "Etkin yerel sunucu ve modeller Blitx'da güncel.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx mevcut yetenekleri denetleyemedi.",
  "agentRequirements.error.mcpStatusFailed": "Blitx MCP sunucu durumunu denetleyemedi.",
  "agentRequirements.error.scopeMismatch": "Bu ajan gereksinimi denetimi artık etkin değil.",
  "agentRequirements.error.requestFailed": "Blitx ajan gereksinimlerini denetleyemedi.",
  ...
  "dialog.model.unpaid.freeModels.title": "Blitx tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Blitx'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix": "Hesabınızı bağlamak ve Blitx'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Blitx'da {{provider}} modellerini kullanın.",
  ...
  "prompt.action.sandbox.enabled": "Sandbox etkin. Agent shell komutları proje ve Blitx dizinleriyle sınırlıdır.",
  "prompt.action.sandbox.disabled":
    "Sandbox devre dışı. Agent shell komut yazma işlemlerini proje ve Blitx dizinleriyle sınırlamak için tıklayın.",
  ...
  "prompt.action.sandbox.description.enabled": "Yazma işlemleri proje ve Blitx dizinleriyle sınırlıdır.",
  ...
  "speechToText.tooltip.start": "Blitx Gateway ile sesli girişi başlatın",
  ...
  "speechToText.error.loginRequired": "Sesli girişi kullanmak için Blitx'ya giriş yapın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Blitx sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Blitx'nun yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Blitx ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Blitx henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Blitx ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Blitx Masaüstü",
  ...
  "settings.general.row.language.description": "Blitx'nun görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Blitx'nun cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Blitx'nun temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Blitx başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Blitx'nun en son sürümünü kullanıyorsunuz.",
  ...
  "settings.providers.betaNotice":
    "Şu anda yalnızca Blitx Gateway sağlayıcısı ayarlar arayüzünde yapılandırılabilir. Diğer sağlayıcılar için destek beta döneminde yakında gelecek. Bu arada CLI veya yapılandırma dosyası ile sağlayıcıları yapılandırabilirsiniz. Blitx'yu açık tutmaya kararlıyız, kilitlenme yok.",
  ...
  "settings.config.title": "{{scope}} Blitx yapılandırma dosyasını aç",
  "settings.config.placeholder":
    "Yapılandırma dosyaları sırayla birleştirilir; yüklendi olarak işaretlenen dosyalar şu anda ayarları etkiler.",
  "settings.config.noWorkspace": "Yerel Blitx yapılandırma dosyasını düzenlemek için bir çalışma alanı klasörü açın.",
  "settings.config.openFailed": "{{scope}} Blitx yapılandırma dosyası açılamadı: {{message}}",
  ...
  "workStyle.onboarding.welcome": "Blitx'ya hoş geldiniz",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx çalışırken duraklar ve planını size gösterir.",
  ...
  "session.cloud.import.placeholder": "Oturum kimliği, URL veya blitx import komutu",
  ...
  "deviceAuth.title": "Blitx'a giriş yap",
  ...
  "profile.action.login": "Blitx ile giriş yap",
  ...
  "profile.pass.subscribe": "Kredi eklemek ve bonus kazanmak için Blitx Pass edinin",
  ...
  "settings.aboutBlitx.title": "Blitx Hakkında",

  "session.messages.empty": "Aşağıya bir mesaj yazarak sohbete başlayın.",
  "session.messages.welcome":
    "Blitx bir yapay zeka kodlama asistanıdır. Özellik geliştirmesini, hata düzeltmesini veya kod tabanınızı açıklamasını isteyin.",
  ...
  "settings.aboutBlitx.status.connected": "Bağlı",
  "settings.aboutBlitx.status.connecting": "Bağlanıyor...",
  "settings.aboutBlitx.status.disconnected": "Bağlantı Kesildi",
  "settings.aboutBlitx.status.error": "Hata",
  "settings.aboutBlitx.cliServer": "CLI Sunucusu",
  "settings.aboutBlitx.status.label": "Durum:",
  "settings.aboutBlitx.port.label": "Port:",
  "settings.aboutBlitx.versionInfo": "Sürüm Bilgisi",
  "settings.aboutBlitx.version.label": "Sürüm:",
  "settings.aboutBlitx.extensionName": "Blitx Uzantısı",
  "settings.aboutBlitx.community": "Topluluk ve Destek",
  "settings.aboutBlitx.feedback.prefix":
    "Herhangi bir sorunuz veya geri bildiriminiz varsa, lütfen şu adreste bir sorun açın:",
  "settings.aboutBlitx.feedback.or": "veya",
  "settings.aboutBlitx.support.prefix": "Faturalama veya hesap soruları için Müşteri Desteği ile iletişime geçin:",
  "settings.aboutBlitx.resetSettings.title": "Ayarları Sıfırla",
  ...
  "settings.aboutBlitx.resetSettings.button": "Tüm Ayarları Sıfırla",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Ayar Aktarımı",
  ...
  "settings.aboutBlitx.exportSettings": "Dışa Aktar",
  "settings.aboutBlitx.importSettings": "İçe Aktar",
  "settings.aboutBlitx.importSettings.invalidJson": "Geçersiz JSON dosyası. Lütfen geçerli bir ayar dosyası seçin.",
  "settings.aboutBlitx.importSettings.invalidConfig": "Dosya geçerli Blitx ayarları içermiyor.",
  "settings.aboutBlitx.importSettings.tooLarge": "Dosya çok büyük. Ayar dosyaları 1 MB altında olmalıdır.",
  "settings.aboutBlitx.importSettings.newerVersion":
    "Bu dosya Blitx'nun daha yeni bir sürümünden dışa aktarılmış. Bazı ayarlar göz ardı edilebilir.",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Telemetri Ayarlarını Aç",
  ...
  "settings.language.description":
    '"Otomatik" VS Code görüntüleme dilinizi kullanır. Blitx arayüzü için dil seçin.',
  ...
  "settings.experimental.speechToText.description":
    "Blitx Gateway üzerinden Blitx hesabınızı kullanarak komut alanlarında sesli girişi etkinleştirin.",
  "settings.models.speechToText.disabledDescription":
    "Speech to Text kullanmak için Blitx sağlayıcısını etkinleştirin ve giriş yapın. Speech to Text şu anda yalnızca Blitx Gateway ile desteklenmektedir.",
  "settings.models.speechToTextModel.title": "Sesten metne modeli",
  "settings.models.speechToTextModel.description": "Sesli giriş için Blitx Gateway transkripsiyon modelini seçin.",
  ...
  "settings.experimental.remote.description":
    "Blitx Cloud üzerinden oturumların Remote kontrolünü etkinleştirin. Bu, bu makinedeki CLI'leri de etkileyecektir.",
  ...
  "settings.experimental.sandbox.description":
    "Agent shell komutlarını, proje ve Blitx durum dizinlerine yazmaları kısıtlanan işletim sistemi düzeyinde bir sandbox içinde çalıştırın",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code yapılandırma dizininizdeki CLAUDE.md talimatlarını ve becerilerini oturumlara yükleyin. Blitx'nun Claude Code talimatlarınızı ve becerilerinizi kullanmasını istiyorsanız bunu etkinleştirin. Yeniden başlatma gerektirir.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Yapılandırılmış MCP sunucusu yok. blitx.jsonc dosyasına MCP sunucuları ekleyin veya ajanın eklemesini isteyin.",
  ...
  "settings.display.fontSize.description": "Blitx webview UI yazı tipi boyutunu VS Code'dan bağımsız olarak ayarlayın.",
  ...
  "settings.models.hidePromptTraining.description":
    "Sağlayıcıları istemlerinizi eğitim için kullanabilecek Blitx Gateway modellerini gizleyin.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "Eski Sürüm Taşıma",
  "settings.aboutBlitx.legacyMigration.description":
    "Sağlayıcı API anahtarları ve varsayılan model dahil olmak üzere Blitx'un önceki yüklemesinden ayarları taşıyın.",
  "settings.aboutBlitx.rooImport.description": "Bir Roo Code yüklemesinden konuşma geçmişini içe aktarın.",
  "settings.aboutBlitx.rooImport.button": "Roo Code'dan Oturumları İçe Aktar",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Blitx'daki Yenilikler",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Her Blitx ürününde küçük ve verimli bir çekirdek. Nasıl çalışmayı tercih ederseniz edin, tanıdık bir deneyim.",
  ...
  "settings.indexing.blitxModel.title": "Blitx model önayarı",
  "settings.indexing.blitxModel.description": "Desteklenen bir Blitx-hosted embeddings modeli seçin.",
  "settings.indexing.blitxSignIn.title": "Blitx oturumu açmak gerekiyor",
  "settings.indexing.blitxSignIn.description": "Hosted embeddings kullanmak için Blitx'da oturum açın.",
  ...
  "diffViewer.source.session.tooltip":
    "Geçerli oturum sırasında Blitx tarafından değiştirilen dosyalar, tur başı anlık görüntülere dayanır. Yeni bir oturum başlatıldığında sıfırlanır.",
