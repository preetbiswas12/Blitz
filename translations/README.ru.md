...
Установите [расширение Blitz](vscode:extension/Blitzcode.Blitz-code) напрямую или скачайте его из [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=blitzcode.Blitz-Code). Создайте аккаунт и получите доступ к более чем 500 моделям, включая GPT-5.5, Claude Opus 4.7, Claude Sonnet 4.6 и Gemini 3.1 Pro Preview, все по ценам поставщиков.
...
Установите [плагин Blitz](https://plugins.jetbrains.com/plugin/28350-Blitz-code) из JetBrains Marketplace или найдите "Blitz" в `Settings → Plugins` в любой IDE JetBrains.
...
Запускайте Blitz из веба без локальной машины на [app.Blitz.ai/cloud](https://app.blitz.ai/cloud).
...
Настройте автоматические AI-ревью кода для ваших pull request на [app.Blitz.ai/code-reviews](https://app.blitz.ai/code-reviews).
...
Запустите своего постоянно активного AI-агента на [app.blitz.ai/claw](https://app.blitz.ai/claw).
...
Скачайте последний бинарный файл со [страницы Releases](https://github.com/Blitz-Org/Blitzcode/releases).
...
Подробнее об [agents и пользовательских agents](https://blitz.ai/docs/code-with-ai/agents/using-agents).
...
Для настройки и всего остального перейдите к [документации](https://blitz.ai/docs).
...
**Присоединяйтесь к сообществу** [Discord](https://blitz.ai/discord) | [X](https://x.com/blitzcode) | [Reddit](https://www.reddit.com/r/blitzcode/)
