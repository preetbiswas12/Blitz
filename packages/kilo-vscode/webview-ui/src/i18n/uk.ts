export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Встановіть Anaconda Desktop на цьому комп'ютері, а потім поверніться сюди. Blitx не запускає інсталятор за вас.",
  ...
  "provider.anaconda.state.signedOut": "Відкрийте Anaconda Desktop та увійдіть перед підключенням Blitx.",
  "provider.anaconda.state.unauthorized":
    "Blitx не вдалося отримати доступ до Anaconda Desktop. Відкрийте Desktop, увійдіть знову та перезапустіть його за потреби.",
  ...
  "provider.anaconda.state.ready":
    "Blitx знайшов справний локальний сервер генерації тексту та може імпортувати його поточні налаштування підключення.",
  ...
  "provider.anaconda.toast.refreshed.description": "Активний локальний сервер та моделі актуальні в Blitx.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx не зміг перевірити доступні навички.",
  "agentRequirements.error.mcpStatusFailed": "Blitx не зміг перевірити стан сервера MCP.",
  "agentRequirements.error.scopeMismatch": "Ця перевірка вимог агента більше не активна.",
  "agentRequirements.error.requestFailed": "Blitx не зміг перевірити вимоги агента.",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Blitx",
  ...
  "provider.connect.apiKey.description":
    "Введіть свій API-ключ {{provider}}, щоб підключити акаунт {{provider}} і використовувати моделі {{provider}} в Blitx.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " щоб отримати код авторизації для підключення акаунта та використання моделей {{provider}} у Blitx.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " та введіть код нижче, щоб підключити акаунт і використовувати моделі {{provider}} у Blitx.",
  ...
  "prompt.action.sandbox.enabled": "Пісочницю увімкнено. Команди оболонки агента обмежені каталогами проєкту та Blitx.",
  "prompt.action.sandbox.disabled":
    "Пісочницю вимкнено. Натисніть, щоб обмежити запис команд оболонки агента каталогами проєкту та Blitx.",
  ...
  "prompt.action.sandbox.description.enabled": "Запис дозволено лише в каталогах проєкту та Blitx.",
  ...
  "speechToText.tooltip.start": "Почати голосове введення з Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "Увійдіть до Blitx, щоб використовувати голосове введення.",
  ...
  "dialog.server.description": "Змінити, до якого сервера Blitx підключається цей додаток.",
  ...
  "toast.update.description": "Нова версія Blitx ({{version}}) готова до встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Blitx",
  ...
  "error.chain.mcpFailed": 'MCP-сервер "{{name}}" зазнав помилки. Примітка: Blitx поки не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Blitx включає безкоштовні моделі, тому ви можете почати відразу.",
  ...
  "settings.general.row.language.description": "Змінити мову відображення Blitx",
  "settings.general.row.appearance.title": "Вигляд",
  "settings.general.row.appearance.description": "Налаштувати вигляд Blitx на вашому пристрої",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштувати тему Blitx.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти оновлення при запуску Blitx",
  ...
  "settings.updates.toast.latest.description": "У вас встановлена остання версія Blitx.",
  ...
  "settings.providers.betaNotice":
    "Наразі в інтерфейсі налаштувань можна налаштувати лише провайдера Blitx Gateway. Підтримка інших провайдерів з'явиться в бета-версії найближчим часом. Тим часом ви можете налаштовувати провайдерів через CLI або файл конфігурації. Blitx залишається відкритим — без прив'язки.",
  ...
  "settings.config.title": "Відкрити файл конфігурації Blitx ({{scope}})",
  "settings.config.placeholder":
    "Файли конфігурації об'єднуються по порядку; файли, позначені як завантажені, наразі впливають на налаштування.",
  "settings.config.noWorkspace": "Відкрийте папку робочої області, щоб відредагувати локальний файл конфігурації Blitx.",
  "settings.config.openFailed": "Не вдалося відкрити файл конфігурації Blitx ({{scope}}): {{message}}",
  ...
  "workStyle.onboarding.welcome": "Ласкаво просимо до Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx призупиняється та показує свій план у процесі роботи.",
  ...
  "session.cloud.import.placeholder": "Ідентифікатор сесії, URL або команда blitx import",
  ...
  "deviceAuth.title": "Увійти до Blitx",
  ...
  "profile.action.login": "Увійти через Blitx",
  ...
  "profile.pass.subscribe": "Отримайте Blitx Pass, щоб додати кредити та заробляти бонуси",
  ...
  "settings.aboutBlitx.title": "Про Blitx",

  "session.messages.empty": "Напишіть повідомлення нижче, щоб розпочати чат.",
  "session.messages.welcome":
    "Blitx — це асистент з кодування на базі ШІ. Попросіть його розробити функцію, виправити помилку або пояснити вашу кодову базу.",
  ...
  "settings.aboutBlitx.status.connected": "Підключено",
  "settings.aboutBlitx.status.connecting": "Підключення...",
  "settings.aboutBlitx.status.disconnected": "Відключено",
  "settings.aboutBlitx.status.error": "Помилка",
  "settings.aboutBlitx.cliServer": "CLI-сервер",
  "settings.aboutBlitx.status.label": "Статус:",
  "settings.aboutBlitx.port.label": "Порт:",
  "settings.aboutBlitx.versionInfo": "Інформація про версію",
  "settings.aboutBlitx.version.label": "Версія:",
  "settings.aboutBlitx.extensionName": "Розширення Blitx",
  "settings.aboutBlitx.community": "Спільнота і підтримка",
  "settings.aboutBlitx.feedback.prefix": "Якщо у вас є питання або відгуки, будь ласка, відкрийте тікет на:",
  "settings.aboutBlitx.feedback.or": "або",
  "settings.aboutBlitx.support.prefix": "З питань виставлення рахунків або акаунту зверніться до служби підтримки:",
  "settings.aboutBlitx.resetSettings.title": "Скидання налаштувань",
  ...
  "settings.aboutBlitx.resetSettings.button": "Скинути всі налаштування",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Перенесення налаштувань",
  ...
  "settings.aboutBlitx.exportSettings": "Експортувати",
  "settings.aboutBlitx.importSettings": "Імпортувати",
  "settings.aboutBlitx.importSettings.invalidJson":
    "Недійсний файл JSON. Будь ласка, виберіть дійсний файл налаштувань.",
  "settings.aboutBlitx.importSettings.invalidConfig": "Файл не містить дійсних налаштувань Blitx.",
  "settings.aboutBlitx.importSettings.tooLarge": "Файл занадто великий. Файли налаштувань мають бути менше 1 МБ.",
  "settings.aboutBlitx.importSettings.newerVersion":
    "Цей файл було експортовано з новішої версії Blitx. Деякі налаштування можуть бути проігноровані.",
  "settings.aboutBlitx.importSettings.success":
    "Налаштування імпортовано. Перегляньте зміни вище, потім натисніть Зберегти.",

  "settings.aboutBlitx.telemetry.title": "Телеметрія",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Відкрити налаштування телеметрії",
  ...
  "settings.language.description":
    '"Автоматично" використовує мову відображення VS Code. Виберіть мову для інтерфейсу Blitx.',
  ...
  "settings.experimental.speechToText.description":
    "Увімкніть голосове введення в полях запитів, використовуючи ваш обліковий запис Blitx через Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Увімкніть провайдер Blitx та виконайте вхід, щоб використовувати Speech to Text. Наразі Speech to Text підтримується лише з Blitx Gateway.",
  "settings.models.speechToTextModel.title": "Модель мовлення в текст",
  "settings.models.speechToTextModel.description": "Виберіть модель транскрипції Blitx Gateway для голосового введення.",
  ...
  "settings.experimental.remote.description":
    "Увімкніть керування Remote сеансами через Blitx Cloud. Це також вплине на CLI на цьому комп'ютері.",
  ...
  "settings.experimental.sandbox.description":
    "Виконувати команди оболонки агента в пісочниці на рівні ОС, яка обмежує запис до каталогів стану проєкту та Blitx",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Завантажувати інструкції та навички CLAUDE.md з вашого каталогу конфігурації Claude Code у сесії. Увімкніть це, якщо ви хочете, щоб Blitx використовував ваші інструкції та навички Claude Code. Потребує перезапуску.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверів не налаштовано. Додайте MCP-сервери до blitx.jsonc або попросіть агента додати їх.",
  ...
  "settings.display.fontSize.description": "Налаштуйте розмір шрифту webview UI для Blitx незалежно від VS Code.",
  ...
  "settings.models.hidePromptTraining.description":
    "Приховувати моделі Blitx Gateway, постачальники яких можуть використовувати ваші запити для навчання.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "Перенесення зі старої версії",
  "settings.aboutBlitx.legacyMigration.description":
    "Перенести налаштування з попередньої версії Blitx, включаючи API-ключі провайдерів та стандартну модель.",
  "settings.aboutBlitx.rooImport.description": "Імпортувати історію розмов з інсталяції Roo Code.",
  "settings.aboutBlitx.rooImport.button": "Імпортувати сесії з Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Що нового в Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Малий та ефективний ядерний модуль у кожному продукті Blitx. Знайомий досвід незалежно від того, як ви вважаєте за краще працювати.",
  ...
  "settings.indexing.blitxModel.title": "Пресет моделі Blitx",
  "settings.indexing.blitxModel.description": "Виберіть підтримувану модель Blitx-hosted embeddings.",
  "settings.indexing.blitxSignIn.title": "Потрібен вхід у Blitx",
  "settings.indexing.blitxSignIn.description": "Увійдіть у Blitx, щоб використовувати hosted embeddings.",
  ...
  "diffViewer.source.session.tooltip":
    "Файли, змінені Blitx під час поточної сесії, на основі знімків по ходу. Скидається при старті нової сесії.",
