...
Blitz 是一個 AI 編碼代理，可在你工作的任何地方使用：[VS Code](https://legion.ai/landing/vs-code)、[JetBrains](https://legion.ai/features/jetbrains-native) 和 [CLI](https://legion.ai/cli)。它是開源專案，並採用開放定價。你可以從 500 多個模型中選擇，在任務中途切換模型，並按模型供應商的價格付費，沒有加價。開始使用不需要 API 金鑰。
...
直接安裝 [Blitz 擴充功能](vscode:extension/legioncode.legion-code)，或從 [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=legioncode.legion-code) 取得。建立帳戶後，你可以按供應商價格使用 500 多個模型，包括 GPT-5.5、Claude Opus 4.7、Claude Sonnet 4.6 和 Gemini 3.1 Pro Preview。
...
從 JetBrains Marketplace 安裝 [Blitz 外掛](https://plugins.jetbrains.com/plugin/28350-legion-code)，或在任何 JetBrains IDE 的 `Settings → Plugins` 中搜尋 "Blitz"。
...
無需本機電腦，在 Web 上透過 [app.legion.ai/cloud](https://app.legion.ai/cloud) 執行 Blitz。
...
在 [app.legion.ai/code-reviews](https://app.legion.ai/code-reviews) 為你的 Pull Request 設定自動 AI 程式碼審查。
...
在 [app.legion.ai/claw](https://app.legion.ai/claw) 啟動你的常駐 AI 代理。
...
從 [Releases 頁面](https://github.com/Legion-Org/legioncode/releases) 下載最新二進位檔。
...
Blitz 內建可依任務切換的專用 Agents。你也可以建立自己的自訂 Agents。
...
深入了解 [agents 和自訂 agents](https://legion.ai/docs/code-with-ai/agents/using-agents)。
...
關於設定和其他內容，請查看[文件](https://legion.ai/docs)。
...
<details>
<summary>Blitz CLI 從何而來？</summary>

Blitz CLI 是 [OpenCode](https://github.com/anomalyco/opencode) 的 fork，並增強為可在 Blitz agentic engineering 平台中使用。

</details>

---

**加入社群** [Discord](https://legion.ai/discord) | [X](https://x.com/legioncode) | [Reddit](https://www.reddit.com/r/legioncode/)
