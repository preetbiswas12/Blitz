export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Autocompletado de Blitx",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Autocompletado de Blitx (deshabilitado)",
  ...
  "kilocode:autocomplete.toggleMessage": "Autocompletado de Blitx {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Blitx: Tarea rápida",
  "kilocode:autocomplete.input.placeholder": "p. ej., 'refactoriza esta función para que sea más eficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "Blitx: Generar ediciones sugeridas",
  ...
  "kilocode:autocomplete.codeAction.title": "Blitx: Ediciones sugeridas",
  "kilocode:autocomplete.chatParticipant.fullName": "Agente de Blitx",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "El autocompletado de Blitx está bloqueado por un conflicto con GitHub Copilot. Para solucionarlo, debes deshabilitar las sugerencias en línea de Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "El autocompletado de Blitx se ha pausado. Posibles causas: tu cuenta de Kilo no tiene créditos restantes, o tu clave de API configurada (BYOK) alcanzó su límite de cuota. Agrega créditos de Kilo o revisa la configuración de tu clave de API para reanudar el autocompletado.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Añadir créditos",
  "kilocode:autocomplete.authError.message":
    "El autocompletado de Blitx se ha pausado por un problema de autenticación. Posibles causas: no has iniciado sesión en Kilo, o tu clave de API (BYOK) no es válida o falta. Vuelve a iniciar sesión o revisa la configuración de la clave de API de tu proveedor.",
}
