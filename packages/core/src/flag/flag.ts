...
const BLITX_DISABLE_CLAUDE_CODE = truthy("BLITX_DISABLE_CLAUDE_CODE")
const BLITX_DISABLE_CLAUDE_CODE_SKILLS = BLITX_DISABLE_CLAUDE_CODE || truthy("BLITX_DISABLE_CLAUDE_CODE_SKILLS")
...
export const Flag = {
  ...
  BLITX_DISABLE_CLAUDE_CODE,
  BLITX_DISABLE_CLAUDE_CODE_PROMPT: BLITX_DISABLE_CLAUDE_CODE || truthy("BLITX_DISABLE_CLAUDE_CODE_PROMPT"),
  BLITX_DISABLE_CLAUDE_CODE_SKILLS,
  ...
  BLITX_SERVER_PASSWORD: process.env["BLITX_SERVER_PASSWORD"],
  ...
  BLITX_DISABLE_CHANNEL_DB: truthy("BLITX_DISABLE_CHANNEL_DB"),
  ...
  get BLITX_CONFIG_DIR() {
    return process.env["BLITX_CONFIG_DIR"]
  },
  get KILO_PURE() {
  ...
  get BLITX_CLIENT() {
    return process.env["BLITX_CLIENT"] ?? "cli"
  },
  get BLITX_SESSION_RETRY_LIMIT() {
    return number("BLITX_SESSION_RETRY_LIMIT")
  },
}
