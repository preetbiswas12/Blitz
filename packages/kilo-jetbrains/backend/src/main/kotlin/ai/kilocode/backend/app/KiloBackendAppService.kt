  ...
  private val loadTimeoutMs: Long,
    ...
    fun requireReady() {
        when (_appState.value) {
            ...
            else -> throw IllegalStateException("Blitx backend is not ready")
        }
    }
    ...
    suspend fun updateConfig(patch: ConfigPatchDto): KiloAppState {
        ...
        val current = _appState.value as? KiloAppState.Ready ?: throw IllegalStateException("Blitx backend is not ready")
