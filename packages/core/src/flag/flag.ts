...
const LEGION_DISABLE_CLAUDE_CODE = truthy("LEGION_DISABLE_CLAUDE_CODE")
const LEGION_DISABLE_CLAUDE_CODE_SKILLS = LEGION_DISABLE_CLAUDE_CODE || truthy("LEGION_DISABLE_CLAUDE_CODE_SKILLS")
...
export const Flag = {
  ...
  LEGION_DISABLE_CLAUDE_CODE_PROMPT: LEGION_DISABLE_CLAUDE_CODE || truthy("LEGION_DISABLE_CLAUDE_CODE_PROMPT"),
  ...
  LEGION_SERVER_PASSWORD: process.env["LEGION_SERVER_PASSWORD"],
  ...
  LEGION_DISABLE_CHANNEL_DB: truthy("LEGION_DISABLE_CHANNEL_DB"),
  ...
  get LEGION_SESSION_RETRY_LIMIT() {
    return number("LEGION_SESSION_RETRY_LIMIT")
  },
}
