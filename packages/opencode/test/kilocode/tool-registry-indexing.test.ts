...
describe("kilocode tool registry indexing", () => {
  ...
  test("conditionally includes Kilo registry extras", () => {
    ...
    const tools = {
      ...
      testRunner: def("test_runner"),
      gitPRCreate: def("git_pr_create"),
      gitPRList: def("git_pr_list"),
      gitConflictResolve: def("git_conflict_resolve"),
      gitConflictList: def("git_conflict_list"),
      gitBlame: def("git_blame"),
