...
function infos() {
  return {
    ...
    terminal: info("interactive_terminal"),
    testRunner: info("test_runner"),
    gitPRCreate: info("git_pr_create"),
    gitPRList: info("git_pr_list"),
    gitConflictResolve: info("git_conflict_resolve"),
    gitConflictList: info("git_conflict_list"),
    gitBlame: info("git_blame"),
