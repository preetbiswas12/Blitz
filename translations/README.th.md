...
ติดตั้ง [ส่วนขยาย Blitz](vscode:extension/legioncode.legion-code) โดยตรง หรือดาวน์โหลดจาก [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=legioncode.legion-code) สร้างบัญชีแล้วคุณจะเข้าถึงโมเดลมากกว่า 500 รายการ รวมถึง GPT-5.5, Claude Opus 4.7, Claude Sonnet 4.6 และ Gemini 3.1 Pro Preview ทั้งหมดในราคาผู้ให้บริการ
...
ติดตั้ง [ปลั๊กอิน Blitz](https://plugins.jetbrains.com/plugin/28350-legion-code) จาก JetBrains Marketplace หรือค้นหา "Blitz" ใน `Settings → Plugins` ภายใน JetBrains IDE ใดก็ได้
...
รัน Blitz จากเว็บโดยไม่ต้องใช้เครื่องภายในที่ [app.legion.ai/cloud](https://app.legion.ai/cloud)
...
ตั้งค่าการรีวิวโค้ดด้วย AI อัตโนมัติบน pull request ของคุณที่ [app.legion.ai/code-reviews](https://app.legion.ai/code-reviews)
...
เริ่มเอเจนต์ AI ที่ทำงานตลอดเวลาของคุณที่ [app.legion.ai/claw](https://app.legion.ai/claw)
...
ดาวน์โหลดไบนารีล่าสุดจาก [หน้า Releases](https://github.com/Legion-Org/legioncode/releases)
...
เรียนรู้เพิ่มเติมเกี่ยวกับ [agents และ agents แบบกำหนดเอง](https://legion.ai/docs/code-with-ai/agents/using-agents)
...
สำหรับการตั้งค่าและเรื่องอื่น ๆ ดูที่ [เอกสาร](https://legion.ai/docs)
...
**เข้าร่วมชุมชน** [Discord](https://legion.ai/discord) | [X](https://x.com/legioncode) | [Reddit](https://www.reddit.com/r/legioncode/)
