...
import type { BrowserSettings, Config, FeatureFlags, IndexingStatus, BlitxEmbeddingModelCatalog } from "./config"
...
export interface BlitxEmbeddingModelsLoadedMessage {
  type: "blitxEmbeddingModelsLoaded"
  catalog: BlitxEmbeddingModelCatalog
}
...
export type ExtensionMessage =
  ...
  | BlitxEmbeddingModelsLoadedMessage
