...
export class WorktreeManager {
  ...
  async ensureGitExclude(): Promise<void> {
    ...
    const items = [
      [".kilo/worktrees/", "Blitx agent worktrees"],
      [".kilo/agent-manager.json", "Blitx Agent Manager state"],
      [".kilo/setup-script", "Blitx worktree setup script"],
      [".kilo/setup-script.sh", "Blitx worktree setup script"],
      [".kilo/setup-script.ps1", "Blitx worktree setup script"],
      [".kilo/setup-script.cmd", "Blitx worktree setup script"],
      [".kilo/setup-script.bat", "Blitx worktree setup script"],
      [".kilocode/worktrees/", "Blitx legacy agent worktrees"],
      [".kilocode/agent-manager.json", "Blitx Agent Manager legacy state"],
      [".kilocode/setup-script", "Blitx legacy worktree setup script"],
      [".kilocode/setup-script.sh", "Blitx legacy worktree setup script"],
      [".kilocode/setup-script.ps1", "Blitx legacy worktree setup script"],
      [".kilocode/setup-script.cmd", "Blitx legacy worktree setup script"],
      [".kilocode/setup-script.bat", "Blitx legacy worktree setup script"],
    ] as const
