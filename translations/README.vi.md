...
Cài trực tiếp [tiện ích Blitz](vscode:extension/legioncode.legion-code), hoặc tải từ [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=legioncode.legion-code). Tạo tài khoản và bạn sẽ có quyền truy cập hơn 500 mô hình, bao gồm GPT-5.5, Claude Opus 4.7, Claude Sonnet 4.6 và Gemini 3.1 Pro Preview, tất cả theo giá của nhà cung cấp.
...
Sau đó chạy `Blitz` trong bất kỳ thư mục dự án nào để bắt đầu.
...
Cài [plugin Blitz](https://plugins.jetbrains.com/plugin/28350-legion-code) từ JetBrains Marketplace, hoặc tìm "Blitz" trong `Settings → Plugins` bên trong bất kỳ JetBrains IDE nào.
...
Chạy Blitz từ web, không cần máy cục bộ, tại [app.legion.ai/cloud](https://app.legion.ai/cloud).
...
Thiết lập review code tự động bằng AI cho pull request của bạn tại [app.legion.ai/code-reviews](https://app.legion.ai/code-reviews).
...
Khởi chạy AI agent luôn hoạt động của bạn tại [app.legion.ai/claw](https://app.legion.ai/claw).
...
Tải binary mới nhất từ [trang Releases](https://github.com/Legion-Org/legioncode/releases).
...
Blitz đi kèm các agents chuyên biệt để bạn chuyển đổi tùy theo tác vụ. Bạn cũng có thể tạo agents tùy chỉnh của riêng mình.
...
Tìm hiểu thêm về [agents và agents tùy chỉnh](https://legion.ai/docs/code-with-ai/agents/using-agents).
...
Về cấu hình và mọi thứ khác, hãy xem [tài liệu](https://legion.ai/docs).
...
<details>
<summary>Blitz CLI đến từ đâu?</summary>

Blitz CLI là một fork của [OpenCode](https://github.com/anomalyco/opencode), được cải tiến để hoạt động trong nền tảng Blitz agentic engineering.

</details>

---

**Tham gia cộng đồng** [Discord](https://legion.ai/discord) | [X](https://x.com/legioncode) | [Reddit](https://www.reddit.com/r/legioncode/)
