export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Instala Anaconda Desktop en este equipo y luego vuelve aquí. Blitx no ejecuta el instalador por ti.",
  ...
  "provider.anaconda.state.signedOut": "Abre Anaconda Desktop e inicia sesión antes de conectar Blitx.",
  "provider.anaconda.state.unauthorized":
    "Blitx no pudo acceder a Anaconda Desktop. Abre Desktop, inicia sesión de nuevo y reinícialo si es necesario.",
  ...
  "provider.anaconda.state.ready":
    "Blitx encontró un servidor local de generación de texto en buen estado y puede importar su configuración de conexión actual.",
  ...
  "provider.anaconda.toast.refreshed.description": "El servidor local activo y los modelos están actualizados en Blitx.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx no pudo comprobar las habilidades disponibles.",
  "agentRequirements.error.mcpStatusFailed": "Blitx no pudo comprobar el estado del servidor MCP.",
  "agentRequirements.error.scopeMismatch": "Esta comprobación de requisitos del agente ya no está activa.",
  "agentRequirements.error.requestFailed": "Blitx no pudo comprobar los requisitos del agente.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Blitx",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Blitx.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Blitx.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Blitx.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox activado. Los comandos de shell del agente están limitados a los directorios del proyecto y de Blitx.",
  "prompt.action.sandbox.disabled":
    "Sandbox desactivado. Haz clic para limitar las escrituras de los comandos de shell del agente a los directorios del proyecto y de Blitx.",
  ...
  "prompt.action.sandbox.description.enabled": "Las escrituras se limitan a los directorios del proyecto y de Blitx.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz con Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "Inicia sesión en Blitx para usar la entrada de voz.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Blitx se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Blitx ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Blitx",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Blitx no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Blitx incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "app.name.desktop": "Blitx Desktop",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Blitx",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Blitx en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Blitx.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Blitx",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Blitx.",
  ...
  "settings.indexing.blitxModel.title": "Preajuste de modelo de Blitx",
  "settings.indexing.blitxModel.description": "Elige un modelo de embeddings alojado por Blitx compatible.",
  "settings.indexing.blitxSignIn.title": "Se requiere iniciar sesión en Blitx",
  "settings.indexing.blitxSignIn.description": "Inicia sesión en Blitx para usar embeddings alojados.",
  ...
  "settings.providers.betaNotice":
    "Actualmente, solo el proveedor Blitx Gateway se puede configurar en la interfaz de ajustes. El soporte para configurar otros proveedores llegará pronto durante el período beta. Mientras tanto, puedes configurar proveedores usando la CLI o el archivo de configuración. Estamos comprometidos a mantener Blitx abierto, sin ataduras.",
  ...
  "settings.models.hidePromptTraining.description":
    "Oculta los modelos de Blitx Gateway cuyos proveedores pueden usar tus prompts para entrenamiento.",
  ...
  "settings.config.title": "Abrir archivo de configuración Blitx {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Abre una carpeta de espacio de trabajo para editar el archivo de configuración Blitx local.",
  "settings.config.openFailed": "Error al abrir el archivo de configuración Blitx {{scope}}: {{message}}",
  ...
  "settings.config.source.envDir": "BLITX_CONFIG_DIR",
  ...
  "workStyle.onboarding.welcome": "Te damos la bienvenida a Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx se detiene y te muestra su plan mientras trabaja.",
  ...
  "session.cloud.import.placeholder": "ID de sesión, URL o comando blitx import",
  ...
  "deviceAuth.title": "Iniciar sesión en Blitx",
  ...
  "profile.action.login": "Iniciar sesión con Blitx",
  ...
  "profile.pass.subscribe": "Obtén Blitx Pass para añadir créditos y ganar bonificaciones",
  ...
  "settings.aboutBlitx.title": "Acerca de Blitx",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "Blitx es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutBlitx.status.connected": "Conectado",
  "settings.aboutBlitx.status.connecting": "Conectando...",
  "settings.aboutBlitx.status.disconnected": "Desconectado",
  "settings.aboutBlitx.status.error": "Error",
  "settings.aboutBlitx.cliServer": "Servidor CLI",
  "settings.aboutBlitx.status.label": "Estado:",
  "settings.aboutBlitx.port.label": "Puerto:",
  "settings.aboutBlitx.versionInfo": "Información de versión",
  "settings.aboutBlitx.version.label": "Versión:",
  "settings.aboutBlitx.extensionName": "Extensión Blitx",
  "settings.aboutBlitx.community": "Comunidad y soporte",
  "settings.aboutBlitx.feedback.prefix": "Si tienes preguntas o comentarios, abre un issue en",
  "settings.aboutBlitx.feedback.or": "o",
  "settings.aboutBlitx.support.prefix": "Para preguntas de facturación o cuenta, contacta al Soporte al Cliente en",
  "settings.aboutBlitx.resetSettings.title": "Restablecer configuración",
  "settings.aboutBlitx.resetSettings.description":
  ...
  "settings.aboutBlitx.resetSettings.button": "Restablecer toda la configuración",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Transferencia de ajustes",
  "settings.aboutBlitx.settingsTransfer.description":
    "Exporta o importa tus ajustes para transferirlos entre instancias de VS Code.",
  "settings.aboutBlitx.exportSettings": "Exportar",
  "settings.aboutBlitx.importSettings": "Importar",
  "settings.aboutBlitx.importSettings.invalidJson":
    "Archivo JSON no válido. Seleccione un archivo de ajustes válido.",
  "settings.aboutBlitx.importSettings.invalidConfig": "El archivo no contiene ajustes válidos de Blitx.",
  "settings.aboutBlitx.importSettings.tooLarge":
    "El archivo es demasiado grande. Los archivos de ajustes deben ser menores de 1 MB.",
  "settings.aboutBlitx.importSettings.newerVersion":
    "Este archivo fue exportado desde una versión más reciente de Blitx. Algunos ajustes podrían ignorarse.",
  "settings.aboutBlitx.importSettings.success":
    "Ajustes importados. Revise los cambios anteriores y luego haga clic en Guardar.",

  "settings.aboutBlitx.telemetry.title": "Telemetría",
  "settings.aboutBlitx.telemetry.description":
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Abrir configuración de telemetría",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de Blitx. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Habilita la entrada de voz en los campos de prompt usando tu cuenta de Blitx a través de Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Habilita e inicia sesión en el proveedor Blitx para usar Speech to Text. Actualmente, Speech to Text solo es compatible con Blitx Gateway.",
  "settings.models.speechToTextModel.title": "Modelo de voz a texto",
  "settings.models.speechToTextModel.description":
    "Elige el modelo de transcripción de Blitx Gateway para la entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite el control Remote de las sesiones a través de Blitx Cloud. Esto también afectará a las CLI de este equipo.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carga las instrucciones y habilidades de CLAUDE.md desde tu directorio de configuración de Claude Code en las sesiones. Activa esta opción si quieres que Blitx utilice tus instrucciones y habilidades de Claude Code. Requiere reiniciar.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No hay servidores MCP configurados. Añada servidores MCP en blitx.jsonc o pida al agente que los añada.",
  ...
  "settings.experimental.sandbox.description":
    "Ejecutar los comandos de shell del agente dentro de un sandbox a nivel de sistema operativo que restringe las escrituras a los directorios de estado del proyecto y de Blitx",
  ...
  "settings.display.fontSize.description":
    "Ajusta el tamaño de fuente de la webview UI de Blitx de forma independiente a VS Code.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "Migración heredada",
  "settings.aboutBlitx.legacyMigration.description":
    "Migra la configuración de una instalación anterior de Blitx, incluyendo las claves API de proveedores y el modelo predeterminado.",
  "settings.aboutBlitx.rooImport.description":
    "Importa el historial de conversaciones de una instalación de Roo Code.",
  "settings.aboutBlitx.rooImport.button": "Importar sesiones desde Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un núcleo pequeño y eficiente en todos los productos Blitx. Una experiencia familiar sin importar cómo elijas trabajar.",
  ...
  "diffViewer.source.session.tooltip":
    "Archivos modificados por Blitx durante la sesión actual, basado en snapshots por turno. Se reinicia al empezar una nueva sesión.",
