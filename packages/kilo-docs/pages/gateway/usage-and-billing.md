...
Your account balance is the difference between total credits purchased and total usage. Check your balance in the [Kilo dashboard](https://app.kilo.ai). <!-- TODO: Replace with Legion dashboard URL -->
