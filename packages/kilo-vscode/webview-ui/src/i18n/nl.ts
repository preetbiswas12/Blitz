export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installeer Anaconda Desktop op deze machine en kom hier dan terug. Blitx voert het installatieprogramma niet voor je uit.",
  ...
  "provider.anaconda.state.signedOut": "Open Anaconda Desktop en meld je aan voordat je Blitx verbindt.",
  "provider.anaconda.state.unauthorized":
    "Blitx kon geen toegang krijgen tot Anaconda Desktop. Open Desktop, meld je opnieuw aan en herstart het indien nodig.",
  ...
  "provider.anaconda.state.ready":
    "Blitx heeft een gezonde lokale tekstgeneratieserver gevonden en kan de huidige verbindingsinstellingen importeren.",
  ...
  "provider.anaconda.toast.refreshed.description": "De actieve lokale server en modellen zijn up-to-date in Blitx.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx kon de beschikbare skills niet controleren.",
  "agentRequirements.error.mcpStatusFailed": "Blitx kon de MCP-serverstatus niet controleren.",
  "agentRequirements.error.scopeMismatch": "Deze controle van agentvereisten is niet meer actief.",
  "agentRequirements.error.requestFailed": "Blitx kon de agentvereisten niet controleren.",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen aangeboden door Blitx",
  ...
  "provider.connect.apiKey.description":
    "Voer uw {{provider}} API-sleutel in om uw account te verbinden en {{provider}} modellen te gebruiken in Blitx.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om uw autorisatiecode op te halen waarmee u uw account kunt verbinden en {{provider}} modellen kunt gebruiken in Blitx.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om uw account te verbinden en {{provider}} modellen te gebruiken in Blitx.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox is ingeschakeld. Shell-opdrachten van de agent zijn beperkt tot de project- en Blitx-mappen.",
  "prompt.action.sandbox.disabled":
    "Sandbox is uitgeschakeld. Klik om schrijfbewerkingen van shell-opdrachten van de agent te beperken tot de project- en Blitx-mappen.",
  ...
  "prompt.action.sandbox.description.enabled": "Schrijfbewerkingen zijn beperkt tot de project- en Blitx-mappen.",
  ...
  "speechToText.tooltip.start": "Spraakinvoer starten met Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "Meld u aan bij Blitx om spraakinvoer te gebruiken.",
  ...
  "dialog.server.description": "Wissel met welke Blitx-server deze app verbinding maakt.",
  ...
  "toast.update.description": "Een nieuwe versie van Blitx ({{version}}) is nu beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Meld deze fout alsjeblieft aan het Blitx team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op, Blitx ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Blitx bevat gratis modellen, zodat je meteen kunt beginnen.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Blitx",
  "settings.general.row.appearance.title": "Uiterlijk",
  "settings.general.row.appearance.description": "Pas aan hoe Blitx eruitziet op je apparaat",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Blitx aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Blitx start",
  ...
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Blitx.",
  ...
  "settings.providers.betaNotice":
    "Momenteel kan alleen de Blitx Gateway-provider worden geconfigureerd in de instellingeninterface. Ondersteuning voor het configureren van andere providers komt binnenkort tijdens de bèta-periode. In de tussentijd kun je providers configureren met behulp van de CLI of het configuratiebestand. We zijn toegewijd om Blitx open te houden, geen lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Blitx-configuratiebestand",
  ...
  "settings.config.noWorkspace": "Open een werkruimtemap om het lokale Blitx-configuratiebestand te bewerken.",
  "settings.config.openFailed": "Kan {{scope}} Blitx-configuratiebestand niet openen: {{message}}",
  ...
  "workStyle.onboarding.welcome": "Welkom bij Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx pauzeert en toont tijdens het werk zijn plan.",
  ...
  "session.cloud.import.placeholder": "Sessie-ID, URL, of blitx import commando",
  ...
  "deviceAuth.title": "Meld je aan bij Blitx",
  ...
  "profile.action.login": "Inloggen met Blitx",
  ...
  "profile.pass.subscribe": "Schaf Blitx Pass aan om tegoed toe te voegen en bonussen te verdienen",
  ...
  "settings.aboutBlitx.title": "Over Blitx",

  "session.messages.empty": "Start een gesprek door hieronder een bericht te typen.",
  "session.messages.welcome":
    "Blitx is een AI-codeerassistent. Vraag het om features te bouwen, bugs op te lossen of je codebase uit te leggen.",
  ...
  "settings.aboutBlitx.status.connected": "Verbonden",
  "settings.aboutBlitx.status.connecting": "Verbinden...",
  "settings.aboutBlitx.status.disconnected": "Verbinding verbroken",
  "settings.aboutBlitx.status.error": "Fout",
  "settings.aboutBlitx.cliServer": "CLI Server",
  "settings.aboutBlitx.status.label": "Status:",
  "settings.aboutBlitx.port.label": "Poort:",
  "settings.aboutBlitx.versionInfo": "Versie-informatie",
  "settings.aboutBlitx.version.label": "Versie:",
  "settings.aboutBlitx.extensionName": "Blitx Extensie",
  "settings.aboutBlitx.community": "Community & Ondersteuning",
  "settings.aboutBlitx.feedback.prefix": "Als je vragen of feedback hebt, voel je vrij om een issue aan te maken op",
  "settings.aboutBlitx.feedback.or": "of",
  "settings.aboutBlitx.support.prefix":
    "Voor vragen over facturering of je account, neem contact op met Klantenservice op",
  "settings.aboutBlitx.resetSettings.title": "Instellingen resetten",
  ...
  "settings.aboutBlitx.resetSettings.button": "Alle instellingen resetten",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Instellingen overdragen",
  ...
  "settings.aboutBlitx.exportSettings": "Exporteren",
  "settings.aboutBlitx.importSettings": "Importeren",
  "settings.aboutBlitx.importSettings.invalidJson":
    "Ongeldig JSON-bestand. Selecteer een geldig instellingenbestand.",
  "settings.aboutBlitx.importSettings.invalidConfig": "Het bestand bevat geen geldige Blitx-instellingen.",
  ...
  "settings.aboutBlitx.importSettings.newerVersion":
    "Dit bestand is geëxporteerd vanuit een nieuwere versie van Blitx. Sommige instellingen worden mogelijk genegeerd.",
  ...
  "settings.aboutBlitx.telemetry.title": "Telemetrie",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Telemetrie-instellingen openen",
  ...
  "settings.language.description": 'Kies de taal voor de Blitx UI. "Auto" gebruikt je VS Code schermtaal.',
  ...
  "settings.experimental.speechToText.description":
    "Schakel spraakinvoer in promptvelden in met uw Blitx-account via Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Schakel de Blitx-provider in en meld u aan om Speech to Text te gebruiken. Speech to Text wordt momenteel alleen ondersteund met Blitx Gateway.",
  "settings.models.speechToTextModel.title": "Spraak-naar-tekst-model",
  "settings.models.speechToTextModel.description": "Kies het Blitx Gateway-transcriptiemodel voor spraakinvoer.",
  ...
  "settings.experimental.remote.description":
    "Schakel Remote-bediening van sessies in via Blitx Cloud. Dit heeft ook invloed op CLI's op deze machine.",
  ...
  "settings.experimental.sandbox.description":
    "Shell-opdrachten van de agent uitvoeren in een sandbox op besturingssysteemniveau die schrijfbewerkingen beperkt tot de project- en Blitx-statusmappen",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Laad CLAUDE.md instructies en vaardigheden uit je Claude Code configuratiemap in sessies. Schakel dit in als je wilt dat Blitx je Claude Code instructies en vaardigheden gebruikt. Herstart vereist.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Geen MCP-servers geconfigureerd. Voeg MCP-servers toe in blitx.jsonc of vraag de agent om ze toe te voegen.",
  ...
  "settings.display.fontSize.description": "Pas de lettergrootte van de Blitx webview UI onafhankelijk van VS Code aan.",
  ...
  "settings.models.hidePromptTraining.description":
    "Verberg Blitx Gateway-modellen waarvan providers je prompts mogelijk voor training gebruiken.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "Legacy Migratie",
  "settings.aboutBlitx.legacyMigration.description":
    "Migreer instellingen van een eerdere installatie van Blitx, inclusief provider API-sleutels en standaard model.",
  "settings.aboutBlitx.rooImport.description": "Importeer gespreksgeschiedenis van een Roo Code installatie.",
  "settings.aboutBlitx.rooImport.button": "Sessies importeren uit Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Wat is er Nieuw in Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Één kleine, efficiënte kern voor elk Blitx-product. Een vertrouwde ervaring, hoe je ook wilt werken.",
  ...
  "settings.indexing.blitxModel.title": "Blitx-model voorinstelling",
  "settings.indexing.blitxModel.description": "Kies een ondersteund Blitx-hosted embeddings model.",
  "settings.indexing.blitxSignIn.title": "Blitx-aanmelding vereist",
  "settings.indexing.blitxSignIn.description": "Log in op Blitx om hosted embeddings te gebruiken.",
  ...
  "diffViewer.source.session.tooltip":
    "Bestanden die door Blitx tijdens de huidige sessie zijn gewijzigd, gebaseerd op snapshots per beurt. Wordt gereset bij het starten van een nieuwe sessie.",
