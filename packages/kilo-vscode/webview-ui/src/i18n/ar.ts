export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "ثبّت Anaconda Desktop على هذا الجهاز، ثم عُد إلى هنا. لا يقوم Blitx بتشغيل المثبّت نيابةً عنك.",
  ...
  "provider.anaconda.state.signedOut": "افتح Anaconda Desktop وسجّل الدخول قبل توصيل Blitx.",
  "provider.anaconda.state.unauthorized":
    "تعذّر على Blitx الوصول إلى Anaconda Desktop. افتح Desktop، وسجّل الدخول مرة أخرى، وأعد تشغيله إذا لزم الأمر.",
  ...
  "provider.anaconda.state.ready":
    "عثر Blitx على خادم محلي سليم لتوليد النصوص ويمكنه استيراد إعدادات الاتصال الحالية الخاصة به.",
  ...
  "provider.anaconda.toast.refreshed.description": "الخادم المحلي النشط والنماذج محدّثة في Blitx.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "تعذر على Blitx فحص المهارات المتاحة.",
  "agentRequirements.error.mcpStatusFailed": "تعذر على Blitx فحص حالة خادم MCP.",
  "agentRequirements.error.scopeMismatch": "لم يعد فحص متطلبات هذا الوكيل نشطًا.",
  "agentRequirements.error.requestFailed": "تعذر على Blitx فحص متطلبات الوكيل.",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Blitx",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Blitx.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Blitx.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Blitx.",
  ...
  "prompt.action.sandbox.enabled": "sandbox مُفعّل. أوامر shell الخاصة بالوكيل مقتصرة على مجلدات المشروع و Blitx.",
  "prompt.action.sandbox.disabled":
    "sandbox مُعطّل. انقر لتقييد كتابة أوامر shell الخاصة بالوكيل على مجلدات المشروع و Blitx.",
  ...
  "prompt.action.sandbox.description.enabled": "تقتصر عمليات الكتابة على مجلدات المشروع و Blitx.",
  ...
  "speechToText.tooltip.start": "بدء الإدخال الصوتي باستخدام Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "قم بتسجيل الدخول إلى Blitx لاستخدام الإدخال الصوتي.",
  ...
  "dialog.server.description": "تبديل خادم Blitx الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من Blitx ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Blitx",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Blitx لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Blitx نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Blitx",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Blitx على جهازك",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Blitx.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Blitx",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Blitx.",
  ...
  "settings.providers.betaNotice":
    "حالياً، يمكن إعداد مزود Blitx Gateway فقط في واجهة الإعدادات. سيتوفر دعم إعداد المزودين الآخرين قريباً خلال الفترة التجريبية. في غضون ذلك، يمكنك إعداد المزودين باستخدام CLI أو ملف التكوين. نحن ملتزمون بإبقاء Blitx مفتوحاً، دون تقييد.",
  ...
  "settings.models.hidePromptTraining.description":
    "إخفاء نماذج Blitx Gateway التي قد يستخدم مزودوها مطالباتك لأغراض التدريب.",
  ...
  "settings.config.title": "فتح ملف تكوين Blitx {{scope}}",
  "settings.config.placeholder": "يتم دمج ملفات التكوين بالترتيب؛ الملفات المحددة كمحملة تؤثر حاليًا على الإعدادات.",
  "settings.config.noWorkspace": "افتح مجلد مساحة عمل لتحرير ملف تكوين Blitx المحلي.",
  "settings.config.openFailed": "فشل فتح ملف تكوين Blitx {{scope}}: {{message}}",
  ...
  "workStyle.onboarding.welcome": "مرحبًا بك في Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "يتوقف Blitx مؤقتًا ويعرض لك خطته أثناء العمل.",
  ...
  "session.cloud.import.placeholder": "معرّف الجلسة أو الرابط أو أمر blitx import",
  ...
  "deviceAuth.title": "تسجيل الدخول إلى Blitx",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام Blitx",
  ...
  "profile.pass.subscribe": "احصل على Blitx Pass لإضافة رصيد وكسب مكافآت",
  ...
  "settings.indexing.blitxModel.title": "إعداد مسبق لنموذج Blitx",
  "settings.indexing.blitxModel.description": "اختر نموذج تضمين مدعومًا ومستضافًا بواسطة Blitx.",
  "settings.indexing.blitxSignIn.title": "تسجيل الدخول إلى Blitx مطلوب",
  "settings.indexing.blitxSignIn.description": "سجّل الدخول إلى Blitx لاستخدام التضمينات المستضافة.",
  ...
  "settings.aboutBlitx.title": "حول Blitx",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "Blitx هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutBlitx.status.connected": "متصل",
  "settings.aboutBlitx.status.connecting": "جارٍ الاتصال...",
  "settings.aboutBlitx.status.disconnected": "غير متصل",
  "settings.aboutBlitx.status.error": "خطأ",
  "settings.aboutBlitx.cliServer": "خادم CLI",
  "settings.aboutBlitx.status.label": "الحالة:",
  "settings.aboutBlitx.port.label": "المنفذ:",
  "settings.aboutBlitx.versionInfo": "معلومات الإصدار",
  "settings.aboutBlitx.version.label": "الإصدار:",
  "settings.aboutBlitx.extensionName": "إضافة Blitx",
  "settings.aboutBlitx.community": "المجتمع والدعم",
  "settings.aboutBlitx.feedback.prefix": "إذا كان لديك أي أسئلة أو ملاحظات، لا تتردد في فتح مشكلة على",
  "settings.aboutBlitx.feedback.or": "أو",
  "settings.aboutBlitx.support.prefix": "لأسئلة الفوترة أو الحساب، تواصل مع دعم العملاء على",
  "settings.aboutBlitx.resetSettings.title": "إعادة تعيين الإعدادات",
  ...
  "settings.aboutBlitx.resetSettings.button": "إعادة تعيين جميع الإعدادات",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "نقل الإعدادات",
  "settings.aboutBlitx.settingsTransfer.description": "تصدير أو استيراد إعداداتك لنقلها بين نُسخ VS Code.",
  "settings.aboutBlitx.exportSettings": "تصدير",
  "settings.aboutBlitx.importSettings": "استيراد",
  "settings.aboutBlitx.importSettings.invalidJson": "ملف JSON غير صالح. يرجى اختيار ملف إعدادات صالح.",
  "settings.aboutBlitx.importSettings.invalidConfig": "الملف لا يحتوي على إعدادات Blitx صالحة.",
  "settings.aboutBlitx.importSettings.tooLarge": "الملف كبير جدًا. يجب أن تكون ملفات الإعدادات أقل من 1 MB.",
  "settings.aboutBlitx.importSettings.newerVersion":
    "تم تصدير هذا الملف من إصدار أحدث من Blitx. قد يتم تجاهل بعض الإعدادات.",
  "settings.aboutBlitx.importSettings.success": "تم استيراد الإعدادات. راجع التغييرات أعلاه، ثم انقر على حفظ.",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "فتح إعدادات Telemetry",
  ...
  "settings.language.description": 'اختر اللغة لواجهة Blitx. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "تمكين الإدخال الصوتي في حقول المطالبة باستخدام حساب Blitx الخاص بك من خلال Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "قم بتمكين وتسجيل الدخول إلى مزود Blitx لاستخدام Speech to Text. ميزة Speech to Text مدعومة حاليًا فقط مع Blitx Gateway.",
  "settings.models.speechToTextModel.title": "نموذج تحويل الصوت إلى نص",
  "settings.models.speechToTextModel.description": "اختر نموذج نسخ Blitx Gateway للإدخال الصوتي.",
  ...
  "settings.experimental.remote.description":
    "قم بتمكين التحكم Remote في الجلسات عبر Blitx Cloud. سيؤثر هذا أيضًا على واجهات سطر الأوامر (CLIs) على هذا الجهاز.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "تحميل تعليمات ومهارات CLAUDE.md من مجلد إعدادات Claude Code إلى الجلسات. قم بتمكين هذا الخيار إذا كنت ترغب في أن يستخدم Blitx مهارات وتعليمات Claude Code الخاصة بك. يتطلب إعادة التشغيل.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "لم يتم تهيئة خوادم MCP. أضف خوادم MCP في blitx.jsonc، أو اطلب من الوكيل إضافتها لك.",
  ...
  "settings.experimental.sandbox.description":
    "تشغيل أوامر shell الخاصة بالوكيل داخل sandbox على مستوى نظام التشغيل يقيّد الكتابة على مجلدات حالة المشروع و Blitx",
  ...
  "settings.display.fontSize.description": "اضبط حجم خط webview UI الخاص بـ Blitx بشكل مستقل عن VS Code.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "ترحيل الإصدار القديم",
  "settings.aboutBlitx.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ Blitx، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",
  "settings.aboutBlitx.rooImport.description": "استيراد سجل المحادثات من تثبيت Roo Code.",
  "settings.aboutBlitx.rooImport.button": "استيراد الجلسات من Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "نواة صغيرة وفعالة واحدة عبر كل منتجات Blitx. تجربة مألوفة بغض النظر عن طريقة عملك.",
  ...
  "diffViewer.source.session.tooltip":
    "الملفات التي غيّرها Blitx خلال الجلسة الحالية، بناءً على لقطات لكل دور. يُعاد ضبطها عند بدء جلسة جديدة.",
