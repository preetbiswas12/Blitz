...
Blitz 是一個 AI 編碼代理，可在你工作的任何地方使用：[VS Code](https://blitz.ai/landing/vs-code)、[JetBrains](https://blitz.ai/features/jetbrains-native) 和 [CLI](https://blitz.ai/cli)。它是開源專案，並採用開放定價。你可以從 500 多個模型中選擇，在任務中途切換模型，並按模型供應商的價格付費，沒有加價。開始使用不需要 API 金鑰。
...
直接安裝 [Blitz 擴充功能](vscode:extension/Blitzcode.Blitz-code)，或從 [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=blitzcode.Blitz-Code) 取得。建立帳戶後，你可以按供應商價格使用 500 多個模型，包括 GPT-5.5、Claude Opus 4.7、Claude Sonnet 4.6 和 Gemini 3.1 Pro Preview。
...
從 JetBrains Marketplace 安裝 [Blitz 外掛](https://plugins.jetbrains.com/plugin/28350-Blitz-code)，或在任何 JetBrains IDE 的 `Settings → Plugins` 中搜尋 "Blitz"。
...
無需本機電腦，在 Web 上透過 [app.Blitz.ai/cloud](https://app.blitz.ai/cloud) 執行 Blitz。
...
在 [app.Blitz.ai/code-reviews](https://app.blitz.ai/code-reviews) 為你的 Pull Request 設定自動 AI 程式碼審查。
...
在 [app.blitz.ai/claw](https://app.blitz.ai/claw) 啟動你的常駐 AI 代理。
...
從 [Releases 頁面](https://github.com/Blitz-Org/Blitzcode/releases) 下載最新二進位檔。
...
深入了解 [agents 和自訂 agents](https://blitz.ai/docs/code-with-ai/agents/using-agents)。
...
關於設定和其他內容，請查看[文件](https://blitz.ai/docs)。
...
**加入社群** [Discord](https://blitz.ai/discord) | [X](https://x.com/blitzcode) | [Reddit](https://www.reddit.com/r/blitzcode/)
