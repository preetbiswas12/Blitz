...
const MOCK_NOTIFICATION = {
  id: "notif-1",
  title: "Try BYOK for Blitx Gateway",
  message: "Bring your own API key for even more flexibility with Blitx Gateway models.",
  action: { actionText: "Learn more", actionURL: "https://blitx.ai/docs" },
}
