...
- **Active Kilo Code account**  
  Sign up or log in at [app.kilo.ai](https://app.kilo.ai) <!-- TODO: Replace with Blitx dashboard URL -->
...
1. Navigate to **[App Builder](https://app.kilo.ai/app-builder)** <!-- TODO: Replace with Blitx dashboard URL --> from your Kilo dashboard.
