...
To try the v7 Early Access Program plugin, follow the [JetBrains EAP installation guide](https://blitx.ai/docs/code-with-ai/platforms/jetbrains#jetbrains-early-access).
...
```
bun turbo build --filter=@blitxcode/kilo-jetbrains
```
