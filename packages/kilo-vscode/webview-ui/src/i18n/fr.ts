export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installez Anaconda Desktop sur cette machine, puis revenez ici. Blitx n’exécute pas l’installateur à votre place.",
  ...
  "provider.anaconda.state.signedOut": "Ouvrez Anaconda Desktop et connectez-vous avant de connecter Blitx.",
  "provider.anaconda.state.unauthorized":
    "Blitx n’a pas pu accéder à Anaconda Desktop. Ouvrez Desktop, reconnectez-vous et redémarrez-le si nécessaire.",
  ...
  "provider.anaconda.state.ready":
    "Blitx a trouvé un serveur local sain de génération de texte et peut importer ses paramètres de connexion actuels.",
  ...
  "provider.anaconda.toast.refreshed.description": "Le serveur local actif et les modèles sont à jour dans Blitx.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx n’a pas pu vérifier les compétences disponibles.",
  "agentRequirements.error.mcpStatusFailed": "Blitx n’a pas pu vérifier l’état du serveur MCP.",
  "agentRequirements.error.scopeMismatch": "Cette vérification des prérequis de l’agent n’est plus active.",
  "agentRequirements.error.requestFailed": "Blitx n’a pas pu vérifier les prérequis de l’agent.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Blitx",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Blitx.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Blitx.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Blitx.",
  ...
  "prompt.action.sandbox.enabled":
    "Le sandbox est activé. Les commandes shell de l'agent sont limitées aux répertoires du projet et de Blitx.",
  "prompt.action.sandbox.disabled":
    "Le sandbox est désactivé. Cliquez pour limiter les écritures des commandes shell de l'agent aux répertoires du projet et de Blitx.",
  ...
  "prompt.action.sandbox.description.enabled": "Les écritures sont limitées aux répertoires du projet et de Blitx.",
  ...
  "speechToText.tooltip.start": "Démarrer la saisie vocale avec Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "Connectez-vous à Blitx pour utiliser la saisie vocale.",
  ...
  "dialog.server.description": "Changez le serveur Blitx auquel cette application se connecte.",
  ...
  "toast.update.description": "Une nouvelle version d'Blitx ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Blitx",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Blitx ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Blitx inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Blitx",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Blitx sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Blitx.",
  ...
  "settings.indexing.blitxModel.title": "Préréglage de modèle Blitx",
  "settings.indexing.blitxModel.description": "Choisissez un modèle d'embedding hébergé par Blitx pris en charge.",
  "settings.indexing.blitxSignIn.title": "Connexion à Blitx requise",
  "settings.indexing.blitxSignIn.description": "Connectez-vous à Blitx pour utiliser les embeddings hébergés.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Blitx",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Blitx.",
  ...
  "settings.providers.betaNotice":
    "Actuellement, seul le fournisseur Blitx Gateway peut être configuré dans l'interface des paramètres. La prise en charge de la configuration d'autres fournisseurs sera bientôt disponible pendant la période bêta. En attendant, vous pouvez configurer les fournisseurs à l'aide de la CLI ou du fichier de configuration. Nous nous engageons à maintenir Blitx ouvert, sans enfermement propriétaire.",
  ...
  "settings.models.hidePromptTraining.description":
    "Masquez les modèles Blitx Gateway dont les fournisseurs peuvent utiliser vos prompts à des fins d'entraînement.",
  ...
  "settings.config.title": "Ouvrir le fichier de configuration Blitx {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Ouvrez un dossier d'espace de travail pour modifier le fichier de configuration Blitx local.",
  "settings.config.openFailed": "Échec de l'ouverture du fichier de configuration Blitx {{scope}} : {{message}}",
  ...
  "workStyle.onboarding.welcome": "Bienvenue dans Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Blitx s'interrompt et vous présente son plan au fil de son travail.",
  ...
  "session.cloud.import.placeholder": "ID de session, URL ou commande blitx import",
  ...
  "deviceAuth.title": "Se connecter à Blitx",
  ...
  "profile.action.login": "Se connecter avec Blitx",
  ...
  "profile.pass.subscribe": "Obtenez Blitx Pass pour ajouter des crédits et gagner des bonus",
  ...
  "settings.aboutBlitx.title": "À propos de Blitx",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "Blitx est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutBlitx.status.connected": "Connecté",
  "settings.aboutBlitx.status.connecting": "Connexion en cours...",
  "settings.aboutBlitx.status.disconnected": "Déconnecté",
  "settings.aboutBlitx.status.error": "Erreur",
  "settings.aboutBlitx.cliServer": "Serveur CLI",
  "settings.aboutBlitx.status.label": "Statut :",
  "settings.aboutBlitx.port.label": "Port :",
  "settings.aboutBlitx.versionInfo": "Informations de version",
  "settings.aboutBlitx.version.label": "Version :",
  "settings.aboutBlitx.extensionName": "Extension Blitx",
  "settings.aboutBlitx.community": "Communauté et support",
  "settings.aboutBlitx.feedback.prefix":
    "Si vous avez des questions ou des commentaires, n'hésitez pas à ouvrir un ticket sur",
  "settings.aboutBlitx.feedback.or": "ou",
  "settings.aboutBlitx.support.prefix":
    "Pour les questions de facturation ou de compte, contactez le support client à",
  "settings.aboutBlitx.resetSettings.title": "Réinitialiser les paramètres",
  ...
  "settings.aboutBlitx.resetSettings.button": "Réinitialiser tous les paramètres",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Transfert des paramètres",
  ...
  "settings.aboutBlitx.exportSettings": "Exporter",
  "settings.aboutBlitx.importSettings": "Importer",
  ...
  "settings.aboutBlitx.importSettings.invalidConfig": "Le fichier ne contient pas de paramètres Blitx valides.",
  ...
  "settings.aboutBlitx.importSettings.newerVersion":
    "Ce fichier a été exporté depuis une version plus récente de Blitx. Certains paramètres pourraient être ignorés.",
  ...
  "settings.aboutBlitx.telemetry.title": "Télémétrie",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Ouvrir les paramètres de télémétrie",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de Blitx. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.experimental.speechToText.description":
    "Activez la saisie vocale dans les champs de prompt en utilisant votre compte Blitx via Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Activez et connectez-vous au fournisseur Blitx pour utiliser Speech to Text. Speech to Text n'est actuellement pris en charge qu'avec Blitx Gateway.",
  "settings.models.speechToTextModel.title": "Modèle de transcription vocale",
  "settings.models.speechToTextModel.description":
    "Choisissez le modèle de transcription Blitx Gateway pour la saisie vocale.",
  ...
  "settings.experimental.remote.description":
    "Activez le contrôle Remote des sessions via Blitx Cloud. Cela affectera également les CLI sur cette machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Charge les instructions et les compétences de CLAUDE.md depuis votre répertoire de configuration Claude Code dans les sessions. Activez cette option si vous souhaitez que Blitx utilise vos instructions et compétences Claude Code. Nécessite un redémarrage.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Aucun serveur MCP configuré. Ajoutez des serveurs MCP dans blitx.jsonc ou demandez à l'agent de les ajouter.",
  ...
  "settings.experimental.sandbox.description":
    "Exécuter les commandes shell de l'agent dans un sandbox au niveau du système d'exploitation qui restreint les écritures aux répertoires d'état du projet et de Blitx",
  ...
  "settings.display.fontSize.description":
    "Ajustez la taille de la police de la webview UI de Blitx indépendamment de VS Code.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "Migration de l'ancienne version",
  "settings.aboutBlitx.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de Blitx, y compris les clés d'API des fournisseurs et le modèle par défaut.",
  "settings.aboutBlitx.rooImport.description":
    "Importer l'historique des conversations depuis une installation de Roo Code.",
  "settings.aboutBlitx.rooImport.button": "Importer les sessions depuis Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un noyau petit et efficace partagé par tous les produits Blitx. Une expérience familière quelle que soit votre façon de travailler.",
  ...
  "diffViewer.source.session.tooltip":
    "Fichiers modifiés par Blitx pendant la session actuelle, basé sur des snapshots par tour. Réinitialisé lors du démarrage d'une nouvelle session.",
