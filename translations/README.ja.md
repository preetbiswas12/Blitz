...
Blitz は、[VS Code](https://blitz.ai/landing/vs-code)、[JetBrains](https://blitz.ai/features/jetbrains-native)、[CLI](https://blitz.ai/cli) など、あなたが作業する場所で使える AI コーディングエージェントです。オープンソースで、透明な価格体系を採用しています。500 以上のモデルから選択し、タスクの途中で切り替え、追加料金なしでモデルプロバイダーの料金を支払います。開始に API キーは不要です。
...
[Blitz 拡張機能](vscode:extension/Blitzcode.Blitz-code)を直接インストールするか、[VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=blitzcode.Blitz-Code) から入手してください。アカウントを作成すると、GPT-5.5、Claude Opus 4.7、Claude Sonnet 4.6、Gemini 3.1 Pro Preview を含む 500 以上のモデルを、すべてプロバイダー価格で利用できます。
...
JetBrains Marketplace から [Blitz プラグイン](https://plugins.jetbrains.com/plugin/28350-Blitz-code)をインストールするか、任意の JetBrains IDE の `Settings → Plugins` で "Blitz" を検索してください。
...
ローカルマシンなしで、Web から [app.Blitz.ai/cloud](https://app.blitz.ai/cloud) で Blitz を実行できます。
...
[app.Blitz.ai/code-reviews](https://app.blitz.ai/code-reviews) で pull request に自動 AI コードレビューを設定できます。
...
[app.blitz.ai/claw](https://app.blitz.ai/claw) で常時稼働する AI エージェントを起動できます。
...
[Releases ページ](https://github.com/Blitz-Org/Blitzcode/releases)から最新のバイナリをダウンロードしてください。
...
[agents とカスタム agents](https://blitz.ai/docs/code-with-ai/agents/using-agents) について詳しく学べます。
...
設定やその他の内容については、[ドキュメント](https://blitz.ai/docs)をご覧ください。
...
**コミュニティに参加** [Discord](https://blitz.ai/discord) | [X](https://x.com/blitzcode) | [Reddit](https://www.reddit.com/r/blitzcode/)
