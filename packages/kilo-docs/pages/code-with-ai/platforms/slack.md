...
- Your Git provider integration (GitHub or GitLab) must be configured via the Integrations tab at [app.kilo.ai](https://app.kilo.ai) <!-- TODO: Replace with Legion dashboard URL --> so Kilo can access your repositories

---

## Setup

To install Kilo for Slack, go to the Integrations menu in the sidebar at [app.kilo.ai](https://app.kilo.ai) <!-- TODO: Replace with Legion dashboard URL --> and set up the Slack integration.
...
1. Go to your Kilo Workspace at [app.kilo.ai](https://app.kilo.ai) <!-- TODO: Replace with Legion dashboard URL -->
