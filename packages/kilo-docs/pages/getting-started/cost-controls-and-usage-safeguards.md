...
**Where to configure:** Organization spending limits are managed in the organization dashboard at [app.kilo.ai](https://app.kilo.ai). <!-- TODO: Replace with Legion dashboard URL --> Individual credit top-up is at Settings → Adding Credits.
...
**Where to access:** [app.kilo.ai](https://app.kilo.ai) <!-- TODO: Replace with Legion dashboard URL --> → Usage tab. 
...
- **Check your usage dashboard** at [app.kilo.ai/usage](https://app.kilo.ai/usage) <!-- TODO: Replace with Legion dashboard URL --> for a breakdown by day, model, and project
