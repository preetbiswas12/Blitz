...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installer Anaconda Desktop på denne maskinen, og kom deretter tilbake hit. Blitx kjører ikke installasjonsprogrammet for deg.",
  ...
  "provider.anaconda.state.signedOut": "Åpne Anaconda Desktop og logg inn før du kobler til Blitx.",
  "provider.anaconda.state.unauthorized":
    "Blitx fikk ikke tilgang til Anaconda Desktop. Åpne Desktop, logg inn på nytt, og start det på nytt om nødvendig.",
  ...
  "provider.anaconda.state.ready":
    "Blitx fant en sunn lokal tekstgenereringsserver og kan importere de gjeldende tilkoblingsinnstillingene.",
  ...
  "provider.anaconda.toast.refreshed.description": "Den aktive lokale serveren og modellene er oppdatert i Blitx.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx kunne ikke sjekke tilgjengelige skills.",
  "agentRequirements.error.mcpStatusFailed": "Blitx kunne ikke sjekke MCP-serverstatus.",
  "agentRequirements.error.scopeMismatch": "Denne sjekken av agentkrav er ikke lenger aktiv.",
  "agentRequirements.error.requestFailed": "Blitx kunne ikke sjekke agentkravene.",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Blitx",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Blitx.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Blitx.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Blitx.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox er aktivert. Shell-kommandoer for agenten er begrenset til prosjekt- og Blitx-mappene.",
  "prompt.action.sandbox.disabled":
    "Sandbox er deaktivert. Klikk for å begrense skriving av shell-kommandoer for agenten til prosjekt- og Blitx-mappene.",
  ...
  "prompt.action.sandbox.description.enabled": "Skrivetilgang er begrenset til prosjekt- og Blitx-mappene.",
  ...
  "speechToText.tooltip.start": "Start taleinndata med Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "Logg på Blitx for å bruke taleinndata.",
  ...
  "dialog.server.description": "Bytt hvilken Blitx-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Blitx ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Blitx-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Blitx ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Blitx inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Blitx",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Blitx ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Blitx er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Blitx starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Blitx.",
  ...
  "settings.providers.betaNotice":
    "For øyeblikket kan kun Blitx Gateway-leverandøren konfigureres i innstillingsgrensesnittet. Støtte for konfigurering av andre leverandører kommer snart i løpet av betaperioden. I mellomtiden kan du konfigurere leverandører via CLI eller konfigurasjonsfilen. Vi er forpliktet til å holde Blitx åpent, ingen lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Skjul Blitx Gateway-modeller der leverandørene kan bruke ledetekstene dine til trening.",
  ...
  "settings.config.title": "Åpne {{scope}} Blitx-konfigurasjonsfil",
  "settings.config.placeholder":
    "Konfigurasjonsfiler slås sammen i rekkefølge; filer merket som lastet påvirker for øyeblikket innstillingene.",
  "settings.config.noWorkspace": "Åpne en arbeidsområdemappe for å redigere den lokale Blitx-konfigurasjonsfilen.",
  "settings.config.openFailed": "Klarte ikke å åpne {{scope}} Blitx-konfigurasjonsfil: {{message}}",
  ...
  "workStyle.onboarding.welcome": "Velkommen til Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx tar pause og viser deg planen sin mens den arbeider.",
  ...
  "session.cloud.import.placeholder": "Økt-ID, URL eller blitx import-kommando",
  ...
  "deviceAuth.title": "Logg inn på Blitx",
  ...
  "profile.action.login": "Logg inn med Blitx",
  ...
  "profile.pass.subscribe": "Få Blitx Pass for å legge til kreditt og tjene bonuser",
  ...
  "settings.aboutBlitx.title": "Om Blitx",

  "session.messages.empty": "Start en samtale ved å skrive en melding nedenfor.",
  "session.messages.welcome":
    "Blitx er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.aboutBlitx.status.connected": "Tilkoblet",
  "settings.aboutBlitx.status.connecting": "Kobler til...",
  "settings.aboutBlitx.status.disconnected": "Frakoblet",
  "settings.aboutBlitx.status.error": "Feil",
  "settings.aboutBlitx.cliServer": "CLI-server",
  "settings.aboutBlitx.status.label": "Status:",
  "settings.aboutBlitx.port.label": "Port:",
  "settings.aboutBlitx.versionInfo": "Versjonsinformasjon",
  "settings.aboutBlitx.version.label": "Versjon:",
  "settings.aboutBlitx.extensionName": "Blitx-utvidelse",
  "settings.aboutBlitx.community": "Fellesskap og støtte",
  "settings.aboutBlitx.feedback.prefix": "Hvis du har spørsmål eller tilbakemeldinger, åpne gjerne en issue på",
  "settings.aboutBlitx.feedback.or": "eller",
  "settings.aboutBlitx.support.prefix": "For fakturerings- eller kontospørsmål, kontakt kundestøtte på",
  "settings.aboutBlitx.resetSettings.title": "Tilbakestill innstillinger",
  ...
  "settings.aboutBlitx.resetSettings.button": "Tilbakestill alle innstillinger",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Overføring av innstillinger",
  ...
  "settings.aboutBlitx.exportSettings": "Eksporter",
  "settings.aboutBlitx.importSettings": "Importer",
  "settings.aboutBlitx.importSettings.invalidJson": "Ugyldig JSON-fil. Vennligst velg en gyldig innstillingsfil.",
  "settings.aboutBlitx.importSettings.invalidConfig": "Filen inneholder ikke gyldige Blitx-innstillinger.",
  "settings.aboutBlitx.importSettings.tooLarge": "Filen er for stor. Innstillingsfiler må være under 1 MB.",
  "settings.aboutBlitx.importSettings.newerVersion":
    "Denne filen ble eksportert fra en nyere versjon av Blitx. Noen innstillinger kan bli ignorert.",
  ...
  "settings.aboutBlitx.telemetry.title": "Telemetri",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Åpne innstillinger for telemetri",
  ...
  "settings.language.description": 'Velg språket for Blitx-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
  ...
  "settings.experimental.speechToText.description":
    "Aktiver taleinndata i prompt-felt ved å bruke din Blitx-konto gjennom Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktiver og logg på Blitx-leverandøren for å bruke Speech to Text. Speech to Text støttes for øyeblikket bare med Blitx Gateway.",
  "settings.models.speechToTextModel.title": "Tale-til-tekst-modell",
  "settings.models.speechToTextModel.description": "Velg Blitx Gateway-transkripsjonsmodellen for taleinndata.",
  ...
  "settings.experimental.remote.description":
    "Aktiver Remote-kontroll av økter via Blitx Cloud. Dette vil også påvirke CLI-er på denne maskinen.",
  ...
  "settings.indexing.blitxModel.title": "Blitx-modellforhåndsvalg",
  "settings.indexing.blitxModel.description": "Velg en støttet Blitx-hostet embedding-modell.",
  "settings.indexing.blitxSignIn.title": "Blitx-pålogging kreves",
  "settings.indexing.blitxSignIn.description": "Logg inn på Blitx for å bruke hostede embeddings.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Last inn CLAUDE.md-instruksjoner og ferdigheter fra Claude Code-konfigurasjonsmappen din i økter. Aktiver dette hvis du vil at Blitx skal bruke dine Claude Code-instruksjoner og ferdigheter. Krever omstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigurert. Legg til MCP-servere i blitx.jsonc, eller be agenten om å legge dem til.",
  ...
  "settings.experimental.sandbox.description":
    "Kjør shell-kommandoer for agenten i en sandbox på operativsystemnivå som begrenser skriving til prosjekt- og Blitx-tilstandsmapper",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Blitx webview UI uavhengig av VS Code.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "Migrering fra eldre versjon",
  "settings.aboutBlitx.legacyMigration.description":
    "Migrer innstillinger fra en tidligere installasjon av Blitx, inkludert API-nøkler for leverandører og standardmodell.",
  "settings.aboutBlitx.rooImport.description": "Importer samtalehistorikk fra en installasjon av Roo Code.",
  "settings.aboutBlitx.rooImport.button": "Importer økter fra Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Hva er nytt i Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én liten, effektiv kjerne på tvers av alle Blitx-produkter. En kjent opplevelse uansett hvordan du velger å jobbe.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer endret av Blitx i løpet av gjeldende økt, basert på øyeblikksbilder per tur. Tilbakestilles når du starter en ny økt.",
