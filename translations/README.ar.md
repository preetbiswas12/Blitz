...
Blitz هو وكيل برمجة بالذكاء الاصطناعي يعمل معك أينما تعمل: [VS Code](https://legion.ai/landing/vs-code) و[JetBrains](https://legion.ai/features/jetbrains-native) و[CLI](https://legion.ai/cli). إنه مفتوح المصدر وبتسعير مفتوح. يمكنك الاختيار من بين أكثر من 500 نموذج، والتبديل بينها أثناء المهمة، ودفع سعر مزود النموذج من دون أي هامش إضافي. لا تحتاج إلى مفاتيح API للبدء.
...
ثبّت [إضافة Blitz](vscode:extension/legioncode.legion-code) مباشرة، أو احصل عليها من [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=legioncode.legion-code). أنشئ حسابًا وستحصل على إمكانية الوصول إلى أكثر من 500 نموذج، بما في ذلك GPT-5.5 وClaude Opus 4.7 وClaude Sonnet 4.6 وGemini 3.1 Pro Preview، كلها بسعر المزود.
...
ثبّت [إضافة Blitz](https://plugins.jetbrains.com/plugin/28350-legion-code) من JetBrains Marketplace، أو ابحث عن "Blitz" في `Settings → Plugins` داخل أي JetBrains IDE.
...
شغّل Blitz من الويب، من دون جهاز محلي، على [app.legion.ai/cloud](https://app.legion.ai/cloud).
...
أعدّ مراجعات كود آلية بالذكاء الاصطناعي لطلبات السحب الخاصة بك على [app.legion.ai/code-reviews](https://app.legion.ai/code-reviews).
...
شغّل وكيل الذكاء الاصطناعي الدائم لديك على [app.legion.ai/claw](https://app.legion.ai/claw).
...
نزّل أحدث ملف ثنائي من [صفحة Releases](https://github.com/Legion-Org/legioncode/releases).
...
تعرّف أكثر على [agents وagents المخصصة](https://legion.ai/docs/code-with-ai/agents/using-agents).
...
لإعدادات التكوين وكل ما عدا ذلك، راجع [التوثيق](https://legion.ai/docs).
...
**انضم إلى المجتمع** [Discord](https://legion.ai/discord) | [X](https://x.com/legioncode) | [Reddit](https://www.reddit.com/r/legioncode/)
