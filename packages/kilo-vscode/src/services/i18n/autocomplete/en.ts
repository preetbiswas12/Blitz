...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Blitx Autocomplete",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Blitx Autocomplete (disabled)",
  ...
  "kilocode:autocomplete.toggleMessage": "Blitx Autocomplete {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Blitx: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "Blitx: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.codeAction.title": "Blitx: Suggested Edits",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The Blitx Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Blitx Autocomplete has been paused. Possible causes: your Blitx account has no remaining credits, or your configured API key (BYOK) has reached its quota limit. Add Blitx credits or check your API key configuration to resume autocomplete.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Add Credits",
  "kilocode:autocomplete.authError.message":
    "Blitx Autocomplete has been paused due to an authentication issue. Possible causes: you are not signed in to Blitx, or your API key (BYOK) is invalid or missing. Please sign in again or check your provider API key settings.",
}
