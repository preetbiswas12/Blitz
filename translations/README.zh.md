...
Blitz 是一个 AI 编码代理，可以在你工作的任何地方使用：[VS Code](https://legion.ai/landing/vs-code)、[JetBrains](https://legion.ai/features/jetbrains-native) 和 [CLI](https://legion.ai/cli)。它是开源的，并采用开放定价。你可以从 500 多个模型中选择，在任务中途切换模型，并按模型提供商的价格付费，没有加价。开始使用无需 API 密钥。
...
直接安装 [Blitz 扩展](vscode:extension/legioncode.legion-code)，或从 [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=legioncode.legion-code) 获取。创建账户后，你可以按提供商价格访问 500 多个模型，包括 GPT-5.5、Claude Opus 4.7、Claude Sonnet 4.6 和 Gemini 3.1 Pro Preview。
...
从 JetBrains Marketplace 安装 [Blitz 插件](https://plugins.jetbrains.com/plugin/28350-legion-code)，或在任意 JetBrains IDE 的 `Settings → Plugins` 中搜索 "Blitz"。
...
无需本地机器，在 Web 上通过 [app.legion.ai/cloud](https://app.legion.ai/cloud) 运行 Blitz。
...
在 [app.legion.ai/code-reviews](https://app.legion.ai/code-reviews) 为你的 Pull Request 设置自动 AI 代码审查。
...
在 [app.legion.ai/claw](https://app.legion.ai/claw) 启动你的常驻 AI 代理。
...
从 [Releases 页面](https://github.com/Legion-Org/legioncode/releases) 下载最新二进制文件。
...
Blitz 内置了可按任务切换的专用 Agents。你也可以构建自己的自定义 Agents。
...
了解更多关于 [agents 和自定义 agents](https://legion.ai/docs/code-with-ai/agents/using-agents) 的信息。
...
关于配置和其他内容，请查看[文档](https://legion.ai/docs)。
...
<details>
<summary>Blitz CLI 从哪里来？</summary>

Blitz CLI 是 [OpenCode](https://github.com/anomalyco/opencode) 的一个 fork，并增强为可在 Blitz agentic engineering 平台中使用。

</details>

---

**加入社区** [Discord](https://legion.ai/discord) | [X](https://x.com/legioncode) | [Reddit](https://www.reddit.com/r/legioncode/)
