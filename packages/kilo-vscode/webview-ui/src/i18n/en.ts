export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Install Anaconda Desktop on this machine, then return here. Blitx does not run the installer for you.",
  ...
  "provider.anaconda.state.signedOut": "Open Anaconda Desktop and sign in before connecting Blitx.",
  "provider.anaconda.state.unauthorized":
    "Blitx could not access Anaconda Desktop. Open Desktop, sign in again, and restart it if needed.",
  ...
  "provider.anaconda.state.ready":
    "Blitx found a healthy local text-generation server and can import its current connection settings.",
  ...
  "provider.anaconda.toast.refreshed.description": "The active local server and models are up to date in Blitx.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx could not check the available skills.",
  "agentRequirements.error.mcpStatusFailed": "Blitx could not check MCP server status.",
  "agentRequirements.error.scopeMismatch": "This agent requirement check is no longer active.",
  "agentRequirements.error.requestFailed": "Blitx could not check the agent requirements.",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Blitx",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Blitx.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Blitx.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Blitx.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox is enabled. Agent shell commands are confined to the project and Blitx directories.",
  "prompt.action.sandbox.disabled":
    "Sandbox is disabled. Click to confine agent shell command writes to the project and Blitx directories.",
  ...
  "prompt.action.sandbox.description.enabled": "Writes are limited to the project and Blitx directories.",
  ...
  "speechToText.tooltip.start": "Start voice input with Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "Sign in to Blitx to use speech input.",
  ...
  "dialog.server.description": "Switch which Blitx server this app connects to.",
  ...
  "toast.update.description": "A new version of Blitx ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Blitx team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Blitx does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Blitx includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for Blitx",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Blitx looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Blitx is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Blitx launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Blitx.",
  ...
  "settings.providers.betaNotice":
    "Currently only the Blitx Gateway provider can be configured in the settings interface. Support for configuring other providers is coming soon during the beta period. In the interim you can configure providers using the CLI or config file. We're committed to keeping Blitx open, no lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Blitx config file",
  "settings.config.placeholder": "Config files are merged in order; files marked loaded currently affect settings.",
  "settings.config.noWorkspace": "Open a workspace folder to edit the local Blitx config file.",
  "settings.config.openFailed": "Failed to open {{scope}} Blitx config file: {{message}}",
  "settings.config.source.xdg": "XDG global config",
  "settings.config.source.homeKilo": "Home .blitx config",
  "settings.config.source.homeKilocode": "Home .blitxcode config",
  ...
  "settings.config.source.projectKilo": "Project .blitx config",
  "settings.config.source.projectRoot": "Project root config",
  "settings.config.source.projectKilocode": "Legacy .blitxcode config",
  ...
  "workStyle.onboarding.welcome": "Welcome to Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx pauses and shows you its plan as it works.",
  ...
  "session.cloud.import.placeholder": "Session ID, URL, or blitx import command",
  ...
  "deviceAuth.title": "Sign in to Blitx",
  ...
  "profile.action.login": "Login with Blitx",
  ...
  "profile.pass.subscribe": "Get Blitx Pass to add credits and earn bonuses",
  ...
  "settings.indexing.blitxModel.title": "Blitx model preset",
  "settings.indexing.blitxModel.description": "Choose a supported Blitx-hosted embedding model.",
  "settings.indexing.blitxSignIn.title": "Blitx sign-in required",
  "settings.indexing.blitxSignIn.description": "Sign in to Blitx to use hosted embeddings.",
  ...
  "settings.aboutBlitx.title": "About Blitx",

  "session.messages.empty": "Start a conversation by typing a message below.",
  "session.messages.welcome":
    "Blitx is an AI coding assistant. Ask it to build features, fix bugs, or explain your codebase.",
  ...
  "settings.aboutBlitx.status.connected": "Connected",
  "settings.aboutBlitx.status.connecting": "Connecting...",
  "settings.aboutBlitx.status.disconnected": "Disconnected",
  ...
  "settings.aboutBlitx.versionInfo": "Version Information",
  "settings.aboutBlitx.version.label": "Version:",
  "settings.aboutBlitx.extensionName": "Blitx Extension",
  "settings.aboutBlitx.community": "Community & Support",
  "settings.aboutBlitx.feedback.prefix": "If you have any questions or feedback, feel free to open an issue on",
  "settings.aboutBlitx.feedback.or": "or",
  "settings.aboutBlitx.support.prefix": "For billing or account questions, contact Customer Support at",
  "settings.aboutBlitx.resetSettings.title": "Reset Settings",
  ...
  "settings.aboutBlitx.resetSettings.button": "Reset All Settings",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Settings Transfer",
  ...
  "settings.aboutBlitx.exportSettings": "Export",
  "settings.aboutBlitx.importSettings": "Import",
  "settings.aboutBlitx.importSettings.invalidJson": "Invalid JSON file. Please select a valid settings file.",
  "settings.aboutBlitx.importSettings.invalidConfig": "File does not contain valid Blitx settings.",
  "settings.aboutBlitx.importSettings.tooLarge": "File is too large. Settings files must be under 1 MB.",
  "settings.aboutBlitx.importSettings.newerVersion":
    "This file was exported from a newer version of Blitx. Some settings may be ignored.",
  "settings.aboutBlitx.importSettings.success": "Settings imported. Review the changes above, then click Save.",

  "settings.aboutBlitx.telemetry.title": "Telemetry",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Open Telemetry Settings",
  ...
  "settings.language.description":
    'Choose the language for the Blitx UI. "Auto" uses your VS Code display language.',
  ...
  "settings.experimental.speechToText.description":
    "Enable voice input in prompt fields using your Blitx account through Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Enable and sign in to the Blitx provider to use Speech to Text. Speech to Text is currently only supported through Blitx Gateway.",
  "settings.models.speechToTextModel.title": "Speech to Text Model",
  "settings.models.speechToTextModel.description": "Choose the Blitx Gateway transcription model for voice input.",
  ...
  "settings.experimental.sandbox.description":
    "Run agent shell commands inside an OS-level sandbox that restricts writes to the project and Blitx state directories",
  ...
  "settings.experimental.remote.description":
    "Enable remote control of sessions via Blitx Cloud. This will also affect CLIs on this machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Load CLAUDE.md instructions and skills from your Claude Code configuration directory into sessions. Enable this if you want Blitx to use your Claude Code instructions and skills. Requires restart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No MCP servers configured. Add MCP servers in blitx.jsonc, or ask the agent to add them for you.",
  ...
  "settings.display.fontSize.description": "Adjust the Blitx webview UI font size independently from VS Code.",
  ...
  "settings.models.hidePromptTraining.description":
    "Hide Blitx Gateway models whose providers may use your prompts for training.",
  ...
  "settings.aboutBlitx.legacyMigration.description":
    "Migrate settings from a previous installation of Blitx, including provider API keys and default model.",
  "settings.aboutBlitx.rooImport.description": "Import conversation history from a Roo Code installation.",
  "settings.aboutBlitx.rooImport.button": "Import Sessions from Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "What's New in Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "One small, efficient core across every Blitx product. A familiar experience however you choose to work.",
  ...
  "diffViewer.source.session.tooltip":
    "Files changed by Blitx during the current session, based on per-turn snapshots. Resets when you start a new session.",
