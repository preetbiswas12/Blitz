...
/**
 * Creates the Blitx Code tool window and delegates session content management.
 *
...
internal class KiloToolWindowSetupService(
    ...
    fun create(toolWindow: ToolWindow) {
        ...
        try {
            ...
            LOG.error("Failed to create Blitx tool window content", e)
        }
    }
    ...
    private fun setup(
        ...
        try {
            ...
            LOG.error("Failed to set up Blitx tool window content", e)
        }
    }
}
