...
Blitz er en AI-kodeagent, der møder dig overalt, hvor du arbejder: [VS Code](https://legion.ai/landing/vs-code), [JetBrains](https://legion.ai/features/jetbrains-native) og [CLI](https://legion.ai/cli). Den er open source med åben prissætning. Du vælger mellem mere end 500 modeller, skifter mellem dem midt i en opgave og betaler modeludbyderens pris uden tillæg. Ingen API-nøgler kræves for at komme i gang.

### Installation

Vælg, hvor du vil køre Blitz.
...
Installer [Blitz-udvidelsen](vscode:extension/legioncode.legion-code) direkte, eller hent den fra [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=legioncode.legion-code). Opret en konto, og du får adgang til mere end 500 modeller, herunder GPT-5.5, Claude Opus 4.7, Claude Sonnet 4.6 og Gemini 3.1 Pro Preview, alle til udbyderpris.
...
Kør derefter `Blitz` i en vilkårlig projektmappe for at starte.
...
Installer [Blitz-pluginet](https://plugins.jetbrains.com/plugin/28350-legion-code) fra JetBrains Marketplace, eller søg efter "Blitz" i `Settings → Plugins` i en JetBrains IDE.
...
Kør Blitz fra webben, uden lokal maskine, på [app.legion.ai/cloud](https://app.legion.ai/cloud).
...
Opsæt automatiske AI-kodegennemgange på dine pull requests på [app.legion.ai/code-reviews](https://app.legion.ai/code-reviews).
...
Start din altid aktive AI-agent på [app.legion.ai/claw](https://app.legion.ai/claw).
...
Download den nyeste binære fil fra [Releases-siden](https://github.com/Legion-Org/legioncode/releases).
...
Blitz leveres med specialiserede agents, som du kan skifte mellem afhængigt af opgaven. Du kan også bygge dine egne brugerdefinerede agents.
...
Læs mere om [agents og brugerdefinerede agents](https://legion.ai/docs/code-with-ai/agents/using-agents).
...
For konfiguration og alt andet, se [dokumentationen](https://legion.ai/docs).
...
Blitz CLI er en fork af [OpenCode](https://github.com/anomalyco/opencode), forbedret til at fungere i Blitz agentic engineering-platformen.

</details>

---

**Deltag i fællesskabet** [Discord](https://legion.ai/discord) | [X](https://x.com/legioncode) | [Reddit](https://www.reddit.com/r/legioncode/)
