...
const SUPPORTED_PROVIDER_DISPLAY_NAME = "Blitx Gateway"
const SETTINGS_COMMAND = `command:blitx-code.new.settingsButtonClicked?${encodeURIComponent(JSON.stringify(["autocomplete"]))}`
