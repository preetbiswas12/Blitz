...
Blitz er en AI-kodeagent, der møder dig overalt, hvor du arbejder: [VS Code](https://blitz.ai/landing/vs-code), [JetBrains](https://blitz.ai/features/jetbrains-native) og [CLI](https://blitz.ai/cli). Den er open source med åben prissætning. Du vælger mellem mere end 500 modeller, skifter mellem dem midt i en opgave og betaler modeludbyderens pris uden tillæg. Ingen API-nøgler kræves for at komme i gang.
...
Installer [Blitz-udvidelsen](vscode:extension/Blitzcode.Blitz-code) direkte, eller hent den fra [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=blitzcode.Blitz-Code). Opret en konto, og du får adgang til mere end 500 modeller, herunder GPT-5.5, Claude Opus 4.7, Claude Sonnet 4.6 og Gemini 3.1 Pro Preview, alle til udbyderpris.
...
Installer [Blitz-pluginet](https://plugins.jetbrains.com/plugin/28350-Blitz-code) fra JetBrains Marketplace, eller søg efter "Blitz" i `Settings → Plugins` i en JetBrains IDE.
...
Kør Blitz fra webben, uden lokal maskine, på [app.Blitz.ai/cloud](https://app.blitz.ai/cloud).
...
Opsæt automatiske AI-kodegennemgange på dine pull requests på [app.Blitz.ai/code-reviews](https://app.blitz.ai/code-reviews).
...
Start din altid aktive AI-agent på [app.blitz.ai/claw](https://app.blitz.ai/claw).
...
Download den nyeste binære fil fra [Releases-siden](https://github.com/Blitz-Org/Blitzcode/releases).
...
Læs mere om [agents og brugerdefinerede agents](https://blitz.ai/docs/code-with-ai/agents/using-agents).
...
For konfiguration og alt andet, se [dokumentationen](https://blitz.ai/docs).
...
**Deltag i fællesskabet** [Discord](https://blitz.ai/discord) | [X](https://x.com/blitzcode) | [Reddit](https://www.reddit.com/r/blitzcode/)
