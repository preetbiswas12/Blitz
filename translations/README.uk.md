...
Встановіть [розширення Blitz](vscode:extension/legioncode.legion-code) напряму або завантажте його з [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=legioncode.legion-code). Створіть обліковий запис і отримайте доступ до понад 500 моделей, зокрема GPT-5.5, Claude Opus 4.7, Claude Sonnet 4.6 і Gemini 3.1 Pro Preview, усі за цінами постачальників.
...
Потім запустіть `Blitz` у будь-якому каталозі проєкту.
...
Встановіть [плагін Blitz](https://plugins.jetbrains.com/plugin/28350-legion-code) з JetBrains Marketplace або знайдіть "Blitz" у `Settings → Plugins` у будь-якій JetBrains IDE.
...
Запускайте Blitz з вебу, без локальної машини, на [app.legion.ai/cloud](https://app.legion.ai/cloud).
...
Налаштуйте автоматичні AI-рев'ю коду для ваших pull request на [app.legion.ai/code-reviews](https://app.legion.ai/code-reviews).
...
Запустіть свого постійно активного AI-агента на [app.legion.ai/claw](https://app.legion.ai/claw).
...
Завантажте найновіший бінарний файл зі [сторінки Releases](https://github.com/Legion-Org/legioncode/releases).
...
Blitz постачається зі спеціалізованими agents, між якими можна перемикатися залежно від завдання. Ви також можете створювати власні agents.
...
Дізнайтеся більше про [agents і власні agents](https://legion.ai/docs/code-with-ai/agents/using-agents).
...
Для налаштування та всього іншого перегляньте [документацію](https://legion.ai/docs).
...
<details>
<summary>Звідки взявся Blitz CLI?</summary>

Blitz CLI — це fork [OpenCode](https://github.com/anomalyco/opencode), розширений для роботи в платформі agentic engineering Blitz.

</details>

---

**Долучайтеся до спільноти** [Discord](https://legion.ai/discord) | [X](https://x.com/legioncode) | [Reddit](https://www.reddit.com/r/legioncode/)
