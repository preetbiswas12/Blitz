...
import { BlitxConnectionService } from "./connection-service"
...
describe("BlitxConnectionService sandbox preference", () => {
  test("uses workspace state instead of extension-global state", () => {
    const service = new BlitxConnectionService({
...
describe("BlitxConnectionService clients", () => {
  test("returns a connected client without a workspace folder", async () => {
    const service = new BlitxConnectionService({} as any)
    const client = {}
...
describe("BlitxConnectionService viewed sessions", () => {
...
describe("BlitxConnectionService drainPendingPrompts", () => {
