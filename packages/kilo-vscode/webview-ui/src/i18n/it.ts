export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Installa Anaconda Desktop su questo computer, poi torna qui. Blitx non esegue il programma di installazione per te.",
  ...
  "provider.anaconda.state.signedOut": "Apri Anaconda Desktop e accedi prima di connettere Blitx.",
  "provider.anaconda.state.unauthorized":
    "Blitx non è riuscito ad accedere ad Anaconda Desktop. Apri Desktop, accedi di nuovo e riavvialo se necessario.",
  ...
  "provider.anaconda.state.ready":
    "Blitx ha trovato un server locale di generazione del testo integro e può importare le sue attuali impostazioni di connessione.",
  ...
  "provider.anaconda.toast.refreshed.description": "Il server locale attivo e i modelli sono aggiornati in Blitx.",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Blitx",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la tua API key {{provider}} per connettere l'account e usare i modelli {{provider}} in Blitx.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere l'account e usare i modelli {{provider}} in Blitx.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere l'account e usare i modelli {{provider}} in Blitx.",
  ...
  "dialog.server.description": "Cambia il server Blitx a cui si connette questa app.",
  ...
  "toast.update.description": "Una nuova versione di Blitx ({{version}}) è disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Blitx",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" non riuscito. Nota: Blitx non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Blitx include modelli gratuiti, così puoi iniziare subito.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione di Blitx",
  "settings.general.row.appearance.title": "Aspetto",
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Blitx sul tuo dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Blitx.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti quando Blitx si avvia",
  ...
  "settings.updates.toast.latest.description": "Stai usando la versione più recente di Blitx.",
  ...
  "settings.providers.betaNotice":
    "Al momento solo il provider Blitx Gateway può essere configurato dall'interfaccia delle impostazioni. Il supporto per altri provider arriverà durante il periodo beta. Nel frattempo puoi configurare i provider con la CLI o il file di configurazione. Ci impegniamo a mantenere Blitx aperto, senza lock-in.",
  ...
  "settings.config.title": "Apri file config Blitx {{scope}}",
  "settings.config.placeholder":
    "I file config vengono uniti in ordine; i file marcati come caricati influenzano attualmente le impostazioni.",
  "settings.config.noWorkspace": "Apri una cartella workspace per modificare il file config Blitx locale.",
  "settings.config.openFailed": "Apertura file config Blitx {{scope}} non riuscita: {{message}}",
  ...
  "workStyle.onboarding.welcome": "Ti diamo il benvenuto in Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx si mette in pausa e ti mostra il suo piano mentre lavora.",
  ...
  "session.cloud.import.placeholder": "ID sessione, URL o comando blitx import",
  ...
  "deviceAuth.title": "Accedi a Blitx",
  ...
  "profile.action.login": "Accedi con Blitx",
  ...
  "profile.pass.subscribe": "Ottieni Blitx Pass per aggiungere crediti e guadagnare bonus",
  ...
  "settings.aboutBlitx.title": "Informazioni su Blitx",
  "session.messages.empty": "Avvia una conversazione scrivendo un messaggio qui sotto.",
  "session.messages.welcome":
    "Blitx è un assistente AI per il coding. Chiedigli di creare feature, correggere bug o spiegare il codebase.",
  ...
  "settings.aboutBlitx.status.connected": "Connesso",
  "settings.aboutBlitx.status.connecting": "Connessione...",
  "settings.aboutBlitx.status.disconnected": "Disconnesso",
  "settings.aboutBlitx.status.error": "Errore",
  "settings.aboutBlitx.cliServer": "Server CLI",
  "settings.aboutBlitx.status.label": "Stato:",
  "settings.aboutBlitx.port.label": "Porta:",
  "settings.aboutBlitx.versionInfo": "Informazioni versione",
  "settings.aboutBlitx.version.label": "Versione:",
  "settings.aboutBlitx.extensionName": "Estensione Blitx",
  "settings.aboutBlitx.community": "Community e supporto",
  "settings.aboutBlitx.feedback.prefix": "Per domande o feedback, apri pure una issue su",
  "settings.aboutBlitx.feedback.or": "oppure",
  "settings.aboutBlitx.support.prefix": "Per domande su fatturazione o account, contatta il supporto clienti a",
  "settings.aboutBlitx.resetSettings.title": "Ripristina impostazioni",
  ...
  "settings.aboutBlitx.resetSettings.button": "Ripristina tutte le impostazioni",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Trasferimento impostazioni",
  "settings.aboutBlitx.settingsTransfer.description":
    "Esporta o importa le impostazioni per trasferirle tra istanze VS Code.",
  "settings.aboutBlitx.exportSettings": "Esporta",
  "settings.aboutBlitx.importSettings": "Importa",
  "settings.aboutBlitx.importSettings.invalidJson": "File JSON non valido. Seleziona un file impostazioni valido.",
  "settings.aboutBlitx.importSettings.invalidConfig": "Il file non contiene impostazioni Blitx valide.",
  "settings.aboutBlitx.importSettings.tooLarge": "File troppo grande. I file impostazioni devono essere sotto 1 MB.",
  "settings.aboutBlitx.importSettings.newerVersion":
    "Questo file è stato esportato da una versione più recente di Blitx. Alcune impostazioni potrebbero essere ignorate.",
  "settings.aboutBlitx.importSettings.success":
    "Impostazioni importate. Controlla le modifiche sopra, poi fai clic su Salva.",
  "settings.aboutBlitx.telemetry.title": "Telemetria",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Apri impostazioni telemetria",
  ...
  "settings.language.description": 'Scegli la lingua dell\'interfaccia Blitx. "Auto" usa la lingua di VS Code.',
  ...
  "settings.experimental.remote.description":
    "Abilita controllo remoto delle sessioni tramite Blitx Cloud. Influenzerà anche le CLI su questa macchina.",
  ...
  "prompt.action.sandbox.enabled":
    "Sandbox abilitata. I comandi shell dell'agente sono limitati alle directory del progetto e di Blitx.",
  "prompt.action.sandbox.disabled":
    "Sandbox disabilitata. Fai clic per limitare le scritture dei comandi shell dell'agente alle directory del progetto e di Blitx.",
  ...
  "prompt.action.sandbox.description.enabled": "Le scritture sono limitate alle directory del progetto e di Blitx.",
  ...
  "settings.experimental.sandbox.description":
    "Esegui i comandi shell dell'agente all'interno di un sandbox a livello di sistema operativo che limita le scritture alle directory di stato del progetto e di Blitx",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carica istruzioni CLAUDE.md e skill dalla directory di configurazione Claude Code nelle sessioni. Abilitalo se vuoi che Blitx usi istruzioni e skill di Claude Code. Richiede riavvio.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nessun server MCP configurato. Aggiungi server MCP in blitx.jsonc, o chiedi all'agente di aggiungerli per te.",
  ...
  "settings.display.fontSize.description":
    "Regola la dimensione del font della webview Blitx indipendentemente da VS Code.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "Migrazione legacy",
  "settings.aboutBlitx.legacyMigration.description":
    "Migra le impostazioni da una precedente installazione di Blitx, incluse API key dei provider e modello predefinito.",
  "settings.aboutBlitx.rooImport.description":
    "Importa la cronologia delle conversazioni da una installazione di Roo Code.",
  "settings.aboutBlitx.rooImport.button": "Importa sessioni da Roo Code",
  "migration.whatsNew.title": "Novità in Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un core piccolo ed efficiente per ogni prodotto Blitx. Un'esperienza familiare comunque tu scelga di lavorare.",
  ...
  "diffViewer.source.session.tooltip":
    "File modificati da Blitx durante la sessione corrente, basati su snapshot per turno. Si resetta quando inizi una nuova sessione.",
  ...
  "settings.experimental.speechToText.description":
    "Abilita input vocale nei campi prompt usando il tuo account Blitx tramite Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Abilita e accedi al provider Blitx per usare Da voce a testo. Da voce a testo è attualmente supportato solo tramite Blitx Gateway.",
  "settings.models.speechToTextModel.title": "Modello Da voce a testo",
  "settings.models.speechToTextModel.description": "Scegli il modello di trascrizione Blitx Gateway per l'input vocale.",
  ...
  "settings.models.hidePromptTraining.description":
    "Nascondi i modelli Blitx Gateway i cui provider potrebbero usare i tuoi prompt per l'addestramento.",
  ...
  "settings.indexing.blitxModel.title": "Preset modello Blitx",
  "settings.indexing.blitxModel.description": "Scegli un modello embedding ospitato da Blitx.",
  "settings.indexing.blitxSignIn.title": "Accesso Blitx richiesto",
  "settings.indexing.blitxSignIn.description": "Accedi a Blitx per usare gli embedding ospitati.",
  ...
  "agentRequirements.error.discoveryFailed": "Blitx non ha potuto controllare le skill disponibili.",
  "agentRequirements.error.mcpStatusFailed": "Blitx non ha potuto controllare lo stato del server MCP.",
  "agentRequirements.error.scopeMismatch": "Questo controllo dei requisiti dell’agente non è più attivo.",
  "agentRequirements.error.requestFailed": "Blitx non ha potuto controllare i requisiti dell’agente.",
  ...
  "speechToText.tooltip.start": "Avvia input vocale con Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "Accedi a Blitx per usare l'input vocale.",
