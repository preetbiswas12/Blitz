...
Cài trực tiếp [tiện ích Blitz](vscode:extension/Blitzcode.Blitz-code), hoặc tải từ [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=blitzcode.Blitz-Code). Tạo tài khoản và bạn sẽ có quyền truy cập hơn 500 mô hình, bao gồm GPT-5.5, Claude Opus 4.7, Claude Sonnet 4.6 và Gemini 3.1 Pro Preview, tất cả theo giá của nhà cung cấp.
...
Cài [plugin Blitz](https://plugins.jetbrains.com/plugin/28350-Blitz-code) từ JetBrains Marketplace, hoặc tìm "Blitz" trong `Settings → Plugins` bên trong bất kỳ JetBrains IDE nào.
...
Chạy Blitz từ web, không cần máy cục bộ, tại [app.Blitz.ai/cloud](https://app.blitz.ai/cloud).
...
Thiết lập review code tự động bằng AI cho pull request của bạn tại [app.Blitz.ai/code-reviews](https://app.blitz.ai/code-reviews).
...
Khởi chạy AI agent luôn hoạt động của bạn tại [app.blitz.ai/claw](https://app.blitz.ai/claw).
...
Tải binary mới nhất từ [trang Releases](https://github.com/Blitz-Org/Blitzcode/releases).
...
Tìm hiểu thêm về [agents và agents tùy chỉnh](https://blitz.ai/docs/code-with-ai/agents/using-agents).
...
Về cấu hình và mọi thứ khác, hãy xem [tài liệu](https://blitz.ai/docs).
...
**Tham gia cộng đồng** [Discord](https://blitz.ai/discord) | [X](https://x.com/blitzcode) | [Reddit](https://www.reddit.com/r/blitzcode/)
