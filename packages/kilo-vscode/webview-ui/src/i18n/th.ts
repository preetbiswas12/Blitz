export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "ติดตั้ง Anaconda Desktop บนเครื่องนี้ แล้วกลับมาที่นี่ Blitx จะไม่เรียกใช้ตัวติดตั้งให้คุณ",
  ...
  "provider.anaconda.state.signedOut": "เปิด Anaconda Desktop และลงชื่อเข้าใช้ก่อนเชื่อมต่อ Blitx",
  "provider.anaconda.state.unauthorized":
    "Blitx ไม่สามารถเข้าถึง Anaconda Desktop ได้ เปิด Desktop ลงชื่อเข้าใช้อีกครั้ง และรีสตาร์ทหากจำเป็น",
  ...
  "provider.anaconda.state.ready":
    "Blitx พบเซิร์ฟเวอร์สร้างข้อความในเครื่องที่พร้อมใช้งาน และสามารถนำเข้าการตั้งค่าการเชื่อมต่อปัจจุบันได้",
  ...
  "provider.anaconda.toast.refreshed.description": "เซิร์ฟเวอร์ในเครื่องและโมเดลที่ใช้งานอยู่เป็นปัจจุบันใน Blitx แล้ว",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx ไม่สามารถตรวจสอบสกิลที่มีอยู่ได้",
  "agentRequirements.error.mcpStatusFailed": "Blitx ไม่สามารถตรวจสอบสถานะเซิร์ฟเวอร์ MCP ได้",
  "agentRequirements.error.scopeMismatch": "การตรวจสอบข้อกำหนดของเอเจนต์นี้ไม่ทำงานอีกต่อไป",
  "agentRequirements.error.requestFailed": "Blitx ไม่สามารถตรวจสอบข้อกำหนดของเอเจนต์ได้",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Blitx",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Blitx",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Blitx",
  ...
  "provider.connect.oauth.auto.visit.suffix": " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Blitx",
  ...
  "prompt.action.sandbox.enabled":
    "เปิดใช้งาน sandbox แล้ว คำสั่ง shell ของ agent ถูกจำกัดไว้ที่โฟลเดอร์โปรเจ็กต์และ Blitx",
  "prompt.action.sandbox.disabled":
    "ปิดใช้งาน sandbox อยู่ คลิกเพื่อจำกัดการเขียนคำสั่ง shell ของ agent ไว้ที่โฟลเดอร์โปรเจ็กต์และ Blitx",
  ...
  "prompt.action.sandbox.description.enabled": "เขียนได้เฉพาะในโฟลเดอร์โปรเจ็กต์และ Blitx",
  ...
  "speechToText.tooltip.start": "เริ่มการป้อนข้อมูลด้วยเสียงด้วย Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "ลงชื่อเข้าใช้ Blitx เพื่อใช้การป้อนข้อมูลด้วยเสียง",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Blitx ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Blitx ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Blitx",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Blitx ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Blitx รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Blitx",
  "settings.general.row.appearance.title": "รูปลักษณ์",
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Blitx มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Blitx มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Blitx เปิดตัว",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้ Blitx เวอร์ชันล่าสุด",
  ...
  "settings.indexing.blitxModel.title": "พรีเซ็ตโมเดล Blitx",
  "settings.indexing.blitxModel.description": "เลือกโมเดลการฝังที่ Blitx โฮสต์และรองรับ",
  "settings.indexing.blitxSignIn.title": "ต้องลงชื่อเข้าใช้ Blitx",
  "settings.indexing.blitxSignIn.description": "ลงชื่อเข้าใช้ Blitx เพื่อใช้การฝังแบบโฮสต์",
  ...
  "settings.providers.betaNotice":
    "ปัจจุบันสามารถตั้งค่าได้เฉพาะผู้ให้บริการ Blitx Gateway ในหน้าการตั้งค่าเท่านั้น การรองรับการตั้งค่าผู้ให้บริการรายอื่นจะพร้อมใช้งานในเร็วๆ นี้ในช่วงเบต้า ในระหว่างนี้คุณสามารถตั้งค่าผู้ให้บริการผ่าน CLI หรือไฟล์คอนฟิกได้ เรามุ่งมั่นที่จะรักษาให้ Blitx เปิดกว้างและไม่มีการผูกมัด",
  ...
  "settings.models.hidePromptTraining.description": "ซ่อนโมเดล Blitx Gateway ที่ผู้ให้บริการอาจใช้พรอมต์ของคุณในการฝึก",
  ...
  "settings.config.title": "เปิดไฟล์การตั้งค่า Blitx ({{scope}})",
  "settings.config.placeholder":
    "ไฟล์การตั้งค่าจะถูกผสานตามลำดับ ไฟล์ที่ถูกทำเครื่องหมายว่าโหลดแล้วจะมีผลกับการตั้งค่าในปัจจุบัน",
  "settings.config.noWorkspace": "เปิดโฟลเดอร์พื้นที่ทำงานเพื่อแก้ไขไฟล์การตั้งค่า Blitx ภายใน",
  "settings.config.openFailed": "ไม่สามารถเปิดไฟล์การตั้งค่า Blitx ({{scope}}): {{message}}",
  ...
  "workStyle.onboarding.welcome": "ยินดีต้อนรับสู่ Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx จะหยุดและแสดงแผนให้คุณเห็นระหว่างการทำงาน",
  ...
  "session.cloud.import.placeholder": "ID เซสชัน, URL หรือคำสั่ง blitx import",
  ...
  "deviceAuth.title": "เข้าสู่ระบบ Blitx",
  ...
  "profile.action.login": "เข้าสู่ระบบด้วย Blitx",
  ...
  "profile.pass.subscribe": "รับ Blitx Pass เพื่อเพิ่มเครดิตและรับโบนัส",
  ...
  "settings.aboutBlitx.title": "เกี่ยวกับ Blitx",

  "session.messages.empty": "เริ่มการสนทนาโดยพิมพ์ข้อความด้านล่าง",
  "session.messages.welcome": "Blitx เป็นผู้ช่วยเขียนโค้ด AI ขอให้สร้างฟีเจอร์ แก้ไขบัก หรืออธิบายโค้ดเบสของคุณ",
  ...
  "settings.aboutBlitx.status.connected": "เชื่อมต่อแล้ว",
  "settings.aboutBlitx.status.connecting": "กำลังเชื่อมต่อ...",
  "settings.aboutBlitx.status.disconnected": "ตัดการเชื่อมต่อ",
  "settings.aboutBlitx.status.error": "ข้อผิดพลาด",
  "settings.aboutBlitx.cliServer": "เซิร์ฟเวอร์ CLI",
  "settings.aboutBlitx.status.label": "สถานะ:",
  "settings.aboutBlitx.port.label": "พอร์ต:",
  "settings.aboutBlitx.versionInfo": "ข้อมูลเวอร์ชัน",
  "settings.aboutBlitx.version.label": "เวอร์ชัน:",
  "settings.aboutBlitx.extensionName": "ส่วนขยาย Blitx",
  "settings.aboutBlitx.community": "ชุมชนและการสนับสนุน",
  "settings.aboutBlitx.feedback.prefix": "หากคุณมีคำถามหรือข้อเสนอแนะ สามารถเปิด issue ได้ที่",
  "settings.aboutBlitx.feedback.or": "หรือ",
  "settings.aboutBlitx.support.prefix": "สำหรับคำถามเกี่ยวกับการเรียกเก็บเงินหรือบัญชี ติดต่อฝ่ายสนับสนุนลูกค้าที่",
  "settings.aboutBlitx.resetSettings.title": "รีเซ็ตการตั้งค่า",
  ...
  "settings.aboutBlitx.resetSettings.button": "รีเซ็ตการตั้งค่าทั้งหมด",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "ถ่ายโอนการตั้งค่า",
  "settings.aboutBlitx.settingsTransfer.description":
    "ส่งออกหรือนำเข้าการตั้งค่าเพื่อถ่ายโอนระหว่างอินสแตนซ์ VS Code",
  "settings.aboutBlitx.exportSettings": "ส่งออก",
  "settings.aboutBlitx.importSettings": "นำเข้า",
  "settings.aboutBlitx.importSettings.invalidJson": "ไฟล์ JSON ไม่ถูกต้อง กรุณาเลือกไฟล์การตั้งค่าที่ถูกต้อง",
  "settings.aboutBlitx.importSettings.invalidConfig": "ไฟล์ไม่มีการตั้งค่า Blitx ที่ถูกต้อง",
  "settings.aboutBlitx.importSettings.tooLarge": "ไฟล์มีขนาดใหญ่เกินไป ไฟล์การตั้งค่าต้องมีขนาดไม่เกิน 1 MB",
  "settings.aboutBlitx.importSettings.newerVersion":
    "ไฟล์นี้ถูกส่งออกจาก Blitx เวอร์ชันใหม่กว่า การตั้งค่าบางรายการอาจถูกข้ามไป",
  "settings.aboutBlitx.importSettings.success": "นำเข้าการตั้งค่าแล้ว ตรวจสอบการเปลี่ยนแปลงด้านบน จากนั้นคลิกบันทึก",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "เปิดการตั้งค่า Telemetry",
  ...
  "settings.language.description": 'เลือกภาษาสำหรับ UI ของ Blitx "อัตโนมัติ" จะใช้ภาษาการแสดงผลของ VS Code',
  ...
  "settings.experimental.speechToText.description":
    "เปิดใช้งานการป้อนข้อมูลด้วยเสียงในช่องพรอมต์โดยใช้บัญชี Blitx ของคุณผ่าน Blitx Gateway",
  "settings.models.speechToText.disabledDescription":
    "เปิดใช้งานและลงชื่อเข้าใช้ผู้ให้บริการ Blitx เพื่อใช้ Speech to Text ปัจจุบัน Speech to Text รองรับเฉพาะกับ Blitx Gateway เท่านั้น",
  "settings.models.speechToTextModel.title": "โมเดลแปลงเสียงเป็นข้อความ",
  "settings.models.speechToTextModel.description": "เลือกโมเดลการถอดเสียง Blitx Gateway สำหรับการป้อนข้อมูลด้วยเสียง",
  ...
  "settings.experimental.remote.description":
    "เปิดใช้งานการควบคุม Remote ของเซสชันผ่าน Blitx Cloud ซึ่งจะส่งผลต่อ CLI บนเครื่องนี้ด้วย",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "โหลดคำแนะนำและทักษะจาก CLAUDE.md ในไดเรกทอรีการกำหนดค่า Claude Code ของคุณลงในเซสชัน เปิดใช้งานตัวเลือกนี้หากคุณต้องการให้ Blitx ใช้คำแนะนำและทักษะจาก Claude Code ของคุณ จำเป็นต้องรีสตาร์ท",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "ไม่ได้กำหนดค่าเซิร์ฟเวอร์ MCP เพิ่มเซิร์ฟเวอร์ MCP ใน blitx.jsonc หรือขอให้เอเจนต์เพิ่มให้คุณ",
  ...
  "settings.experimental.sandbox.description":
    "เรียกใช้คำสั่ง shell ของ agent ใน sandbox ระดับระบบปฏิบัติการที่จำกัดการเขียนไปยังโฟลเดอร์สถานะของโปรเจ็กต์และ Blitx",
  ...
  "settings.display.fontSize.description": "ปรับขนาดฟอนต์ webview UI ของ Blitx แยกเป็นอิสระจาก VS Code.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "การย้ายข้อมูลจากเวอร์ชันดั้งเดิม",
  "settings.aboutBlitx.legacyMigration.description":
    "ย้ายการตั้งค่าจากการติดตั้ง Blitx ก่อนหน้านี้ รวมถึงคีย์ API ของผู้ให้บริการและโมเดลเริ่มต้น",
  "settings.aboutBlitx.rooImport.description": "นำเข้าประวัติการสนทนาจากการติดตั้ง Roo Code",
  "settings.aboutBlitx.rooImport.button": "นำเข้าเซสชันจาก Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "มีอะไรใหม่ใน Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "แกนหลักขนาดเล็กและมีประสิทธิภาพเดียวกันในทุกผลิตภัณฑ์ Blitx ประสบการณ์ที่คุ้นเคยไม่ว่าคุณจะเลือกทำงานอย่างไร",
  ...
  "diffViewer.source.session.tooltip":
    "ไฟล์ที่ Blitx แก้ไขในช่วงเซสชันปัจจุบัน โดยอิงจากสแน็ปช็อตต่อเทิร์น จะรีเซ็ตเมื่อเริ่มเซสชันใหม่",
