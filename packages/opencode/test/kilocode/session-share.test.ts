...
it.instance("shares and unshares sessions through Kilo public URLs", () => {
  ...
  return Effect.gen(function* () {
    ...
    expect(result.url).toBe("https://app.kilocodecode.ai/s/public-1") // TODO: Replace with Legion share URL
    expect((yield* session.get(info.id)).share?.url).toBe("https://app.kilocodecode.ai/s/public-1") // TODO: Replace with Legion share URL
