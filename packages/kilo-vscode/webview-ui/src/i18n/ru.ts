export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "Установите Anaconda Desktop на этом компьютере, затем вернитесь сюда. Blitx не запускает установщик за вас.",
  ...
  "provider.anaconda.state.signedOut": "Откройте Anaconda Desktop и войдите в систему перед подключением Blitx.",
  "provider.anaconda.state.unauthorized":
    "Blitx не удалось получить доступ к Anaconda Desktop. Откройте Desktop, войдите снова и при необходимости перезапустите его.",
  ...
  "provider.anaconda.state.ready":
    "Blitx обнаружил исправный локальный сервер генерации текста и может импортировать его текущие настройки подключения.",
  ...
  "provider.anaconda.toast.refreshed.description": "Активный локальный сервер и модели актуальны в Blitx.",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx не смог проверить доступные навыки.",
  "agentRequirements.error.mcpStatusFailed": "Blitx не смог проверить состояние сервера MCP.",
  "agentRequirements.error.scopeMismatch": "Эта проверка требований агента больше не активна.",
  "agentRequirements.error.requestFailed": "Blitx не смог проверить требования агента.",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Blitx",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Blitx.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Blitx.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Blitx.",
  ...
  "prompt.action.sandbox.enabled": "Песочница включена. Команды оболочки агента ограничены каталогами проекта и Blitx.",
  "prompt.action.sandbox.disabled":
    "Песочница отключена. Нажмите, чтобы ограничить запись команд оболочки агента каталогами проекта и Blitx.",
  ...
  "prompt.action.sandbox.description.enabled": "Запись разрешена только в каталогах проекта и Blitx.",
  ...
  "speechToText.tooltip.start": "Начать голосовой ввод с Blitx Gateway",
  ...
  "speechToText.error.loginRequired": "Войдите в Blitx, чтобы использовать голосовой ввод.",
  ...
  "dialog.server.description": "Переключите сервер Blitx к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия Blitx ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Blitx",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Blitx пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Blitx включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Blitx",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как Blitx выглядит на вашем устройстве",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Blitx.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Blitx",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Blitx.",
  ...
  "settings.indexing.blitxModel.title": "Предустановка модели Blitx",
  "settings.indexing.blitxModel.description": "Выберите поддерживаемую модель эмбеддингов, размещенную в Blitx.",
  "settings.indexing.blitxSignIn.title": "Требуется вход в Blitx",
  "settings.indexing.blitxSignIn.description": "Войдите в Blitx, чтобы использовать размещенные эмбеддинги.",
  ...
  "settings.providers.betaNotice":
    "В настоящее время в интерфейсе настроек можно настроить только провайдер Blitx Gateway. Поддержка настройки других провайдеров скоро появится в период бета-тестирования. А пока вы можете настраивать провайдеров с помощью CLI или конфигурационного файла. Мы стремимся сохранить Blitx открытым — без привязки к поставщикам.",
  ...
  "settings.models.hidePromptTraining.description":
    "Скрывать модели Blitx Gateway, поставщики которых могут использовать ваши запросы для обучения.",
  ...
  "settings.config.title": "Открыть файл конфигурации Blitx ({{scope}})",
  ...
  "settings.config.noWorkspace":
    "Откройте папку рабочей области для редактирования локального файла конфигурации Blitx.",
  "settings.config.openFailed": "Не удалось открыть файл конфигурации Blitx ({{scope}}): {{message}}",
  ...
  "workStyle.onboarding.welcome": "Добро пожаловать в Blitx",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitx приостанавливается и показывает свой план по ходу работы.",
  ...
  "session.cloud.import.placeholder": "ID сессии, URL или команда blitx import",
  ...
  "deviceAuth.title": "Войти в Blitx",
  ...
  "profile.action.login": "Войти через Blitx",
  ...
  "profile.pass.subscribe": "Оформите Blitx Pass, чтобы добавить кредиты и получать бонусы",
  ...
  "settings.aboutBlitx.title": "О Blitx",

  "session.messages.empty": "Начните разговор, введя сообщение ниже.",
  "session.messages.welcome":
    "Blitx — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.aboutBlitx.status.connected": "Подключено",
  "settings.aboutBlitx.status.connecting": "Подключение...",
  "settings.aboutBlitx.status.disconnected": "Отключено",
  "settings.aboutBlitx.status.error": "Ошибка",
  "settings.aboutBlitx.cliServer": "CLI-сервер",
  "settings.aboutBlitx.status.label": "Статус:",
  "settings.aboutBlitx.port.label": "Порт:",
  "settings.aboutBlitx.versionInfo": "Информация о версии",
  "settings.aboutBlitx.version.label": "Версия:",
  "settings.aboutBlitx.extensionName": "Расширение Blitx",
  "settings.aboutBlitx.community": "Сообщество и поддержка",
  "settings.aboutBlitx.feedback.prefix": "Если у вас есть вопросы или отзывы, создайте issue на",
  "settings.aboutBlitx.feedback.or": "или",
  "settings.aboutBlitx.support.prefix": "По вопросам оплаты или аккаунта обращайтесь в службу поддержки по адресу",
  "settings.aboutBlitx.resetSettings.title": "Сброс настроек",
  ...
  "settings.aboutBlitx.resetSettings.button": "Сбросить все настройки",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "Перенос настроек",
  ...
  "settings.aboutBlitx.exportSettings": "Экспорт",
  "settings.aboutBlitx.importSettings": "Импорт",
  "settings.aboutBlitx.importSettings.invalidJson": "Недопустимый файл JSON. Выберите корректный файл настроек.",
  "settings.aboutBlitx.importSettings.invalidConfig": "Файл не содержит допустимых настроек Blitx.",
  "settings.aboutBlitx.importSettings.tooLarge": "Файл слишком большой. Файлы настроек должны быть менее 1 MB.",
  "settings.aboutBlitx.importSettings.newerVersion":
    "Этот файл был экспортирован из более новой версии Blitx. Некоторые настройки могут быть проигнорированы.",
  "settings.aboutBlitx.importSettings.success":
    "Настройки импортированы. Просмотрите изменения выше и нажмите «Сохранить».",

  "settings.aboutBlitx.telemetry.title": "Телеметрия",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "Открыть настройки телеметрии",
  ...
  "settings.language.description": "Выберите язык интерфейса Blitx. «Авто» использует язык отображения VS Code.",
  ...
  "settings.experimental.speechToText.description":
    "Включите голосовой ввод в полях запросов, используя вашу учетную запись Blitx через Blitx Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Включите провайдер Blitx и выполните вход, чтобы использовать Speech to Text. В настоящее время Speech to Text поддерживается только с Blitx Gateway.",
  "settings.models.speechToTextModel.title": "Модель речи в текст",
  "settings.models.speechToTextModel.description": "Выберите модель транскрипции Blitx Gateway для голосового ввода.",
  ...
  "settings.experimental.remote.description":
    "Включите управление Remote сеансами через Blitx Cloud. Это также повлияет на CLI на этом компьютере.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Загружать инструкции CLAUDE.md и навыки из каталога конфигурации Claude Code в сессии. Включите эту опцию, если хотите, чтобы Blitx использовал ваши инструкции и навыки Claude Code. Требуется перезапуск.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверы не настроены. Добавьте MCP-серверы в blitx.jsonc или попросите агента добавить их.",
  ...
  "settings.experimental.sandbox.description":
    "Выполнять команды оболочки агента в песочнице на уровне ОС, которая ограничивает запись в каталоги состояния проекта и Blitx",
  ...
  "settings.display.fontSize.description": "Настройте размер шрифта webview UI для Blitx независимо от VS Code.",
  ...
  "settings.aboutBlitx.legacyMigration.title": "Миграция с устаревшей версии",
  "settings.aboutBlitx.legacyMigration.description":
    "Перенос настроек из предыдущей установки Blitx, включая API-ключи провайдеров и модель по умолчанию.",
  "settings.aboutBlitx.rooImport.description": "Импорт истории переписки из установки Roo Code.",
  "settings.aboutBlitx.rooImport.button": "Импортировать сеансы из Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Что нового в Blitx",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Одно компактное и эффективное ядро для всех продуктов Blitx. Знакомый опыт независимо от выбранного способа работы.",
  ...
  "diffViewer.source.session.tooltip":
    "Файлы, изменённые Blitx в текущей сессии, на основе снимков по ходу. Сбрасывается при начале новой сессии.",
