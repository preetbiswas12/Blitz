...
const AM_PREFIX = "blitx-code.new.agentManager."

/** Global commands whose keybindings are forwarded to the webview. */
const GLOBAL_KEYBINDINGS: Record<string, string> = {
  "blitx-code.new.agentManagerOpen": "agentManagerOpen",
  "blitx-code.new.cycleAgentMode": "cycleAgentMode",
  "blitx-code.new.cyclePreviousAgentMode": "cyclePreviousAgentMode",
}
