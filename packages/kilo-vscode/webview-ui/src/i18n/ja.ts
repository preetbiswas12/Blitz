export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "このマシンに Anaconda Desktop をインストールしてから、ここに戻ってください。Blitx はインストーラーを実行しません。",
  ...
  "provider.anaconda.state.signedOut": "Blitx を接続する前に、Anaconda Desktop を開いてサインインしてください。",
  "provider.anaconda.state.unauthorized":
    "Blitx は Anaconda Desktop にアクセスできませんでした。Desktop を開いて再度サインインし、必要に応じて再起動してください。",
  ...
  "provider.anaconda.state.ready":
    "Blitx は正常なローカルのテキスト生成サーバーを見つけ、現在の接続設定をインポートできます。",
  ...
  "provider.anaconda.toast.refreshed.description": "アクティブなローカルサーバーとモデルが Blitx で最新になりました。",
...
export const dict = {
  ...
  "agentRequirements.error.discoveryFailed": "Blitx は利用可能なスキルを確認できませんでした。",
  "agentRequirements.error.mcpStatusFailed": "Blitx は MCP サーバーの状態を確認できませんでした。",
  "agentRequirements.error.scopeMismatch": "このエージェント要件の確認はもう有効ではありません。",
  "agentRequirements.error.requestFailed": "Blitx はエージェント要件を確認できませんでした。",
  ...
  "dialog.model.unpaid.freeModels.title": "Blitxが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Blitxで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してBlitxで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Blitxで{{provider}}モデルを使用してください。",
  ...
  "prompt.action.sandbox.enabled":
    "サンドボックスが有効です。エージェントのシェルコマンドは、プロジェクトおよびBlitxディレクトリに制限されています。",
  "prompt.action.sandbox.disabled":
    "サンドボックスが無効です。クリックしてエージェントのシェルコマンドの書き込みをプロジェクトおよびBlitxディレクトリに制限します。",
  ...
  "prompt.action.sandbox.description.enabled": "書き込みはプロジェクトおよびBlitxディレクトリ内に制限されます。",
  ...
  "speechToText.tooltip.start": "Blitx Gatewayで音声入力を開始",
  ...
  "speechToText.error.loginRequired": "音声入力を使用するにはBlitxにサインインしてください。",
  ...
  "dialog.server.description": "このアプリが接続するBlitxサーバーを切り替えます。",
  ...
  "toast.update.description": "Blitxの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをBlitxチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: BlitxはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Blitxには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.row.language.description": "Blitxの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのBlitxの表示をカスタマイズします",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Blitxのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Blitx の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Blitx は最新バージョンです。",
  ...
  "settings.indexing.blitxModel.title": "Blitxモデルプリセット",
  "settings.indexing.blitxModel.description": "サポートされているBlitxホスト型埋め込みモデルを選択します。",
  "settings.indexing.blitxSignIn.title": "Blitxへのサインインが必要です",
  "settings.indexing.blitxSignIn.description": "ホスト型埋め込みを使用するにはBlitxにサインインしてください。",
  ...
  "settings.providers.betaNotice":
    "現在、設定画面で設定できるのはBlitx Gatewayプロバイダーのみです。他のプロバイダーの設定については、ベータ期間中にまもなく対応予定です。それまでの間は、CLIまたは設定ファイルを使用してプロバイダーを設定できます。私たちはBlitxをオープンに保ち、ロックインのない状態を維持することをお約束します。",
  ...
  "settings.models.hidePromptTraining.description":
    "プロバイダーがプロンプトを学習に使用する可能性のある Blitx Gateway モデルを非表示にします。",
  ...
  "settings.config.title": "{{scope}}のBlitx構成ファイルを開く",
  "settings.config.placeholder":
    "構成ファイルは順番にマージされます。読み込み済みとしてマークされているファイルが現在設定に影響しています。",
  "settings.config.noWorkspace": "ローカルのBlitx構成ファイルを編集するには、ワークスペースフォルダーを開いてください。",
  "settings.config.openFailed": "{{scope}}のBlitx構成ファイルを開けませんでした: {{message}}",
  ...
  "workStyle.onboarding.welcome": "Blitxへようこそ",
  ...
  "workStyle.choice.human-in-the-loop.description": "Blitxは作業中に一時停止し、計画を表示します。",
  ...
  "session.cloud.import.placeholder": "セッションID、URL、またはblitx importコマンド",
  ...
  "settings.aboutBlitx.title": "Blitxについて",

  "session.messages.empty": "下にメッセージを入力して会話を始めましょう。",
  "session.messages.welcome":
    "BlitxはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.aboutBlitx.status.connected": "接続済み",
  "settings.aboutBlitx.status.connecting": "接続中...",
  "settings.aboutBlitx.status.disconnected": "切断",
  "settings.aboutBlitx.status.error": "エラー",
  "settings.aboutBlitx.cliServer": "CLIサーバー",
  "settings.aboutBlitx.status.label": "ステータス：",
  "settings.aboutBlitx.port.label": "ポート：",
  "settings.aboutBlitx.versionInfo": "バージョン情報",
  "settings.aboutBlitx.version.label": "バージョン：",
  "settings.aboutBlitx.extensionName": "Blitx拡張機能",
  "settings.aboutBlitx.community": "コミュニティとサポート",
  "settings.aboutBlitx.feedback.prefix": "ご質問やフィードバックがありましたら、お気軽にissueを作成してください",
  "settings.aboutBlitx.feedback.or": "または",
  "settings.aboutBlitx.support.prefix":
    "請求やアカウントに関するご質問は、カスタマーサポートまでお問い合わせください",
  "settings.aboutBlitx.resetSettings.title": "設定をリセット",
  ...
  "settings.aboutBlitx.resetSettings.button": "すべての設定をリセット",
  "settings.aboutBlitx.resetSettings.notificationsButton": "Reset Read Notifications",
  "settings.aboutBlitx.settingsTransfer.title": "設定の移行",
  "settings.aboutBlitx.settingsTransfer.description":
    "VS Code インスタンス間で設定を転送するには、エクスポートまたはインポートしてください。",
  "settings.aboutBlitx.exportSettings": "エクスポート",
  "settings.aboutBlitx.importSettings": "インポート",
  "settings.aboutBlitx.importSettings.invalidJson":
    "無効な JSON ファイルです。有効な設定ファイルを選択してください。",
  "settings.aboutBlitx.importSettings.invalidConfig": "ファイルに有効な Blitx の設定が含まれていません。",
  "settings.aboutBlitx.importSettings.tooLarge": "ファイルが大きすぎます。設定ファイルは 1 MB 以下にしてください。",
  "settings.aboutBlitx.importSettings.newerVersion":
    "このファイルはより新しいバージョンの Blitx からエクスポートされたものです。一部の設定が無視される場合があります。",
  "settings.aboutBlitx.importSettings.success":
    "設定をインポートしました。上記の変更内容を確認してから、保存をクリックしてください。",

  "settings.aboutBlitx.telemetry.title": "テレメトリ",
  ...
  "settings.aboutBlitx.telemetry.openSettings": "テレメトリ設定を開く",
  ...
  "settings.language.description": "Blitx UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
  ...
  "settings.experimental.speechToText.description":
    "Blitx Gateway経由でBlitxアカウントを使用して、プロンプトフィールドでの音声入力を有効にします。",
  "settings.models.speechToText.disabledDescription":
    "Speech to Text を使用するには、Blitx プロバイダーを有効にしてサインインしてください。現在、Speech to Text は Blitx Gateway でのみサポートされています。",
  "settings.models.speechToTextModel.title": "音声認識モデル",
  "settings.models.speechToTextModel.description": "音声入力に使用するBlitx Gateway文字起こしモデルを選択します。",
  ...
  "settings.experimental.remote.description":
    "Blitx Cloud 経由でのセッションの Remote コントロールを有効にします。これはこのマシンの CLI にも影響します。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code の設定ディレクトリから CLAUDE.md のインストラクションとスキルをセッションに読み込みます。Blitx に Claude Code のインストラクションとスキルを使用させる場合は、これを有効にしてください。再起動が必要です。",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCPサーバーが設定されていません。blitx.jsoncでMCPサーバーを追加するか、エージェントに追加を依頼してください。",
  ...
  "settings.experimental.sandbox.description":
    "エージェントのシェルコマンドを、プロジェクトおよびBlitxの状態ディレクトリへの書き込みを制限するOSレベルのサンドボックス内で実行",
  ...
  "settings.display.fontSize.description": "VS Code とは独立して Blitx webview UI のフォントサイズを調整します。",
  ...
  "settings.aboutBlitx.legacyMigration.title": "レガシー移行",
  "settings.aboutBlitx.legacyMigration.description":
    "プロバイダーのAPIキーやデフォルトモデルなど、以前にインストールしたBlitxから設定を移行します。",
  "settings.aboutBlitx.rooImport.description": "インストールしたRoo Codeから会話履歴を移行します。",
  "settings.aboutBlitx.rooImport.button": "Roo Codeからセッションをインポート",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Blitxの新機能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "すべてのBlitx製品で共有される小さく効率的なコア。どのような作業スタイルでも馴染みのある体験を提供します。",
  ...
  "diffViewer.source.session.tooltip":
    "現在のセッション中に Blitx が変更したファイル。ターンごとのスナップショットに基づきます。新しいセッションを開始するとリセットされます。",
