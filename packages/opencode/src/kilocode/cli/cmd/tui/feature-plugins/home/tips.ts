...
export const KILO_TIPS: Tip[] = [
  ...
  "Create {highlight}legion.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "Place TUI settings in {highlight}~/.config/legion/tui.json{/highlight} for global config",
  ...
  "Add {highlight}.ts{/highlight} files to {highlight}.legion/plugins/{/highlight} for event hooks",
  ...
  "Use {highlight}/connect{/highlight} with Legion Gateway for curated, tested models",
