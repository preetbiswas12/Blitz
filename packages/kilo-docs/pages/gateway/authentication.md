...
API keys are JWT tokens tied to your Kilocode account. See [how to get your API key](/docs/getting-started/setup-authentication#kilocode-api-key) for step-by-step instructions.
