...
| DoltHub | [Connect DoltHub](https://app.kilo.ai/integrations/dolthub) <!-- TODO: Replace with Blitx dashboard URL --> from Integrations | Query Dolt-versioned data and authorize DoltHub access for Gas Town Wasteland |

---

## How to Set Up

All integrations are configured from the **Integrations** tab at [app.kilo.ai](https://app.kilo.ai). <!-- TODO: Replace with Blitx dashboard URL --> Each integration requires:
