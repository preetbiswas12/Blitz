...
const TIPS = [
  ...
  "Legion can {highlight}configure itself{/highlight} if you ask it",
  "Ask Legion to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Legion to {highlight}create a review agent for this project{/highlight}",
  "Ask Legion to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Legion to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Legion to {highlight}make my review agent read-only{/highlight}",
  "Ask Legion to {highlight}require approval before git push{/highlight}",
  "Ask Legion to {highlight}turn off auto-formatting{/highlight}",
  "Ask Legion to {highlight}block access to .env files{/highlight}",
  "Ask Legion to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Legion to {highlight}match my terminal theme{/highlight}",
  "Ask Legion to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Legion to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Legion to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Legion to {highlight}save this workflow as a /command{/highlight}",
