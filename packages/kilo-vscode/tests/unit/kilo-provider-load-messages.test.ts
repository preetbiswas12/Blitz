...
const { BlitxProvider, unwrapSyncEvent } = await import("../../src/BlitxProvider")
...
function makeProvider(client: ReturnType<typeof createClient>) {
  ...
  const provider = new BlitxProvider({} as never, connection as never)
...
describe("BlitxProvider.handleAbort", () => {
...
describe("BlitxProvider sandbox status", () => {
...
describe("BlitxProvider sandbox toggle", () => {
...
describe("BlitxProvider revert ordering", () => {
...
describe("BlitxProvider.handleLoadMessages / focus mode freshness", () => {
...
describe("BlitxProvider.handleDeleteSession / background processes", () => {
...
describe("BlitxProvider.handleLoadMessages / slim payload", () => {
...
describe("BlitxProvider.loadMessages / sub-agent viewer", () => {
...
describe("BlitxProvider.handleLoadMessages / prepend into deleted session", () => {
